...
const file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDesc = "" +
	"\n" +
	"Gcontrib/envoy/extensions/upstreams/http/tcp/golang/v3alpha/golang.proto\x122envoy.extensions.upstreams.http.tcp.golang.v3alpha\x1a\x19google/protobuf/any.proto\x1a\x1fxds/annotations/v3/status.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc1\x01\n" +
	"\x06Config\x12&\n" +
	"\n" +
	...
	"pluginName\x129\n" +
	"\rplugin_config\x18\x04 \x01(\v2\x14.google.protobuf.AnyR\fpluginConfigB\xc4\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"@io.envoyproxy.envoy.extensions.upstreams.http.tcp.golang.v3alphaB\vGolangProtoP\x01Zagithub.com/envoyproxy/go-control-plane/contrib/envoy/extensions/upstreams/http/tcp/golang/v3alphab\x06proto3"

var (
	file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDescOnce sync.Once
	file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDescData []byte
)
...
func file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDescGZIP() []byte {
	file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDescOnce.Do(func() {
		file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDesc), len(file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDesc)))
	})
...
var file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_goTypes = []any{
...
func file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDesc), len(file_contrib_envoy_extensions_upstreams_http_tcp_golang_v3alpha_golang_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
