...
const file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDesc = "" +
	"\n" +
	"Dcontrib/envoy/extensions/private_key_providers/qat/v3alpha/qat.proto\x122envoy.extensions.private_key_providers.qat.v3alpha\x1a\x1fenvoy/config/core/v3/base.proto\x1a\x1egoogle/protobuf/duration.proto\x1a udpa/annotations/sensitive.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xb0\x01\n" +
	"\x19QatPrivateKeyMethodConfig\x12I\n" +
	...
	"@io.envoyproxy.envoy.extensions.private_key_providers.qat.v3alphaB\bQatProtoP\x01Zagithub.com/envoyproxy/go-control-plane/contrib/envoy/extensions/private_key_providers/qat/v3alphab\x06proto3"

var (
	file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDescOnce sync.Once
	file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDescData []byte
)
...
func file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDescGZIP() []byte {
	file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDescOnce.Do(func() {
		file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDesc), len(file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDesc)))
	})
...
var file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_goTypes = []any{
...
func file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDesc), len(file_contrib_envoy_extensions_private_key_providers_qat_v3alpha_qat_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
