...
const file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDesc = "" +
	"\n" +
	"?contrib/envoy/extensions/vcl/v3alpha/vcl_socket_interface.proto\x12\x1cenvoy.extensions.vcl.v3alpha\x1a\x1dudpa/annotations/status.proto\"\x14\n" +
	"\x12VclSocketInterfaceB\x9e\x01\xba\x80\xc8\xd1\x06\x04\b\x01\x10\x02\n" +
	"*io.envoyproxy.envoy.extensions.vcl.v3alphaB\x17VclSocketInterfaceProtoP\x01ZKgithub.com/envoyproxy/go-control-plane/contrib/envoy/extensions/vcl/v3alphab\x06proto3"

var (
	file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDescOnce sync.Once
	file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDescData []byte
)
...
func file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDescGZIP() []byte {
	file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDescOnce.Do(func() {
		file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDesc), len(file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDesc)))
	})
...
var file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_goTypes = []any{
...
func file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDesc), len(file_contrib_envoy_extensions_vcl_v3alpha_vcl_socket_interface_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
