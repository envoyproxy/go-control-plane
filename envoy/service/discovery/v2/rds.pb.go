...
// source: envoy/service/discovery/v2/rds.proto
...
func (*RdsDummy) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{0} }

func init() {
	proto.RegisterType((*RdsDummy)(nil), "envoy.service.discovery.v2.RdsDummy")
}
...
func (c *routeDiscoveryServiceClient) StreamRoutes(ctx context.Context, opts ...grpc.CallOption) (RouteDiscoveryService_StreamRoutesClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RouteDiscoveryService_serviceDesc.Streams[0], c.cc, "/envoy.service.discovery.v2.RouteDiscoveryService/StreamRoutes", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *routeDiscoveryServiceClient) FetchRoutes(ctx context.Context, in *DiscoveryRequest, opts ...grpc.CallOption) (*DiscoveryResponse, error) {
	...
	err := grpc.Invoke(ctx, "/envoy.service.discovery.v2.RouteDiscoveryService/FetchRoutes", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RouteDiscoveryService_FetchRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/envoy.service.discovery.v2.RouteDiscoveryService/FetchRoutes",
	}
...
var _RouteDiscoveryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "envoy.service.discovery.v2.RouteDiscoveryService",
	...
	Metadata: "envoy/service/discovery/v2/rds.proto",
}
...
func init() { proto.RegisterFile("envoy/service/discovery/v2/rds.proto", fileDescriptorRds) }
...
var fileDescriptorRds = []byte{
	...
	0x4b, 0x2d, 0xaa, 0xd4, 0x2f, 0x33, 0xd2, 0x2f, 0x4a, 0x29, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9,
	...
	,
}
