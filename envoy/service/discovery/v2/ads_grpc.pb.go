...
func (c *aggregatedDiscoveryServiceClient) StreamAggregatedResources(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[v2.DiscoveryRequest, v2.DiscoveryResponse], error) {
...
func (c *aggregatedDiscoveryServiceClient) DeltaAggregatedResources(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAggregatedDiscoveryServiceServer) StreamAggregatedResources(grpc.BidiStreamingServer[v2.DiscoveryRequest, v2.DiscoveryResponse]) error {
	return status.Errorf(codes.Unimplemented, "method StreamAggregatedResources not implemented")
}
func (UnimplementedAggregatedDiscoveryServiceServer) DeltaAggregatedResources(grpc.BidiStreamingServer[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]) error {
...
func _AggregatedDiscoveryService_StreamAggregatedResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AggregatedDiscoveryServiceServer).StreamAggregatedResources(&grpc.GenericServerStream[v2.DiscoveryRequest, v2.DiscoveryResponse]{ServerStream: stream})
}
...
func _AggregatedDiscoveryService_DeltaAggregatedResources_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AggregatedDiscoveryServiceServer).DeltaAggregatedResources(&grpc.GenericServerStream[v2.DeltaDiscoveryRequest, v2.DeltaDiscoveryResponse]{ServerStream: stream})
}
