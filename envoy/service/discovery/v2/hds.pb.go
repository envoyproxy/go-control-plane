...
func (Capability_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptorHds, []int{1, 0} }
...
func (m *HdsDummy) Reset()                    { *m = HdsDummy{} }
func (m *HdsDummy) String() string            { return proto.CompactTextString(m) }
func (*HdsDummy) ProtoMessage()               {}
func (*HdsDummy) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{0} }
...
func (*Capability) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{1} }
...
func (*HealthCheckRequest) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{2} }

func (m *HealthCheckRequest) GetNode() *envoy_api_v21.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type EndpointHealth struct {
	...
	HealthStatus envoy_api_v22.HealthStatus      `protobuf:"varint,2,opt,name=health_status,json=healthStatus,proto3,enum=envoy.api.v2.HealthStatus" json:"health_status,omitempty"`
}
...
func (*EndpointHealth) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{3} }
...
func (m *EndpointHealth) GetHealthStatus() envoy_api_v22.HealthStatus {
	if m != nil {
		return m.HealthStatus
	}
	return envoy_api_v22.HealthStatus_UNKNOWN
}
...
func (*EndpointHealthResponse) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{4} }
...
func (*HealthCheckRequestOrEndpointHealthResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorHds, []int{5}
}
...
func (*LocalityEndpoints) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{6} }

func (m *LocalityEndpoints) GetLocality() *envoy_api_v21.Locality {
	if m != nil {
		return m.Locality
	}
	return nil
...
type ClusterHealthCheck struct {
	...
	HealthChecks []*envoy_api_v22.HealthCheck `protobuf:"bytes,2,rep,name=health_checks,json=healthChecks" json:"health_checks,omitempty"`
...
func (*ClusterHealthCheck) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{7} }
...
func (m *ClusterHealthCheck) GetHealthChecks() []*envoy_api_v22.HealthCheck {
	if m != nil {
...
func (*HealthCheckSpecifier) Descriptor() ([]byte, []int) { return fileDescriptorHds, []int{8} }
...
func init() {
	proto.RegisterType((*HdsDummy)(nil), "envoy.service.discovery.v2.HdsDummy")
...
func (m *HdsDummy) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *HdsDummy) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *HdsDummy) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: HdsDummy: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HdsDummy: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HealthStatus |= (envoy_api_v22.HealthStatus(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ClusterHealthCheck) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.HealthChecks = append(m.HealthChecks, &envoy_api_v22.HealthCheck{})
...
var fileDescriptorHds = []byte{
	...
	,
}
