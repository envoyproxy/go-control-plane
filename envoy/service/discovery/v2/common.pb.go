...
// source: envoy/service/discovery/v2/common.proto
...
type DiscoveryRequest struct {
	...
	Node *envoy_api_v21.Node `protobuf:"bytes,2,opt,name=node" json:"node,omitempty"`
...
func (*DiscoveryRequest) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{0} }
...
func (m *DiscoveryRequest) GetNode() *envoy_api_v21.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (*DiscoveryResponse) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1} }
...
func init() {
	proto.RegisterType((*DiscoveryRequest)(nil), "envoy.service.discovery.v2.DiscoveryRequest")
	proto.RegisterType((*DiscoveryResponse)(nil), "envoy.service.discovery.v2.DiscoveryResponse")
}
...
func (m *DiscoveryRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.VersionInfo) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCommon(dAtA, i, uint64(len(m.VersionInfo)))
		i += copy(dAtA[i:], m.VersionInfo)
	}
	if m.Node != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCommon(dAtA, i, uint64(m.Node.Size()))
	...
	if len(m.ResponseNonce) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintCommon(dAtA, i, uint64(len(m.ResponseNonce)))
...
func init() { proto.RegisterFile("envoy/service/discovery/v2/common.proto", fileDescriptorCommon) }

var fileDescriptorCommon = []byte{
	// 342 bytes of a gzipped FileDescriptorProto
	,
}
