...
// source: envoy/service/discovery/v3alpha/discovery.proto
...
type DiscoveryRequest struct {
	...
	Node                 *v3alpha.Node  `protobuf:"bytes,2,opt,name=node,proto3" json:"node,omitempty"`
...
func (*DiscoveryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5aa0a32d59b8c1, []int{0}
}
...
func (m *DiscoveryRequest) GetNode() *v3alpha.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
type DiscoveryResponse struct {
	...
	ControlPlane         *v3alpha.ControlPlane `protobuf:"bytes,6,opt,name=control_plane,json=controlPlane,proto3" json:"control_plane,omitempty"`
	XXX_NoUnkeyedLiteral struct{}              `json:"-"`
	XXX_unrecognized     []byte                `json:"-"`
	XXX_sizecache        int32                 `json:"-"`
}
...
func (*DiscoveryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5aa0a32d59b8c1, []int{1}
}
...
func (m *DiscoveryResponse) GetControlPlane() *v3alpha.ControlPlane {
	if m != nil {
...
func (*DeltaDiscoveryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5aa0a32d59b8c1, []int{2}
}
...
func (m *DeltaDiscoveryRequest) GetNode() *v3alpha.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (*DeltaDiscoveryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5aa0a32d59b8c1, []int{3}
}
...
func (*Resource) Descriptor() ([]byte, []int) {
	return fileDescriptor_1c5aa0a32d59b8c1, []int{4}
}
...
func init() {
	proto.RegisterType((*DiscoveryRequest)(nil), "envoy.service.discovery.v3alpha.DiscoveryRequest")
	proto.RegisterType((*DiscoveryResponse)(nil), "envoy.service.discovery.v3alpha.DiscoveryResponse")
	proto.RegisterType((*DeltaDiscoveryRequest)(nil), "envoy.service.discovery.v3alpha.DeltaDiscoveryRequest")
	proto.RegisterMapType((map[string]string)(nil), "envoy.service.discovery.v3alpha.DeltaDiscoveryRequest.InitialResourceVersionsEntry")
	proto.RegisterType((*DeltaDiscoveryResponse)(nil), "envoy.service.discovery.v3alpha.DeltaDiscoveryResponse")
	proto.RegisterType((*Resource)(nil), "envoy.service.discovery.v3alpha.Resource")
}

func init() {
	proto.RegisterFile("envoy/service/discovery/v3alpha/discovery.proto", fileDescriptor_1c5aa0a32d59b8c1)
}

var fileDescriptor_1c5aa0a32d59b8c1 = []byte{
	// 769 bytes of a gzipped FileDescriptorProto
	,
}
