...
type LoadStatsResponse struct {
	...
	LoadReportingInterval *google_protobuf4.Duration `protobuf:"bytes,2,opt,name=load_reporting_interval,json=loadReportingInterval" json:"load_reporting_interval,omitempty"`
...
func (m *LoadStatsResponse) GetLoadReportingInterval() *google_protobuf4.Duration {
	if m != nil {
...
func (m *LoadStatsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.LoadReportingInterval == nil {
				m.LoadReportingInterval = &google_protobuf4.Duration{}
			}
