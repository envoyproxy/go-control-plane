...
func (*LoadStatsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_lrs_24976ebc53275992, []int{0}
}
...
func (*LoadStatsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_lrs_24976ebc53275992, []int{1}
}
...
func init() {
	proto.RegisterFile("envoy/service/load_stats/v2/lrs.proto", fileDescriptor_lrs_24976ebc53275992)
}

var fileDescriptor_lrs_24976ebc53275992 = []byte{
