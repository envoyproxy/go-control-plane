...
import envoy_data_tap_v2alpha3 "github.com/envoyproxy/go-control-plane/envoy/data/tap/v2alpha"
...
type StreamTapsRequest struct {
	...
	Identifier *StreamTapsRequest_Identifier `protobuf:"bytes,1,opt,name=identifier" json:"identifier,omitempty"`
	...
	// The trace data.
	Trace *envoy_data_tap_v2alpha3.TraceWrapper `protobuf:"bytes,3,opt,name=trace" json:"trace,omitempty"`
}
...
func (*StreamTapsRequest) Descriptor() ([]byte, []int) { return fileDescriptorTap, []int{0} }
...
func (m *StreamTapsRequest) GetTrace() *envoy_data_tap_v2alpha3.TraceWrapper {
	if m != nil {
		return m.Trace
	}
	return nil
...
func (*StreamTapsRequest_Identifier) Descriptor() ([]byte, []int) {
	return fileDescriptorTap, []int{0, 0}
}

func (m *StreamTapsRequest_Identifier) GetNode() *envoy_api_v2_core.Node {
	if m != nil {
		return m.Node
	}
	return nil
...
func (*StreamTapsResponse) Descriptor() ([]byte, []int) { return fileDescriptorTap, []int{1} }
...
// Client API for TapSinkService service
...
func (c *tapSinkServiceClient) StreamTaps(ctx context.Context, opts ...grpc.CallOption) (TapSinkService_StreamTapsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_TapSinkService_serviceDesc.Streams[0], c.cc, "/envoy.service.tap.v2alpha.TapSinkService/StreamTaps", opts...)
	if err != nil {
		return nil, err
	}
...
// Server API for TapSinkService service
...
func (m *StreamTapsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Trace == nil {
				m.Trace = &envoy_data_tap_v2alpha3.TraceWrapper{}
			}
...
func init() { proto.RegisterFile("envoy/service/tap/v2alpha/tap.proto", fileDescriptorTap) }

var fileDescriptorTap = []byte{
