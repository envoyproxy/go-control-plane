...
const file_envoy_service_tap_v2alpha_common_proto_rawDesc = "" +
	"\n" +
	"&envoy/service/tap/v2alpha/common.proto\x12\x19envoy.service.tap.v2alpha\x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy/api/v2/core/grpc_service.proto\x1a)envoy/api/v2/route/route_components.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x89\x02\n" +
	"\tTapConfig\x12V\n" +
	"\fmatch_config\x18\x01 \x01(\v2).envoy.service.tap.v2alpha.MatchPredicateB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vmatchConfig\x12V\n" +
	"\routput_config\x18\x02 \x01(\v2'.envoy.service.tap.v2alpha.OutputConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\foutputConfig\x12L\n" +
	"\vtap_enabled\x18\x03 \x01(\v2+.envoy.api.v2.core.RuntimeFractionalPercentR\n" +
	"tapEnabled\"\xc2\x06\n" +
	"\x0eMatchPredicate\x12O\n" +
	"\bor_match\x18\x01 \x01(\v22.envoy.service.tap.v2alpha.MatchPredicate.MatchSetH\x00R\aorMatch\x12Q\n" +
	"\tand_match\x18\x02 \x01(\v22.envoy.service.tap.v2alpha.MatchPredicate.MatchSetH\x00R\bandMatch\x12H\n" +
	"\tnot_match\x18\x03 \x01(\v2).envoy.service.tap.v2alpha.MatchPredicateH\x00R\bnotMatch\x12&\n" +
	"\tany_match\x18\x04 \x01(\bB\a\xfaB\x04j\x02\b\x01H\x00R\banyMatch\x12j\n" +
	"\x1ahttp_request_headers_match\x18\x05 \x01(\v2+.envoy.service.tap.v2alpha.HttpHeadersMatchH\x00R\x17httpRequestHeadersMatch\x12l\n" +
	"\x1bhttp_request_trailers_match\x18\x06 \x01(\v2+.envoy.service.tap.v2alpha.HttpHeadersMatchH\x00R\x18httpRequestTrailersMatch\x12l\n" +
	"\x1bhttp_response_headers_match\x18\a \x01(\v2+.envoy.service.tap.v2alpha.HttpHeadersMatchH\x00R\x18httpResponseHeadersMatch\x12n\n" +
	"\x1chttp_response_trailers_match\x18\b \x01(\v2+.envoy.service.tap.v2alpha.HttpHeadersMatchH\x00R\x19httpResponseTrailersMatch\x1aU\n" +
	"\bMatchSet\x12I\n" +
	"\x05rules\x18\x01 \x03(\v2).envoy.service.tap.v2alpha.MatchPredicateB\b\xfaB\x05\x92\x01\x02\b\x02R\x05rulesB\v\n" +
	"\x04rule\x12\x03\xf8B\x01\"O\n" +
	"\x10HttpHeadersMatch\x12;\n" +
	"\aheaders\x18\x01 \x03(\v2!.envoy.api.v2.route.HeaderMatcherR\aheaders\"\x97\x02\n" +
	"\fOutputConfig\x12G\n" +
	"\x05sinks\x18\x01 \x03(\v2%.envoy.service.tap.v2alpha.OutputSinkB\n" +
	...
	"\tstreaming\x18\x04 \x01(\bR\tstreaming\"\xf5\x03\n" +
	"\n" +
	"OutputSink\x12N\n" +
	"\x06format\x18\x01 \x01(\x0e2,.envoy.service.tap.v2alpha.OutputSink.FormatB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06format\x12X\n" +
	"\x0fstreaming_admin\x18\x02 \x01(\v2-.envoy.service.tap.v2alpha.StreamingAdminSinkH\x00R\x0estreamingAdmin\x12M\n" +
	"\ffile_per_tap\x18\x03 \x01(\v2).envoy.service.tap.v2alpha.FilePerTapSinkH\x00R\n" +
	"filePerTap\x12U\n" +
	"\x0estreaming_grpc\x18\x04 \x01(\v2,.envoy.service.tap.v2alpha.StreamingGrpcSinkH\x00R\rstreamingGrpc\"~\n" +
	"\x06Format\x12\x16\n" +
	...
	"\x10output_sink_type\x12\x03\xf8B\x01\"\x14\n" +
	"\x12StreamingAdminSink\":\n" +
	"\x0eFilePerTapSink\x12(\n" +
	"\vpath_prefix\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\n" +
	"pathPrefix\"w\n" +
	"\x11StreamingGrpcSink\x12\x15\n" +
	"\x06tap_id\x18\x01 \x01(\tR\x05tapId\x12K\n" +
	"\fgrpc_service\x18\x02 \x01(\v2\x1e.envoy.api.v2.core.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcServiceB\x9d\x01\xf2\x98\xfe\x8f\x05\x15\x12\x13envoy.config.tap.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"'io.envoyproxy.envoy.service.tap.v2alphaB\vCommonProtoP\x01Z@github.com/envoyproxy/go-control-plane/envoy/service/tap/v2alphab\x06proto3"

var (
	file_envoy_service_tap_v2alpha_common_proto_rawDescOnce sync.Once
	file_envoy_service_tap_v2alpha_common_proto_rawDescData []byte
)
...
func file_envoy_service_tap_v2alpha_common_proto_rawDescGZIP() []byte {
	file_envoy_service_tap_v2alpha_common_proto_rawDescOnce.Do(func() {
		file_envoy_service_tap_v2alpha_common_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_service_tap_v2alpha_common_proto_rawDesc), len(file_envoy_service_tap_v2alpha_common_proto_rawDesc)))
	})
...
var file_envoy_service_tap_v2alpha_common_proto_goTypes = []any{
...
func file_envoy_service_tap_v2alpha_common_proto_init() {
	...
	file_envoy_service_tap_v2alpha_common_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_envoy_service_tap_v2alpha_common_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_service_tap_v2alpha_common_proto_rawDesc), len(file_envoy_service_tap_v2alpha_common_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
