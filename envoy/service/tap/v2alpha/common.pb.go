...
/*
	Package envoy_service_tap_v2alpha is a generated protocol buffer package.
...
import _ "github.com/envoyproxy/go-control-plane/envoy/type/matcher"
...
func (OutputSink_Format) EnumDescriptor() ([]byte, []int) { return fileDescriptorCommon, []int{4, 0} }

// Tap configuration.
type TapConfig struct {
	// The match configuration. If the configuration matches the data source being tapped, a tap will
	// occur, with the result written to the configured output.
	MatchConfig *MatchPredicate `protobuf:"bytes,1,opt,name=match_config,json=matchConfig" json:"match_config,omitempty"`
	// The tap output configuration. If a match configuration matches a data source being tapped,
	// a tap will occur and the data will be written to the configured output.
	OutputConfig *OutputConfig `protobuf:"bytes,2,opt,name=output_config,json=outputConfig" json:"output_config,omitempty"`
	...
	TapEnabled *envoy_api_v2_core.RuntimeFractionalPercent `protobuf:"bytes,3,opt,name=tap_enabled,json=tapEnabled" json:"tap_enabled,omitempty"`
}
...
func (*TapConfig) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{0} }
...
func (m *TapConfig) GetTapEnabled() *envoy_api_v2_core.RuntimeFractionalPercent {
	if m != nil {
		return m.TapEnabled
	}
	return nil
...
func (*MatchPredicate) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1} }
...
type MatchPredicate_OrMatch struct {
	OrMatch *MatchPredicate_MatchSet `protobuf:"bytes,1,opt,name=or_match,json=orMatch,oneof"`
}
type MatchPredicate_AndMatch struct {
	AndMatch *MatchPredicate_MatchSet `protobuf:"bytes,2,opt,name=and_match,json=andMatch,oneof"`
}
type MatchPredicate_NotMatch struct {
	NotMatch *MatchPredicate `protobuf:"bytes,3,opt,name=not_match,json=notMatch,oneof"`
}
...
type MatchPredicate_HttpRequestHeadersMatch struct {
	HttpRequestHeadersMatch *HttpHeadersMatch `protobuf:"bytes,5,opt,name=http_request_headers_match,json=httpRequestHeadersMatch,oneof"`
}
type MatchPredicate_HttpRequestTrailersMatch struct {
	HttpRequestTrailersMatch *HttpHeadersMatch `protobuf:"bytes,6,opt,name=http_request_trailers_match,json=httpRequestTrailersMatch,oneof"`
}
type MatchPredicate_HttpResponseHeadersMatch struct {
	HttpResponseHeadersMatch *HttpHeadersMatch `protobuf:"bytes,7,opt,name=http_response_headers_match,json=httpResponseHeadersMatch,oneof"`
}
type MatchPredicate_HttpResponseTrailersMatch struct {
	HttpResponseTrailersMatch *HttpHeadersMatch `protobuf:"bytes,8,opt,name=http_response_trailers_match,json=httpResponseTrailersMatch,oneof"`
}
...
type MatchPredicate_MatchSet struct {
	...
	Rules []*MatchPredicate `protobuf:"bytes,1,rep,name=rules" json:"rules,omitempty"`
}
...
func (*MatchPredicate_MatchSet) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1, 0} }
...
func (*HttpHeadersMatch) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{2} }

func (m *HttpHeadersMatch) GetHeaders() []*envoy_api_v2_route.HeaderMatcher {
	if m != nil {
		return m.Headers
	}
	return nil
...
type OutputConfig struct {
	...
	Sinks []*OutputSink `protobuf:"bytes,1,rep,name=sinks" json:"sinks,omitempty"`
	// For buffered tapping, the maximum amount of received body that will be buffered prior to
	// truncation. If truncation occurs, the :ref:`truncated
	// <envoy_api_field_data.tap.v2alpha.Body.truncated>` field will be set. If not specified, the
	// default is 1KiB.
	MaxBufferedRxBytes *google_protobuf2.UInt32Value `protobuf:"bytes,2,opt,name=max_buffered_rx_bytes,json=maxBufferedRxBytes" json:"max_buffered_rx_bytes,omitempty"`
	// For buffered tapping, the maximum amount of transmitted body that will be buffered prior to
	// truncation. If truncation occurs, the :ref:`truncated
	// <envoy_api_field_data.tap.v2alpha.Body.truncated>` field will be set. If not specified, the
	// default is 1KiB.
	MaxBufferedTxBytes *google_protobuf2.UInt32Value `protobuf:"bytes,3,opt,name=max_buffered_tx_bytes,json=maxBufferedTxBytes" json:"max_buffered_tx_bytes,omitempty"`
...
func (*OutputConfig) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{3} }
...
func (m *OutputConfig) GetMaxBufferedRxBytes() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *OutputConfig) GetMaxBufferedTxBytes() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (*OutputSink) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{4} }
...
type OutputSink_StreamingAdmin struct {
	StreamingAdmin *StreamingAdminSink `protobuf:"bytes,2,opt,name=streaming_admin,json=streamingAdmin,oneof"`
}
type OutputSink_FilePerTap struct {
	FilePerTap *FilePerTapSink `protobuf:"bytes,3,opt,name=file_per_tap,json=filePerTap,oneof"`
}
type OutputSink_StreamingGrpc struct {
	StreamingGrpc *StreamingGrpcSink `protobuf:"bytes,4,opt,name=streaming_grpc,json=streamingGrpc,oneof"`
}
...
func (*StreamingAdminSink) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{5} }
...
func (*FilePerTapSink) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{6} }
...
func (*StreamingGrpcSink) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{7} }
...
func (m *StreamingGrpcSink) GetGrpcService() *envoy_api_v2_core1.GrpcService {
	if m != nil {
...
func (m *TapConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.TapEnabled == nil {
				m.TapEnabled = &envoy_api_v2_core.RuntimeFractionalPercent{}
			}
...
func (m *OutputConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.MaxBufferedRxBytes == nil {
				m.MaxBufferedRxBytes = &google_protobuf2.UInt32Value{}
			}
		...
		case 3:
			...
			if m.MaxBufferedTxBytes == nil {
				m.MaxBufferedTxBytes = &google_protobuf2.UInt32Value{}
			}
...
func init() { proto.RegisterFile("envoy/service/tap/v2alpha/common.proto", fileDescriptorCommon) }
