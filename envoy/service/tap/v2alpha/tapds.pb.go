...
type TapResource struct {
	...
	// Tap config to apply
	Config *TapConfig `protobuf:"bytes,2,opt,name=config" json:"config,omitempty"`
}
...
func (*TapResource) Descriptor() ([]byte, []int) { return fileDescriptorTapds, []int{0} }
...
// Client API for TapDiscoveryService service
...
type TapDiscoveryServiceClient interface {
	...
	FetchTapConfigs(ctx context.Context, in *envoy_api_v2.DiscoveryRequest, opts ...grpc.CallOption) (*envoy_api_v2.DiscoveryResponse, error)
}
...
func (c *tapDiscoveryServiceClient) StreamTapConfigs(ctx context.Context, opts ...grpc.CallOption) (TapDiscoveryService_StreamTapConfigsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_TapDiscoveryService_serviceDesc.Streams[0], c.cc, "/envoy.service.tap.v2alpha.TapDiscoveryService/StreamTapConfigs", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *tapDiscoveryServiceStreamTapConfigsClient) Send(m *envoy_api_v2.DiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tapDiscoveryServiceStreamTapConfigsClient) Recv() (*envoy_api_v2.DiscoveryResponse, error) {
...
func (c *tapDiscoveryServiceClient) DeltaTapConfigs(ctx context.Context, opts ...grpc.CallOption) (TapDiscoveryService_DeltaTapConfigsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_TapDiscoveryService_serviceDesc.Streams[1], c.cc, "/envoy.service.tap.v2alpha.TapDiscoveryService/DeltaTapConfigs", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *tapDiscoveryServiceDeltaTapConfigsClient) Send(m *envoy_api_v2.DeltaDiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *tapDiscoveryServiceDeltaTapConfigsClient) Recv() (*envoy_api_v2.DeltaDiscoveryResponse, error) {
...
func (c *tapDiscoveryServiceClient) FetchTapConfigs(ctx context.Context, in *envoy_api_v2.DiscoveryRequest, opts ...grpc.CallOption) (*envoy_api_v2.DiscoveryResponse, error) {
	out := new(envoy_api_v2.DiscoveryResponse)
	err := grpc.Invoke(ctx, "/envoy.service.tap.v2alpha.TapDiscoveryService/FetchTapConfigs", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// Server API for TapDiscoveryService service
...
type TapDiscoveryServiceServer interface {
	...
	FetchTapConfigs(context.Context, *envoy_api_v2.DiscoveryRequest) (*envoy_api_v2.DiscoveryResponse, error)
}
...
func (x *tapDiscoveryServiceStreamTapConfigsServer) Send(m *envoy_api_v2.DiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tapDiscoveryServiceStreamTapConfigsServer) Recv() (*envoy_api_v2.DiscoveryRequest, error) {
...
func (x *tapDiscoveryServiceDeltaTapConfigsServer) Send(m *envoy_api_v2.DeltaDiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *tapDiscoveryServiceDeltaTapConfigsServer) Recv() (*envoy_api_v2.DeltaDiscoveryRequest, error) {
...
func _TapDiscoveryService_FetchTapConfigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TapDiscoveryServiceServer).FetchTapConfigs(ctx, req.(*envoy_api_v2.DiscoveryRequest))
	}
...
func init() { proto.RegisterFile("envoy/service/tap/v2alpha/tapds.proto", fileDescriptorTapds) }

var fileDescriptorTapds = []byte{
