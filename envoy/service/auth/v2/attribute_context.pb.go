...
type AttributeContext_Request struct {
	...
	Time *google_protobuf5.Timestamp `protobuf:"bytes,1,opt,name=time" json:"time,omitempty"`
...
func (m *AttributeContext_Request) GetTime() *google_protobuf5.Timestamp {
	if m != nil {
		return m.Time
	}
	return nil
...
func (m *AttributeContext_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Time == nil {
				m.Time = &google_protobuf5.Timestamp{}
			}
