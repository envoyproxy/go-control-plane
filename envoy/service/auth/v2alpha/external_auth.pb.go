...
import fmt "fmt"
import math "math"
import envoy_service_auth_v21 "github.com/envoyproxy/go-control-plane/envoy/service/auth/v2"
...
type AuthorizationClient interface {
	...
	Check(ctx context.Context, in *envoy_service_auth_v21.CheckRequest, opts ...grpc.CallOption) (*envoy_service_auth_v21.CheckResponse, error)
}
...
func (c *authorizationClient) Check(ctx context.Context, in *envoy_service_auth_v21.CheckRequest, opts ...grpc.CallOption) (*envoy_service_auth_v21.CheckResponse, error) {
	out := new(envoy_service_auth_v21.CheckResponse)
...
type AuthorizationServer interface {
	// Performs authorization check based on the attributes associated with the
	// incoming request, and returns status `OK` or not `OK`.
	Check(context.Context, *envoy_service_auth_v21.CheckRequest) (*envoy_service_auth_v21.CheckResponse, error)
}
...
func _Authorization_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(envoy_service_auth_v21.CheckRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).Check(ctx, req.(*envoy_service_auth_v21.CheckRequest))
	}
