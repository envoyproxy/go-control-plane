...
const file_envoy_service_metrics_v2_metrics_service_proto_rawDesc = "" +
	"\n" +
	".envoy/service/metrics/v2/metrics_service.proto\x12\x18envoy.service.metrics.v2\x1a\x1cenvoy/api/v2/core/base.proto\x1a\"io/prometheus/client/metrics.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x17\n" +
	"\x15StreamMetricsResponse\"\xff\x01\n" +
	"\x14StreamMetricsMessage\x12Y\n" +
	"\n" +
	"identifier\x18\x01 \x01(\v29.envoy.service.metrics.v2.StreamMetricsMessage.IdentifierR\n" +
	"identifier\x12G\n" +
	"\renvoy_metrics\x18\x02 \x03(\v2\".io.prometheus.client.MetricFamilyR\fenvoyMetrics\x1aC\n" +
	"\n" +
	"Identifier\x125\n" +
	"\x04node\x18\x01 \x01(\v2\x17.envoy.api.v2.core.NodeB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x04node2\x86\x01\n" +
	"\x0eMetricsService\x12t\n" +
	"\rStreamMetrics\x12..envoy.service.metrics.v2.StreamMetricsMessage\x1a/.envoy.service.metrics.v2.StreamMetricsResponse\"\x00(\x01B\x92\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"&io.envoyproxy.envoy.service.metrics.v2B\x13MetricsServiceProtoP\x01ZIgithub.com/envoyproxy/go-control-plane/envoy/service/metrics/v2;metricsv2b\x06proto3"

var (
	file_envoy_service_metrics_v2_metrics_service_proto_rawDescOnce sync.Once
	file_envoy_service_metrics_v2_metrics_service_proto_rawDescData []byte
)
...
func file_envoy_service_metrics_v2_metrics_service_proto_rawDescGZIP() []byte {
	file_envoy_service_metrics_v2_metrics_service_proto_rawDescOnce.Do(func() {
		file_envoy_service_metrics_v2_metrics_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_service_metrics_v2_metrics_service_proto_rawDesc), len(file_envoy_service_metrics_v2_metrics_service_proto_rawDesc)))
	})
...
var file_envoy_service_metrics_v2_metrics_service_proto_goTypes = []any{
...
func file_envoy_service_metrics_v2_metrics_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_service_metrics_v2_metrics_service_proto_rawDesc), len(file_envoy_service_metrics_v2_metrics_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
