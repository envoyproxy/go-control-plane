...
type StreamTracesMessage struct {
	...
	Spans []*opencensus_proto_trace_v1.Span `protobuf:"bytes,2,rep,name=spans" json:"spans,omitempty"`
}
...
func (m *StreamTracesMessage) GetSpans() []*opencensus_proto_trace_v1.Span {
	if m != nil {
		return m.Spans
	}
	return nil
...
func (m *StreamTracesMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Spans = append(m.Spans, &opencensus_proto_trace_v1.Span{})
