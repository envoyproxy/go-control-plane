...
type StreamAccessLogsMessage_HTTPAccessLogEntries struct {
	LogEntry []*envoy_api_v2_filter_accesslog.HTTPAccessLogEntry `protobuf:"bytes,1,rep,name=log_entry,json=logEntry" json:"log_entry,omitempty"`
}
...
func (m *StreamAccessLogsMessage_HTTPAccessLogEntries) GetLogEntry() []*envoy_api_v2_filter_accesslog.HTTPAccessLogEntry {
	if m != nil {
		return m.LogEntry
	}
	return nil
...
type StreamAccessLogsMessage_TCPAccessLogEntries struct {
	LogEntry []*envoy_api_v2_filter_accesslog.TCPAccessLogEntry `protobuf:"bytes,1,rep,name=log_entry,json=logEntry" json:"log_entry,omitempty"`
}
...
func (m *StreamAccessLogsMessage_TCPAccessLogEntries) GetLogEntry() []*envoy_api_v2_filter_accesslog.TCPAccessLogEntry {
	if m != nil {
		return m.LogEntry
	}
	return nil
...
func (m *StreamAccessLogsMessage_HTTPAccessLogEntries) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.LogEntry = append(m.LogEntry, &envoy_api_v2_filter_accesslog.HTTPAccessLogEntry{})
...
func (m *StreamAccessLogsMessage_TCPAccessLogEntries) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.LogEntry = append(m.LogEntry, &envoy_api_v2_filter_accesslog.TCPAccessLogEntry{})
			if err := m.LogEntry[len(m.LogEntry)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
var fileDescriptorAls = []byte{
	...
	,
}
