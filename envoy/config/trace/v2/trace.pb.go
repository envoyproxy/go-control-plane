...
import opencensus_proto_trace_v1 "istio.io/gogo-genproto/opencensus/proto/trace/v1"
...
func (OpenCensusConfig_TraceContext) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorTrace, []int{5, 0}
}
...
type OpenCensusConfig struct {
	...
	TraceConfig *opencensus_proto_trace_v1.TraceConfig `protobuf:"bytes,1,opt,name=trace_config,json=traceConfig" json:"trace_config,omitempty"`
	...
	// wins.
	IncomingTraceContext []OpenCensusConfig_TraceContext `protobuf:"varint,8,rep,packed,name=incoming_trace_context,json=incomingTraceContext,enum=envoy.config.trace.v2.OpenCensusConfig_TraceContext" json:"incoming_trace_context,omitempty"`
	// List of outgoing trace context headers we will produce.
	OutgoingTraceContext []OpenCensusConfig_TraceContext `protobuf:"varint,9,rep,packed,name=outgoing_trace_context,json=outgoingTraceContext,enum=envoy.config.trace.v2.OpenCensusConfig_TraceContext" json:"outgoing_trace_context,omitempty"`
}
...
func (*OpenCensusConfig) Descriptor() ([]byte, []int) { return fileDescriptorTrace, []int{5} }

func (m *OpenCensusConfig) GetTraceConfig() *opencensus_proto_trace_v1.TraceConfig {
	if m != nil {
...
func (*TraceServiceConfig) Descriptor() ([]byte, []int) { return fileDescriptorTrace, []int{6} }
...
func (m *OpenCensusConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TraceConfig == nil {
				m.TraceConfig = &opencensus_proto_trace_v1.TraceConfig{}
			}
...
var fileDescriptorTrace = []byte{
	...
	,
}
