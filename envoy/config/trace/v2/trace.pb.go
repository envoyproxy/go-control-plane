...
const file_envoy_config_trace_v2_trace_proto_rawDesc = "" +
	"\n" +
	"!envoy/config/trace/v2/trace.proto\x12\x15envoy.config.trace.v2\x1a#envoy/config/trace/v2/datadog.proto\x1a&envoy/config/trace/v2/dynamic_ot.proto\x1a'envoy/config/trace/v2/http_tracer.proto\x1a%envoy/config/trace/v2/lightstep.proto\x1a#envoy/config/trace/v2/service.proto\x1a\"envoy/config/trace/v2/zipkin.protoBy\n" +
	"#io.envoyproxy.envoy.config.trace.v2B\n" +
	"TraceProtoP\x01ZDgithub.com/envoyproxy/go-control-plane/envoy/config/trace/v2;tracev2P\x00P\x01P\x02P\x03P\x04P\x05b\x06proto3"

var file_envoy_config_trace_v2_trace_proto_goTypes = []any{}
...
func file_envoy_config_trace_v2_trace_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_trace_v2_trace_proto_rawDesc), len(file_envoy_config_trace_v2_trace_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
