...
const file_envoy_config_trace_v2_service_proto_rawDesc = "" +
	"\n" +
	"#envoy/config/trace/v2/service.proto\x12\x15envoy.config.trace.v2\x1a$envoy/api/v2/core/grpc_service.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"a\n" +
	"\x12TraceServiceConfig\x12K\n" +
	"\fgrpc_service\x18\x01 \x01(\v2\x1e.envoy.api.v2.core.GrpcServiceB\b\xfaB\x05\x8a\x01\x02\x10\x01R\vgrpcServiceB\x83\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.config.trace.v2B\fServiceProtoP\x01ZDgithub.com/envoyproxy/go-control-plane/envoy/config/trace/v2;tracev2b\x06proto3"

var (
	file_envoy_config_trace_v2_service_proto_rawDescOnce sync.Once
	file_envoy_config_trace_v2_service_proto_rawDescData []byte
)
...
func file_envoy_config_trace_v2_service_proto_rawDescGZIP() []byte {
	file_envoy_config_trace_v2_service_proto_rawDescOnce.Do(func() {
		file_envoy_config_trace_v2_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_trace_v2_service_proto_rawDesc), len(file_envoy_config_trace_v2_service_proto_rawDesc)))
	})
...
var file_envoy_config_trace_v2_service_proto_goTypes = []any{
...
func file_envoy_config_trace_v2_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_trace_v2_service_proto_rawDesc), len(file_envoy_config_trace_v2_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
