...
const file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc = "" +
	"\n" +
	".envoy/config/cluster/redis/redis_cluster.proto\x12\x1aenvoy.config.cluster.redis\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xfe\x03\n" +
	...
	"\x1fhost_degraded_refresh_threshold\x18\x06 \x01(\rR\x1chostDegradedRefreshThresholdB\x8a\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.config.cluster.redisB\x11RedisClusterProtoP\x01ZAgithub.com/envoyproxy/go-control-plane/envoy/config/cluster/redisb\x06proto3"

var (
	file_envoy_config_cluster_redis_redis_cluster_proto_rawDescOnce sync.Once
	file_envoy_config_cluster_redis_redis_cluster_proto_rawDescData []byte
)
...
func file_envoy_config_cluster_redis_redis_cluster_proto_rawDescGZIP() []byte {
	file_envoy_config_cluster_redis_redis_cluster_proto_rawDescOnce.Do(func() {
		file_envoy_config_cluster_redis_redis_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc), len(file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc)))
	})
...
var file_envoy_config_cluster_redis_redis_cluster_proto_goTypes = []any{
...
func file_envoy_config_cluster_redis_redis_cluster_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc), len(file_envoy_config_cluster_redis_redis_cluster_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
