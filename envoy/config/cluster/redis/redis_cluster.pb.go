...
type RedisClusterConfig struct {
	...
	ClusterRefreshRate *time.Duration `protobuf:"bytes,1,opt,name=cluster_refresh_rate,json=clusterRefreshRate,stdduration" json:"cluster_refresh_rate,omitempty"`
	// Timeout for topology refresh request. If not set, this defaults to 3s.
	ClusterRefreshTimeout *time.Duration `protobuf:"bytes,2,opt,name=cluster_refresh_timeout,json=clusterRefreshTimeout,stdduration" json:"cluster_refresh_timeout,omitempty"`
}
...
func (*RedisClusterConfig) Descriptor() ([]byte, []int) { return fileDescriptorRedisCluster, []int{0} }
...
func (m *RedisClusterConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterRefreshRate != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintRedisCluster(dAtA, i, uint64(types.SizeOfStdDuration(*m.ClusterRefreshRate)))
		n1, err := types.StdDurationMarshalTo(*m.ClusterRefreshRate, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n1
	...
	if m.ClusterRefreshTimeout != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintRedisCluster(dAtA, i, uint64(types.SizeOfStdDuration(*m.ClusterRefreshTimeout)))
		n2, err := types.StdDurationMarshalTo(*m.ClusterRefreshTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n2
...
func (m *RedisClusterConfig) Size() (n int) {
	...
	_ = l
	if m.ClusterRefreshRate != nil {
		l = types.SizeOfStdDuration(*m.ClusterRefreshRate)
		n += 1 + l + sovRedisCluster(uint64(l))
	}
	if m.ClusterRefreshTimeout != nil {
		l = types.SizeOfStdDuration(*m.ClusterRefreshTimeout)
		n += 1 + l + sovRedisCluster(uint64(l))
	}
	return n
}
...
func (m *RedisClusterConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if err := types.StdDurationUnmarshal(m.ClusterRefreshRate, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			if err := types.StdDurationUnmarshal(m.ClusterRefreshTimeout, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("envoy/config/cluster/redis/redis_cluster.proto", fileDescriptorRedisCluster)
}

var fileDescriptorRedisCluster = []byte{
