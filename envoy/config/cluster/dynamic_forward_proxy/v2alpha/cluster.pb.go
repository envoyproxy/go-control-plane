...
func (*ClusterConfig) Descriptor() ([]byte, []int) { return fileDescriptorCluster, []int{0} }

func (m *ClusterConfig) GetDnsCacheConfig() *envoy_config_common_dynamic_forward_proxy_v2alpha.DnsCacheConfig {
	if m != nil {
...
func init() {
	proto.RegisterFile("envoy/config/cluster/dynamic_forward_proxy/v2alpha/cluster.proto", fileDescriptorCluster)
}
