...
// source: envoy/config/cluster/v3alpha/outlier_detection.proto
...
func (*OutlierDetection) Descriptor() ([]byte, []int) {
	return fileDescriptor_e425517233f09a87, []int{0}
}
...
func init() {
	proto.RegisterType((*OutlierDetection)(nil), "envoy.config.cluster.v3alpha.OutlierDetection")
}

func init() {
	proto.RegisterFile("envoy/config/cluster/v3alpha/outlier_detection.proto", fileDescriptor_e425517233f09a87)
}

var fileDescriptor_e425517233f09a87 = []byte{
	// 762 bytes of a gzipped FileDescriptorProto
	,
}
