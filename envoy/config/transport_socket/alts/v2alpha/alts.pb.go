...
func (*Alts) Descriptor() ([]byte, []int) { return fileDescriptorAlts, []int{0} }
...
func init() {
	proto.RegisterFile("envoy/config/transport_socket/alts/v2alpha/alts.proto", fileDescriptorAlts)
}

var fileDescriptorAlts = []byte{
