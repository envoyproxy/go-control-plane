...
const file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDesc = "" +
	"\n" +
	"<envoy/config/transport_socket/raw_buffer/v2/raw_buffer.proto\x12+envoy.config.transport_socket.raw_buffer.v2\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\"\v\n" +
	"\tRawBufferB\xee\x01\xf2\x98\xfe\x8f\x052\x120envoy.extensions.transport_sockets.raw_buffer.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"9io.envoyproxy.envoy.config.transport_socket.raw_buffer.v2B\x0eRawBufferProtoP\x01Z_github.com/envoyproxy/go-control-plane/envoy/config/transport_socket/raw_buffer/v2;raw_bufferv2b\x06proto3"

var (
	file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDescOnce sync.Once
	file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDescData []byte
)
...
func file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDescGZIP() []byte {
	file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDescOnce.Do(func() {
		file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDesc), len(file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDesc)))
	})
...
var file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_goTypes = []any{
...
func file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDesc), len(file_envoy_config_transport_socket_raw_buffer_v2_raw_buffer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
