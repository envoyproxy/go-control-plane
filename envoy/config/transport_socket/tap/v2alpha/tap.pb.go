...
func (m *Tap) GetTransportSocket() *envoy_api_v2_core.TransportSocket {
	if m != nil {
...
func init() {
	proto.RegisterFile("envoy/config/transport_socket/tap/v2alpha/tap.proto", fileDescriptorTap)
}
