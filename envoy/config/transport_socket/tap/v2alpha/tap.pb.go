...
const file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc = "" +
	"\n" +
	"3envoy/config/transport_socket/tap/v2alpha/tap.proto\x12)envoy.config.transport_socket.tap.v2alpha\x1a\x1cenvoy/api/v2/core/base.proto\x1a,envoy/config/common/tap/v2alpha/common.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc5\x01\n" +
	"\x03Tap\x12e\n" +
	"\rcommon_config\x18\x01 \x01(\v26.envoy.config.common.tap.v2alpha.CommonExtensionConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\fcommonConfig\x12W\n" +
	"\x10transport_socket\x18\x02 \x01(\v2\".envoy.api.v2.core.TransportSocketB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0ftransportSocketB\xd2\x01\xf2\x98\xfe\x8f\x05+\x12)envoy.extensions.transport_sockets.tap.v3\xba\x80\xc8\xd1\x06\x04\b\x01\x10\x01\n" +
	"7io.envoyproxy.envoy.config.transport_socket.tap.v2alphaB\bTapProtoP\x01ZPgithub.com/envoyproxy/go-control-plane/envoy/config/transport_socket/tap/v2alphab\x06proto3"

var (
	file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDescOnce sync.Once
	file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDescData []byte
)
...
func file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDescGZIP() []byte {
	file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDescOnce.Do(func() {
		file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc), len(file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc)))
	})
...
var file_envoy_config_transport_socket_tap_v2alpha_tap_proto_goTypes = []any{
...
func file_envoy_config_transport_socket_tap_v2alpha_tap_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc), len(file_envoy_config_transport_socket_tap_v2alpha_tap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
