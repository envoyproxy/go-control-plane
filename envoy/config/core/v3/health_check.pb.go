...
var file_envoy_config_core_v3_health_check_proto_rawDesc = []byte{
	...
	0x22, 0xb8, 0x1d, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x6c, 0x6f, 0x61, 0x64, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x1a, 0xf3, 0x06, 0x0a, 0x0f, 0x48, 0x74,
...
var file_envoy_config_core_v3_health_check_proto_goTypes = []interface{}{
	...
	(RequestMethod)(0),                    // 19: envoy.config.core.v3.RequestMethod
...
var file_envoy_config_core_v3_health_check_proto_depIdxs = []int32{
	...
	19, // 28: envoy.config.core.v3.HealthCheck.HttpHealthCheck.method:type_name -> envoy.config.core.v3.RequestMethod
	3,  // 29: envoy.config.core.v3.HealthCheck.TcpHealthCheck.send:type_name -> envoy.config.core.v3.HealthCheck.Payload
	3,  // 30: envoy.config.core.v3.HealthCheck.TcpHealthCheck.receive:type_name -> envoy.config.core.v3.HealthCheck.Payload
	15, // 31: envoy.config.core.v3.HealthCheck.GrpcHealthCheck.initial_metadata:type_name -> envoy.config.core.v3.HeaderValueOption
	20, // 32: envoy.config.core.v3.HealthCheck.CustomHealthCheck.typed_config:type_name -> google.protobuf.Any
