...
var file_envoy_config_core_v3_config_source_proto_rawDesc = []byte{
	...
	,
...
var file_envoy_config_core_v3_config_source_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_envoy_config_core_v3_config_source_proto_goTypes = []interface{}{
	...
	(*GrpcService)(nil),            // 10: envoy.config.core.v3.GrpcService
	(*duration.Duration)(nil),      // 11: google.protobuf.Duration
	(*TypedExtensionConfig)(nil),   // 12: envoy.config.core.v3.TypedExtensionConfig
	...
	(*v3.Authority)(nil),           // 16: xds.core.v3.Authority
...
var file_envoy_config_core_v3_config_source_proto_depIdxs = []int32{
	...
	10, // 2: envoy.config.core.v3.ApiConfigSource.grpc_services:type_name -> envoy.config.core.v3.GrpcService
	11, // 3: envoy.config.core.v3.ApiConfigSource.refresh_delay:type_name -> google.protobuf.Duration
	11, // 4: envoy.config.core.v3.ApiConfigSource.request_timeout:type_name -> google.protobuf.Duration
	5,  // 5: envoy.config.core.v3.ApiConfigSource.rate_limit_settings:type_name -> envoy.config.core.v3.RateLimitSettings
	12, // 6: envoy.config.core.v3.ApiConfigSource.config_validators:type_name -> envoy.config.core.v3.TypedExtensionConfig
	0,  // 7: envoy.config.core.v3.SelfConfigSource.transport_api_version:type_name -> envoy.config.core.v3.ApiVersion
	13, // 8: envoy.config.core.v3.RateLimitSettings.max_tokens:type_name -> google.protobuf.UInt32Value
	14, // 9: envoy.config.core.v3.RateLimitSettings.fill_rate:type_name -> google.protobuf.DoubleValue
	15, // 10: envoy.config.core.v3.PathConfigSource.watched_directory:type_name -> envoy.config.core.v3.WatchedDirectory
	16, // 11: envoy.config.core.v3.ConfigSource.authorities:type_name -> xds.core.v3.Authority
	...
	11, // 16: envoy.config.core.v3.ConfigSource.initial_fetch_timeout:type_name -> google.protobuf.Duration
	...
	17, // 19: envoy.config.core.v3.ExtensionConfigSource.default_config:type_name -> google.protobuf.Any
