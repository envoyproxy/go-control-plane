...
func (m *UpstreamLocalityStats) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.TotalIssuedRequests != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TotalIssuedRequests))
		i--
		dAtA[i] = 0x40
	}
	...
	if m.TotalErrorRequests != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TotalErrorRequests))
		i--
		dAtA[i] = 0x20
	}
	if m.TotalRequestsInProgress != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TotalRequestsInProgress))
		i--
		dAtA[i] = 0x18
	}
	if m.TotalSuccessfulRequests != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TotalSuccessfulRequests))
		i--
		dAtA[i] = 0x10
	}
	if m.Locality != nil {
...
func (m *EndpointLoadMetricStats) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.NumRequestsFinishedWithMetric != 0 {
		i = encodeVarint(dAtA, i, uint64(m.NumRequestsFinishedWithMetric))
		i--
		dAtA[i] = 0x10
	}
...
func (m *ClusterStats_DroppedRequests) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.DroppedCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DroppedCount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Category) > 0 {
...
func (m *ClusterStats) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.ClusterServiceName) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ClusterServiceName)))
		i--
		dAtA[i] = 0x32
	}
	...
	if m.TotalDroppedRequests != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TotalDroppedRequests))
		i--
		dAtA[i] = 0x18
	}
...
func (m *UpstreamLocalityStats) SizeVT() (n int) {
	...
	if m.TotalSuccessfulRequests != 0 {
		n += 1 + sov(uint64(m.TotalSuccessfulRequests))
	}
	if m.TotalRequestsInProgress != 0 {
		n += 1 + sov(uint64(m.TotalRequestsInProgress))
	}
	if m.TotalErrorRequests != 0 {
		n += 1 + sov(uint64(m.TotalErrorRequests))
	}
	if len(m.LoadMetricStats) > 0 {
	...
	if m.TotalIssuedRequests != 0 {
		n += 1 + sov(uint64(m.TotalIssuedRequests))
	}
...
func (m *EndpointLoadMetricStats) SizeVT() (n int) {
	...
	if m.NumRequestsFinishedWithMetric != 0 {
		n += 1 + sov(uint64(m.NumRequestsFinishedWithMetric))
	}
	if m.TotalMetricValue != 0 {
		n += 9
	}
...
func (m *ClusterStats) SizeVT() (n int) {
	...
	if m.TotalDroppedRequests != 0 {
		n += 1 + sov(uint64(m.TotalDroppedRequests))
	}
	if m.LoadReportInterval != nil {
