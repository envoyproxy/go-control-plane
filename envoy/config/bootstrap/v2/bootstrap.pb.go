...
const file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc = "" +
	"\n" +
	")envoy/config/bootstrap/v2/bootstrap.proto\x12\x19envoy.config.bootstrap.v2\x1a\x1eenvoy/api/v2/auth/secret.proto\x1a\x1aenvoy/api/v2/cluster.proto\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1cenvoy/api/v2/core/base.proto\x1a%envoy/api/v2/core/config_source.proto\x1a,envoy/api/v2/core/event_service_config.proto\x1a%envoy/api/v2/core/socket_option.proto\x1a\x1benvoy/api/v2/listener.proto\x1a#envoy/config/metrics/v2/stats.proto\x1a,envoy/config/overload/v2alpha/overload.proto\x1a'envoy/config/trace/v2/http_tracer.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xd5\r\n" +
	"\tBootstrap\x12+\n" +
	"\x04node\x18\x01 \x01(\v2\x17.envoy.api.v2.core.NodeR\x04node\x12_\n" +
	"\x10static_resources\x18\x02 \x01(\v24.envoy.config.bootstrap.v2.Bootstrap.StaticResourcesR\x0fstaticResources\x12b\n" +
	"\x11dynamic_resources\x18\x03 \x01(\v25.envoy.config.bootstrap.v2.Bootstrap.DynamicResourcesR\x10dynamicResources\x12R\n" +
	"\x0fcluster_manager\x18\x04 \x01(\v2).envoy.config.bootstrap.v2.ClusterManagerR\x0eclusterManager\x12A\n" +
	"\n" +
	"hds_config\x18\x0e \x01(\v2\".envoy.api.v2.core.ApiConfigSourceR\thdsConfig\x12\x1d\n" +
	"\n" +
	"flags_path\x18\x05 \x01(\tR\tflagsPath\x12C\n" +
	"\vstats_sinks\x18\x06 \x03(\v2\".envoy.config.metrics.v2.StatsSinkR\n" +
	"statsSinks\x12G\n" +
	"\fstats_config\x18\r \x01(\v2$.envoy.config.metrics.v2.StatsConfigR\vstatsConfig\x12^\n" +
	"\x14stats_flush_interval\x18\a \x01(\v2\x19.google.protobuf.DurationB\x11\xfaB\x0e\xaa\x01\v\x1a\x03\b\xac\x022\x04\x10\xc0\x84=R\x12statsFlushInterval\x12?\n" +
	"\bwatchdog\x18\b \x01(\v2#.envoy.config.bootstrap.v2.WatchdogR\bwatchdog\x128\n" +
	"\atracing\x18\t \x01(\v2\x1e.envoy.config.trace.v2.TracingR\atracing\x12F\n" +
	"\aruntime\x18\v \x01(\v2\".envoy.config.bootstrap.v2.RuntimeB\b\xb8\xee\xf2\xd2\x05\x01\x18\x01R\aruntime\x12R\n" +
	"\x0flayered_runtime\x18\x11 \x01(\v2).envoy.config.bootstrap.v2.LayeredRuntimeR\x0elayeredRuntime\x126\n" +
	"\x05admin\x18\f \x01(\v2 .envoy.config.bootstrap.v2.AdminR\x05admin\x12Y\n" +
	"\x10overload_manager\x18\x0f \x01(\v2..envoy.config.overload.v2alpha.OverloadManagerR\x0foverloadManager\x126\n" +
	"\x17enable_dispatcher_stats\x18\x10 \x01(\bR\x15enableDispatcherStats\x12#\n" +
	"\rheader_prefix\x18\x12 \x01(\tR\fheaderPrefix\x12_\n" +
	"\x1dstats_server_version_override\x18\x13 \x01(\v2\x1c.google.protobuf.UInt64ValueR\x1astatsServerVersionOverride\x124\n" +
	"\x17use_tcp_for_dns_lookups\x18\x14 \x01(\bR\x13useTcpForDnsLookups\x1a\xaf\x01\n" +
	"\x0fStaticResources\x124\n" +
	"\tlisteners\x18\x01 \x03(\v2\x16.envoy.api.v2.ListenerR\tlisteners\x121\n" +
	"\bclusters\x18\x02 \x03(\v2\x15.envoy.api.v2.ClusterR\bclusters\x123\n" +
	"\asecrets\x18\x03 \x03(\v2\x19.envoy.api.v2.auth.SecretR\asecrets\x1a\xdb\x01\n" +
	"\x10DynamicResources\x12>\n" +
	"\n" +
	"lds_config\x18\x01 \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceR\tldsConfig\x12>\n" +
	"\n" +
	"cds_config\x18\x02 \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceR\tcdsConfig\x12A\n" +
	"\n" +
	"ads_config\x18\x03 \x01(\v2\".envoy.api.v2.core.ApiConfigSourceR\tadsConfigJ\x04\b\x04\x10\x05J\x04\b\n" +
	"\x10\v\"\xd0\x01\n" +
	"\x05Admin\x12&\n" +
	"\x0faccess_log_path\x18\x01 \x01(\tR\raccessLogPath\x12!\n" +
	"\fprofile_path\x18\x02 \x01(\tR\vprofilePath\x124\n" +
	"\aaddress\x18\x03 \x01(\v2\x1a.envoy.api.v2.core.AddressR\aaddress\x12F\n" +
	"\x0esocket_options\x18\x04 \x03(\v2\x1f.envoy.api.v2.core.SocketOptionR\rsocketOptions\"\xcf\x03\n" +
	"\x0eClusterManager\x12,\n" +
	"\x12local_cluster_name\x18\x01 \x01(\tR\x10localClusterName\x12g\n" +
	"\x11outlier_detection\x18\x02 \x01(\v2:.envoy.config.bootstrap.v2.ClusterManager.OutlierDetectionR\x10outlierDetection\x12O\n" +
	"\x14upstream_bind_config\x18\x03 \x01(\v2\x1d.envoy.api.v2.core.BindConfigR\x12upstreamBindConfig\x12N\n" +
	"\x11load_stats_config\x18\x04 \x01(\v2\".envoy.api.v2.core.ApiConfigSourceR\x0floadStatsConfig\x1a\x84\x01\n" +
	"\x10OutlierDetection\x12$\n" +
	"\x0eevent_log_path\x18\x01 \x01(\tR\feventLogPath\x12J\n" +
	"\revent_service\x18\x02 \x01(\v2%.envoy.api.v2.core.EventServiceConfigR\feventService\"\x94\x02\n" +
	"\bWatchdog\x12<\n" +
	...
	"\fkill_timeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vkillTimeout\x12F\n" +
	"\x11multikill_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\x10multikillTimeout\"\xb2\x01\n" +
	"\aRuntime\x12!\n" +
	...
	"\x04base\x18\x04 \x01(\v2\x17.google.protobuf.StructR\x04base\"\xfc\x04\n" +
	...
	"\n" +
	"disk_layer\x18\x03 \x01(\v21.envoy.config.bootstrap.v2.RuntimeLayer.DiskLayerH\x00R\tdiskLayer\x12U\n" +
	"\vadmin_layer\x18\x04 \x01(\v22.envoy.config.bootstrap.v2.RuntimeLayer.AdminLayerH\x00R\n" +
	"adminLayer\x12R\n" +
	"\n" +
	"rtds_layer\x18\x05 \x01(\v21.envoy.config.bootstrap.v2.RuntimeLayer.RtdsLayerH\x00R\trtdsLayer\x1a\x88\x01\n" +
	"\tDiskLayer\x12!\n" +
	"\fsymlink_root\x18\x01 \x01(\tR\vsymlinkRoot\x12\"\n" +
	"\fsubdirectory\x18\x03 \x01(\tR\fsubdirectory\x124\n" +
	"\x16append_service_cluster\x18\x02 \x01(\bR\x14appendServiceCluster\x1a\f\n" +
	"\n" +
	"AdminLayer\x1aa\n" +
	"\tRtdsLayer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12@\n" +
	"\vrtds_config\x18\x02 \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceR\n" +
	"rtdsConfigB\x16\n" +
	"\x0flayer_specifier\x12\x03\xf8B\x01\"Q\n" +
	"\x0eLayeredRuntime\x12?\n" +
	"\x06layers\x18\x01 \x03(\v2'.envoy.config.bootstrap.v2.RuntimeLayerR\x06layersB\x91\x01\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"'io.envoyproxy.envoy.config.bootstrap.v2B\x0eBootstrapProtoP\x01ZLgithub.com/envoyproxy/go-control-plane/envoy/config/bootstrap/v2;bootstrapv2b\x06proto3"

var (
	file_envoy_config_bootstrap_v2_bootstrap_proto_rawDescOnce sync.Once
	file_envoy_config_bootstrap_v2_bootstrap_proto_rawDescData []byte
)
...
func file_envoy_config_bootstrap_v2_bootstrap_proto_rawDescGZIP() []byte {
	file_envoy_config_bootstrap_v2_bootstrap_proto_rawDescOnce.Do(func() {
		file_envoy_config_bootstrap_v2_bootstrap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc), len(file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc)))
	})
...
var file_envoy_config_bootstrap_v2_bootstrap_proto_goTypes = []any{
...
func file_envoy_config_bootstrap_v2_bootstrap_proto_init() {
	...
	file_envoy_config_bootstrap_v2_bootstrap_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc), len(file_envoy_config_bootstrap_v2_bootstrap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
