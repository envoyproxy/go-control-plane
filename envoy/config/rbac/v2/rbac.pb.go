...
import envoy_type_matcher1 "github.com/envoyproxy/go-control-plane/envoy/type/matcher"
...
type Permission_RequestedServerName struct {
	RequestedServerName *envoy_type_matcher1.StringMatcher `protobuf:"bytes,9,opt,name=requested_server_name,json=requestedServerName,oneof"`
}
...
func (m *Permission) GetRequestedServerName() *envoy_type_matcher1.StringMatcher {
...
func _Permission_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 9: // rule.requested_server_name
		...
		msg := new(envoy_type_matcher1.StringMatcher)
		err := b.DecodeMessage(msg)
...
type Principal_Authenticated struct {
	...
	PrincipalName *envoy_type_matcher1.StringMatcher `protobuf:"bytes,2,opt,name=principal_name,json=principalName" json:"principal_name,omitempty"`
}
...
func (m *Principal_Authenticated) GetPrincipalName() *envoy_type_matcher1.StringMatcher {
	if m != nil {
...
func (m *RBAC) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Policies) > 0 {
		...
		sortkeys.Strings(keysForPolicies)
...
func (m *Permission) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			v := &envoy_type_matcher1.StringMatcher{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *Principal_Authenticated) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrincipalName == nil {
				m.PrincipalName = &envoy_type_matcher1.StringMatcher{}
			}
...
func init() { proto.RegisterFile("envoy/config/rbac/v2/rbac.proto", fileDescriptorRbac) }

var fileDescriptorRbac = []byte{
	// 872 bytes of a gzipped FileDescriptorProto
	,
}
