...
/*
	Package envoy_config_common_dynamic_forward_proxy_v2alpha is a generated protocol buffer package.
...
type DnsCacheConfig struct {
	...
	DnsLookupFamily envoy_api_v22.Cluster_DnsLookupFamily `protobuf:"varint,2,opt,name=dns_lookup_family,json=dnsLookupFamily,proto3,enum=envoy.api.v2.Cluster_DnsLookupFamily" json:"dns_lookup_family,omitempty"`
	...
	DnsRefreshRate *google_protobuf4.Duration `protobuf:"bytes,3,opt,name=dns_refresh_rate,json=dnsRefreshRate" json:"dns_refresh_rate,omitempty"`
	...
	HostTtl *google_protobuf4.Duration `protobuf:"bytes,4,opt,name=host_ttl,json=hostTtl" json:"host_ttl,omitempty"`
	...
	MaxHosts *google_protobuf2.UInt32Value `protobuf:"bytes,5,opt,name=max_hosts,json=maxHosts" json:"max_hosts,omitempty"`
}
...
func (*DnsCacheConfig) Descriptor() ([]byte, []int) { return fileDescriptorDnsCache, []int{0} }
...
func (m *DnsCacheConfig) GetDnsLookupFamily() envoy_api_v22.Cluster_DnsLookupFamily {
	if m != nil {
		return m.DnsLookupFamily
	}
	return envoy_api_v22.Cluster_AUTO
}

func (m *DnsCacheConfig) GetDnsRefreshRate() *google_protobuf4.Duration {
	if m != nil {
...
func (m *DnsCacheConfig) GetHostTtl() *google_protobuf4.Duration {
	if m != nil {
		return m.HostTtl
	}
	return nil
...
func (m *DnsCacheConfig) GetMaxHosts() *google_protobuf2.UInt32Value {
	if m != nil {
		return m.MaxHosts
	}
	return nil
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DnsLookupFamily |= (envoy_api_v22.Cluster_DnsLookupFamily(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			if m.DnsRefreshRate == nil {
				m.DnsRefreshRate = &google_protobuf4.Duration{}
			}
		...
		case 4:
			...
			if m.HostTtl == nil {
				m.HostTtl = &google_protobuf4.Duration{}
			}
		...
		case 5:
			...
			if m.MaxHosts == nil {
				m.MaxHosts = &google_protobuf2.UInt32Value{}
			}
...
func init() {
	proto.RegisterFile("envoy/config/common/dynamic_forward_proxy/v2alpha/dns_cache.proto", fileDescriptorDnsCache)
}

var fileDescriptorDnsCache = []byte{
