...
/*
	Package envoy_config_common_tap_v2alpha is a generated protocol buffer package.
...
import fmt "fmt"
import math "math"
import envoy_service_tap_v2alpha "github.com/envoyproxy/go-control-plane/envoy/service/tap/v2alpha"
...
func (*CommonExtensionConfig) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{0} }
...
type CommonExtensionConfig_AdminConfig struct {
	AdminConfig *AdminConfig `protobuf:"bytes,1,opt,name=admin_config,json=adminConfig,oneof"`
}
type CommonExtensionConfig_StaticConfig struct {
	StaticConfig *envoy_service_tap_v2alpha.TapConfig `protobuf:"bytes,2,opt,name=static_config,json=staticConfig,oneof"`
}
type CommonExtensionConfig_TapdsConfig struct {
	TapdsConfig *CommonExtensionConfig_TapDSConfig `protobuf:"bytes,3,opt,name=tapds_config,json=tapdsConfig,oneof"`
}
...
func (m *CommonExtensionConfig) GetStaticConfig() *envoy_service_tap_v2alpha.TapConfig {
...
func _CommonExtensionConfig_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // config_type.static_config
		...
		msg := new(envoy_service_tap_v2alpha.TapConfig)
		err := b.DecodeMessage(msg)
...
func (*CommonExtensionConfig_TapDSConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCommon, []int{0, 0}
}

func (m *CommonExtensionConfig_TapDSConfig) GetConfigSource() envoy_api_v2_core2.ConfigSource {
	if m != nil {
...
func (*AdminConfig) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1} }
...
func (m *CommonExtensionConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			v := &envoy_service_tap_v2alpha.TapConfig{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func init() { proto.RegisterFile("envoy/config/common/tap/v2alpha/common.proto", fileDescriptorCommon) }
