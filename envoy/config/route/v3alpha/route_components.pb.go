...
// source: envoy/config/route/v3alpha/route_components.proto
...
func (VirtualHost_TlsRequirementType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{0, 0}
}
...
func (RouteAction_ClusterNotFoundResponseCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 0}
}
...
func (RouteAction_InternalRedirectAction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 1}
}
...
func (RedirectAction_RedirectResponseCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{9, 0}
}
...
type VirtualHost struct {
	...
	RequireTls                           VirtualHost_TlsRequirementType `protobuf:"varint,4,opt,name=require_tls,json=requireTls,proto3,enum=envoy.config.route.v3alpha.VirtualHost_TlsRequirementType" json:"require_tls,omitempty"`
	...
	RequestHeadersToAdd                  []*v3alpha.HeaderValueOption   `protobuf:"bytes,7,rep,name=request_headers_to_add,json=requestHeadersToAdd,proto3" json:"request_headers_to_add,omitempty"`
	...
	ResponseHeadersToAdd                 []*v3alpha.HeaderValueOption   `protobuf:"bytes,10,rep,name=response_headers_to_add,json=responseHeadersToAdd,proto3" json:"response_headers_to_add,omitempty"`
...
func (*VirtualHost) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{0}
}
...
func (m *VirtualHost) GetRequestHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
...
func (m *VirtualHost) GetResponseHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
...
func (*FilterAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{1}
}
...
type Route struct {
	...
	Metadata                             *v3alpha.Metadata            `protobuf:"bytes,4,opt,name=metadata,proto3" json:"metadata,omitempty"`
	...
	RequestHeadersToAdd                  []*v3alpha.HeaderValueOption `protobuf:"bytes,9,rep,name=request_headers_to_add,json=requestHeadersToAdd,proto3" json:"request_headers_to_add,omitempty"`
...
func (*Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{2}
}
...
func (m *Route) GetMetadata() *v3alpha.Metadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func (m *Route) GetRequestHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
		return m.RequestHeadersToAdd
	}
	return nil
...
func (m *Route) GetResponseHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
		return m.ResponseHeadersToAdd
	}
	return nil
...
func (*WeightedCluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{3}
}
...
type WeightedCluster_ClusterWeight struct {
	...
	RequestHeadersToAdd                  []*v3alpha.HeaderValueOption `protobuf:"bytes,4,rep,name=request_headers_to_add,json=requestHeadersToAdd,proto3" json:"request_headers_to_add,omitempty"`
	...
	ResponseHeadersToAdd                 []*v3alpha.HeaderValueOption `protobuf:"bytes,5,rep,name=response_headers_to_add,json=responseHeadersToAdd,proto3" json:"response_headers_to_add,omitempty"`
...
func (*WeightedCluster_ClusterWeight) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{3, 0}
}
...
func (m *WeightedCluster_ClusterWeight) GetMetadataMatch() *v3alpha.Metadata {
	if m != nil {
...
func (m *WeightedCluster_ClusterWeight) GetRequestHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
		return m.RequestHeadersToAdd
	}
	return nil
...
func (m *WeightedCluster_ClusterWeight) GetResponseHeadersToAdd() []*v3alpha.HeaderValueOption {
	if m != nil {
		return m.ResponseHeadersToAdd
	}
	return nil
...
type RouteMatch struct {
	...
	RuntimeFraction      *v3alpha.RuntimeFractionalPercent  `protobuf:"bytes,9,opt,name=runtime_fraction,json=runtimeFraction,proto3" json:"runtime_fraction,omitempty"`
...
func (*RouteMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{4}
}
...
type RouteMatch_SafeRegex struct {
	SafeRegex *v3alpha1.RegexMatcher `protobuf:"bytes,10,opt,name=safe_regex,json=safeRegex,proto3,oneof"`
}
...
func (m *RouteMatch) GetSafeRegex() *v3alpha1.RegexMatcher {
...
func (m *RouteMatch) GetRuntimeFraction() *v3alpha.RuntimeFractionalPercent {
	if m != nil {
...
func (*RouteMatch_GrpcRouteMatchOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{4, 0}
}
...
func (*RouteMatch_TlsContextMatchOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{4, 1}
}
...
type CorsPolicy struct {
	...
	AllowOriginStringMatch                []*v3alpha1.StringMatcher `protobuf:"bytes,11,rep,name=allow_origin_string_match,json=allowOriginStringMatch,proto3" json:"allow_origin_string_match,omitempty"`
	...
	ShadowEnabled        *v3alpha.RuntimeFractionalPercent `protobuf:"bytes,10,opt,name=shadow_enabled,json=shadowEnabled,proto3" json:"shadow_enabled,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
func (*CorsPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{5}
}
...
func (m *CorsPolicy) GetAllowOriginStringMatch() []*v3alpha1.StringMatcher {
	if m != nil {
...
type CorsPolicy_FilterEnabled struct {
	FilterEnabled *v3alpha.RuntimeFractionalPercent `protobuf:"bytes,9,opt,name=filter_enabled,json=filterEnabled,proto3,oneof"`
}
...
func (m *CorsPolicy) GetFilterEnabled() *v3alpha.RuntimeFractionalPercent {
...
func (m *CorsPolicy) GetShadowEnabled() *v3alpha.RuntimeFractionalPercent {
	if m != nil {
...
type RouteAction struct {
	...
	ClusterNotFoundResponseCode RouteAction_ClusterNotFoundResponseCode `protobuf:"varint,20,opt,name=cluster_not_found_response_code,json=clusterNotFoundResponseCode,proto3,enum=envoy.config.route.v3alpha.RouteAction_ClusterNotFoundResponseCode" json:"cluster_not_found_response_code,omitempty"`
	MetadataMatch               *v3alpha.Metadata                       `protobuf:"bytes,4,opt,name=metadata_match,json=metadataMatch,proto3" json:"metadata_match,omitempty"`
	...
	Priority                                 v3alpha.RoutingPriority            `protobuf:"varint,11,opt,name=priority,proto3,enum=envoy.config.core.v3alpha.RoutingPriority" json:"priority,omitempty"`
	...
	InternalRedirectAction                   RouteAction_InternalRedirectAction `protobuf:"varint,26,opt,name=internal_redirect_action,json=internalRedirectAction,proto3,enum=envoy.config.route.v3alpha.RouteAction_InternalRedirectAction" json:"internal_redirect_action,omitempty"`
...
func (*RouteAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6}
}
...
func (m *RouteAction) GetMetadataMatch() *v3alpha.Metadata {
	if m != nil {
		return m.MetadataMatch
	}
	return nil
...
func (m *RouteAction) GetPriority() v3alpha.RoutingPriority {
	if m != nil {
		return m.Priority
	}
...
type RouteAction_RequestMirrorPolicy struct {
	...
	RuntimeFraction                 *v3alpha.RuntimeFractionalPercent `protobuf:"bytes,3,opt,name=runtime_fraction,json=runtimeFraction,proto3" json:"runtime_fraction,omitempty"`
	XXX_NoUnkeyedLiteral            struct{}                          `json:"-"`
	XXX_unrecognized                []byte                            `json:"-"`
	XXX_sizecache                   int32                             `json:"-"`
}
...
func (m *RouteAction_RequestMirrorPolicy) GetRuntimeFraction() *v3alpha.RuntimeFractionalPercent {
	if m != nil {
		return m.RuntimeFraction
	}
	return nil
...
func (*RouteAction_HashPolicy_Header) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 1, 0}
}
...
func (*RouteAction_HashPolicy_Cookie) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 1, 1}
}
...
func (*RouteAction_HashPolicy_ConnectionProperties) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 1, 2}
}
...
func (*RouteAction_HashPolicy_QueryParameter) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 1, 3}
}
...
func (*RouteAction_UpgradeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{6, 2}
}
...
func (*RetryPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{7}
}
...
func (*RetryPolicy_RetryPriority) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{7, 0}
}
...
func (*RetryPolicy_RetryHostPredicate) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{7, 1}
}
...
func (*RetryPolicy_RetryBackOff) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{7, 2}
}
...
type HedgePolicy struct {
	...
	AdditionalRequestChance *v3alpha2.FractionalPercent `protobuf:"bytes,2,opt,name=additional_request_chance,json=additionalRequestChance,proto3" json:"additional_request_chance,omitempty"`
...
func (*HedgePolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{8}
}
...
func (m *HedgePolicy) GetAdditionalRequestChance() *v3alpha2.FractionalPercent {
	if m != nil {
...
type RedirectAction struct {
	...
	ResponseCode         RedirectAction_RedirectResponseCode   `protobuf:"varint,3,opt,name=response_code,json=responseCode,proto3,enum=envoy.config.route.v3alpha.RedirectAction_RedirectResponseCode" json:"response_code,omitempty"`
...
func (*RedirectAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{9}
}
...
type DirectResponseAction struct {
	...
	Body                 *v3alpha.DataSource `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (*DirectResponseAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{10}
}
...
func (m *DirectResponseAction) GetBody() *v3alpha.DataSource {
	if m != nil {
		return m.Body
	}
	return nil
...
func (*Decorator) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{11}
}
...
type Tracing struct {
	ClientSampling       *v3alpha2.FractionalPercent `protobuf:"bytes,1,opt,name=client_sampling,json=clientSampling,proto3" json:"client_sampling,omitempty"`
	RandomSampling       *v3alpha2.FractionalPercent `protobuf:"bytes,2,opt,name=random_sampling,json=randomSampling,proto3" json:"random_sampling,omitempty"`
	OverallSampling      *v3alpha2.FractionalPercent `protobuf:"bytes,3,opt,name=overall_sampling,json=overallSampling,proto3" json:"overall_sampling,omitempty"`
...
func (*Tracing) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{12}
}
...
func (m *Tracing) GetClientSampling() *v3alpha2.FractionalPercent {
	if m != nil {
...
func (m *Tracing) GetRandomSampling() *v3alpha2.FractionalPercent {
	if m != nil {
...
func (m *Tracing) GetOverallSampling() *v3alpha2.FractionalPercent {
	if m != nil {
...
type VirtualCluster struct {
	...
	HiddenEnvoyDeprecatedMethod  v3alpha.RequestMethod `protobuf:"varint,3,opt,name=hidden_envoy_deprecated_method,json=hiddenEnvoyDeprecatedMethod,proto3,enum=envoy.config.core.v3alpha.RequestMethod" json:"hidden_envoy_deprecated_method,omitempty"` // Deprecated: Do not use.
	XXX_NoUnkeyedLiteral         struct{}              `json:"-"`
	XXX_unrecognized             []byte                `json:"-"`
	XXX_sizecache                int32                 `json:"-"`
}
...
func (*VirtualCluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{13}
}
...
// Deprecated: Do not use.
func (m *VirtualCluster) GetHiddenEnvoyDeprecatedMethod() v3alpha.RequestMethod {
	if m != nil {
...
func (*RateLimit) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14}
}
...
func (*RateLimit_Action) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0}
}
...
func (*RateLimit_Action_SourceCluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 0}
}
...
func (*RateLimit_Action_DestinationCluster) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 1}
}
...
func (*RateLimit_Action_RequestHeaders) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 2}
}
...
func (*RateLimit_Action_RemoteAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 3}
}
...
func (*RateLimit_Action_GenericKey) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 4}
}
...
func (*RateLimit_Action_HeaderValueMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{14, 0, 5}
}
...
func (*HeaderMatcher) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{15}
}
...
type HeaderMatcher_SafeRegexMatch struct {
	SafeRegexMatch *v3alpha1.RegexMatcher `protobuf:"bytes,11,opt,name=safe_regex_match,json=safeRegexMatch,proto3,oneof"`
}

type HeaderMatcher_RangeMatch struct {
	RangeMatch *v3alpha2.Int64Range `protobuf:"bytes,6,opt,name=range_match,json=rangeMatch,proto3,oneof"`
}
...
func (m *HeaderMatcher) GetSafeRegexMatch() *v3alpha1.RegexMatcher {
...
func (m *HeaderMatcher) GetRangeMatch() *v3alpha2.Int64Range {
...
func (*QueryParameterMatcher) Descriptor() ([]byte, []int) {
	return fileDescriptor_865f979ae88908e2, []int{16}
}
...
type QueryParameterMatcher_StringMatch struct {
	StringMatch *v3alpha1.StringMatcher `protobuf:"bytes,5,opt,name=string_match,json=stringMatch,proto3,oneof"`
}
...
func (m *QueryParameterMatcher) GetStringMatch() *v3alpha1.StringMatcher {
...
func init() {
	proto.RegisterEnum("envoy.config.route.v3alpha.VirtualHost_TlsRequirementType", VirtualHost_TlsRequirementType_name, VirtualHost_TlsRequirementType_value)
	proto.RegisterEnum("envoy.config.route.v3alpha.RouteAction_ClusterNotFoundResponseCode", RouteAction_ClusterNotFoundResponseCode_name, RouteAction_ClusterNotFoundResponseCode_value)
	proto.RegisterEnum("envoy.config.route.v3alpha.RouteAction_InternalRedirectAction", RouteAction_InternalRedirectAction_name, RouteAction_InternalRedirectAction_value)
	proto.RegisterEnum("envoy.config.route.v3alpha.RedirectAction_RedirectResponseCode", RedirectAction_RedirectResponseCode_name, RedirectAction_RedirectResponseCode_value)
	proto.RegisterType((*VirtualHost)(nil), "envoy.config.route.v3alpha.VirtualHost")
	proto.RegisterMapType((map[string]*_struct.Struct)(nil), "envoy.config.route.v3alpha.VirtualHost.HiddenEnvoyDeprecatedPerFilterConfigEntry")
	proto.RegisterMapType((map[string]*any.Any)(nil), "envoy.config.route.v3alpha.VirtualHost.TypedPerFilterConfigEntry")
	proto.RegisterType((*FilterAction)(nil), "envoy.config.route.v3alpha.FilterAction")
	proto.RegisterType((*Route)(nil), "envoy.config.route.v3alpha.Route")
	proto.RegisterMapType((map[string]*_struct.Struct)(nil), "envoy.config.route.v3alpha.Route.HiddenEnvoyDeprecatedPerFilterConfigEntry")
	proto.RegisterMapType((map[string]*any.Any)(nil), "envoy.config.route.v3alpha.Route.TypedPerFilterConfigEntry")
	proto.RegisterType((*WeightedCluster)(nil), "envoy.config.route.v3alpha.WeightedCluster")
	proto.RegisterType((*WeightedCluster_ClusterWeight)(nil), "envoy.config.route.v3alpha.WeightedCluster.ClusterWeight")
	proto.RegisterMapType((map[string]*_struct.Struct)(nil), "envoy.config.route.v3alpha.WeightedCluster.ClusterWeight.HiddenEnvoyDeprecatedPerFilterConfigEntry")
	proto.RegisterMapType((map[string]*any.Any)(nil), "envoy.config.route.v3alpha.WeightedCluster.ClusterWeight.TypedPerFilterConfigEntry")
	proto.RegisterType((*RouteMatch)(nil), "envoy.config.route.v3alpha.RouteMatch")
	proto.RegisterType((*RouteMatch_GrpcRouteMatchOptions)(nil), "envoy.config.route.v3alpha.RouteMatch.GrpcRouteMatchOptions")
	proto.RegisterType((*RouteMatch_TlsContextMatchOptions)(nil), "envoy.config.route.v3alpha.RouteMatch.TlsContextMatchOptions")
	proto.RegisterType((*CorsPolicy)(nil), "envoy.config.route.v3alpha.CorsPolicy")
	proto.RegisterType((*RouteAction)(nil), "envoy.config.route.v3alpha.RouteAction")
	proto.RegisterType((*RouteAction_RequestMirrorPolicy)(nil), "envoy.config.route.v3alpha.RouteAction.RequestMirrorPolicy")
	proto.RegisterType((*RouteAction_HashPolicy)(nil), "envoy.config.route.v3alpha.RouteAction.HashPolicy")
	proto.RegisterType((*RouteAction_HashPolicy_Header)(nil), "envoy.config.route.v3alpha.RouteAction.HashPolicy.Header")
	proto.RegisterType((*RouteAction_HashPolicy_Cookie)(nil), "envoy.config.route.v3alpha.RouteAction.HashPolicy.Cookie")
	proto.RegisterType((*RouteAction_HashPolicy_ConnectionProperties)(nil), "envoy.config.route.v3alpha.RouteAction.HashPolicy.ConnectionProperties")
	proto.RegisterType((*RouteAction_HashPolicy_QueryParameter)(nil), "envoy.config.route.v3alpha.RouteAction.HashPolicy.QueryParameter")
	proto.RegisterType((*RouteAction_UpgradeConfig)(nil), "envoy.config.route.v3alpha.RouteAction.UpgradeConfig")
	proto.RegisterType((*RetryPolicy)(nil), "envoy.config.route.v3alpha.RetryPolicy")
	proto.RegisterType((*RetryPolicy_RetryPriority)(nil), "envoy.config.route.v3alpha.RetryPolicy.RetryPriority")
	proto.RegisterType((*RetryPolicy_RetryHostPredicate)(nil), "envoy.config.route.v3alpha.RetryPolicy.RetryHostPredicate")
	proto.RegisterType((*RetryPolicy_RetryBackOff)(nil), "envoy.config.route.v3alpha.RetryPolicy.RetryBackOff")
	proto.RegisterType((*HedgePolicy)(nil), "envoy.config.route.v3alpha.HedgePolicy")
	proto.RegisterType((*RedirectAction)(nil), "envoy.config.route.v3alpha.RedirectAction")
	proto.RegisterType((*DirectResponseAction)(nil), "envoy.config.route.v3alpha.DirectResponseAction")
	proto.RegisterType((*Decorator)(nil), "envoy.config.route.v3alpha.Decorator")
	proto.RegisterType((*Tracing)(nil), "envoy.config.route.v3alpha.Tracing")
	proto.RegisterType((*VirtualCluster)(nil), "envoy.config.route.v3alpha.VirtualCluster")
	proto.RegisterType((*RateLimit)(nil), "envoy.config.route.v3alpha.RateLimit")
	proto.RegisterType((*RateLimit_Action)(nil), "envoy.config.route.v3alpha.RateLimit.Action")
	proto.RegisterType((*RateLimit_Action_SourceCluster)(nil), "envoy.config.route.v3alpha.RateLimit.Action.SourceCluster")
	proto.RegisterType((*RateLimit_Action_DestinationCluster)(nil), "envoy.config.route.v3alpha.RateLimit.Action.DestinationCluster")
	proto.RegisterType((*RateLimit_Action_RequestHeaders)(nil), "envoy.config.route.v3alpha.RateLimit.Action.RequestHeaders")
	proto.RegisterType((*RateLimit_Action_RemoteAddress)(nil), "envoy.config.route.v3alpha.RateLimit.Action.RemoteAddress")
	proto.RegisterType((*RateLimit_Action_GenericKey)(nil), "envoy.config.route.v3alpha.RateLimit.Action.GenericKey")
	proto.RegisterType((*RateLimit_Action_HeaderValueMatch)(nil), "envoy.config.route.v3alpha.RateLimit.Action.HeaderValueMatch")
	proto.RegisterType((*HeaderMatcher)(nil), "envoy.config.route.v3alpha.HeaderMatcher")
	proto.RegisterType((*QueryParameterMatcher)(nil), "envoy.config.route.v3alpha.QueryParameterMatcher")
}

func init() {
	proto.RegisterFile("envoy/config/route/v3alpha/route_components.proto", fileDescriptor_865f979ae88908e2)
}

var fileDescriptor_865f979ae88908e2 = []byte{
	...
	,
}
