...
type RouteConfiguration struct {
	...
	TypedPerFilterConfig map[string]*any.Any `protobuf:"bytes,16,rep,name=typed_per_filter_config,json=typedPerFilterConfig,proto3" json:"typed_per_filter_config,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *RouteConfiguration) GetTypedPerFilterConfig() map[string]*any.Any {
	if x != nil {
