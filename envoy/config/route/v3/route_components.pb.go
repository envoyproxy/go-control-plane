...
type RetryPolicy struct {
	...
	RetryOptionsPredicates []*v3.TypedExtensionConfig `protobuf:"bytes,12,rep,name=retry_options_predicates,json=retryOptionsPredicates,proto3" json:"retry_options_predicates,omitempty"`
...
func (x *RetryPolicy) GetRetryOptionsPredicates() []*v3.TypedExtensionConfig {
	if x != nil {
