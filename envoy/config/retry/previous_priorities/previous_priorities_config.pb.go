...
/*
Package envoy_config_retry_previous_priorities is a generated protocol buffer package.
...
func (*PreviousPrioritiesConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorPreviousPrioritiesConfig, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/retry/previous_priorities/previous_priorities_config.proto", fileDescriptorPreviousPrioritiesConfig)
}

var fileDescriptorPreviousPrioritiesConfig = []byte{
