...
const file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc = "" +
	"\n" +
	"Henvoy/config/retry/omit_host_metadata/v2/omit_host_metadata_config.proto\x12(envoy.config.retry.omit_host_metadata.v2\x1a\x1cenvoy/api/v2/core/base.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\"\\\n" +
	"\x16OmitHostMetadataConfig\x12B\n" +
	"\x0emetadata_match\x18\x01 \x01(\v2\x1b.envoy.api.v2.core.MetadataR\rmetadataMatchB\xfe\x01\xf2\x98\xfe\x8f\x053\x121envoy.extensions.retry.host.omit_host_metadata.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"6io.envoyproxy.envoy.config.retry.omit_host_metadata.v2B\x1bOmitHostMetadataConfigProtoP\x01Zdgithub.com/envoyproxy/go-control-plane/envoy/config/retry/omit_host_metadata/v2;omit_host_metadatav2b\x06proto3"

var (
	file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDescOnce sync.Once
	file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDescData []byte
)
...
func file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDescGZIP() []byte {
	file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDescOnce.Do(func() {
		file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc), len(file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc)))
	})
...
var file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_goTypes = []any{
...
func file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc), len(file_envoy_config_retry_omit_host_metadata_v2_omit_host_metadata_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
