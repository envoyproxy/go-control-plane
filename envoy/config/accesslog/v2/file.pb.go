...
const file_envoy_config_accesslog_v2_file_proto_rawDesc = "" +
	"\n" +
	"$envoy/config/accesslog/v2/file.proto\x12\x19envoy.config.accesslog.v2\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xde\x01\n" +
	"\rFileAccessLog\x12\x1b\n" +
	"\x04path\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04path\x12\x18\n" +
	"\x06format\x18\x02 \x01(\tH\x00R\x06format\x12:\n" +
	"\vjson_format\x18\x03 \x01(\v2\x17.google.protobuf.StructH\x00R\n" +
	"jsonFormat\x12E\n" +
	"\x11typed_json_format\x18\x04 \x01(\v2\x17.google.protobuf.StructH\x00R\x0ftypedJsonFormatB\x13\n" +
	"\x11access_log_formatB\xbb\x01\xf2\x98\xfe\x8f\x05)\x12'envoy.extensions.access_loggers.file.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"'io.envoyproxy.envoy.config.accesslog.v2B\tFileProtoP\x01ZLgithub.com/envoyproxy/go-control-plane/envoy/config/accesslog/v2;accesslogv2b\x06proto3"

var (
	file_envoy_config_accesslog_v2_file_proto_rawDescOnce sync.Once
	file_envoy_config_accesslog_v2_file_proto_rawDescData []byte
)
...
func file_envoy_config_accesslog_v2_file_proto_rawDescGZIP() []byte {
	file_envoy_config_accesslog_v2_file_proto_rawDescOnce.Do(func() {
		file_envoy_config_accesslog_v2_file_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_accesslog_v2_file_proto_rawDesc), len(file_envoy_config_accesslog_v2_file_proto_rawDesc)))
	})
...
var file_envoy_config_accesslog_v2_file_proto_goTypes = []any{
...
func file_envoy_config_accesslog_v2_file_proto_init() {
	...
	file_envoy_config_accesslog_v2_file_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_accesslog_v2_file_proto_rawDesc), len(file_envoy_config_accesslog_v2_file_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
