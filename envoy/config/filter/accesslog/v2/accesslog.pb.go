...
func (GrpcStatusFilter_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorAccesslog, []int{12, 0}
}
...
type AccessLog_Config struct {
	Config *google_protobuf1.Struct `protobuf:"bytes,3,opt,name=config,oneof"`
}
...
func (m *AccessLog) GetTypedConfig() *google_protobuf.Any {
...
type AccessLogFilter_GrpcStatusFilter struct {
	GrpcStatusFilter *GrpcStatusFilter `protobuf:"bytes,10,opt,name=grpc_status_filter,json=grpcStatusFilter,oneof"`
}
...
type GrpcStatusFilter struct {
	...
	Statuses []GrpcStatusFilter_Status `protobuf:"varint,1,rep,packed,name=statuses,enum=envoy.config.filter.accesslog.v2.GrpcStatusFilter_Status" json:"statuses,omitempty"`
...
func (*GrpcStatusFilter) Descriptor() ([]byte, []int) { return fileDescriptorAccesslog, []int{12} }
