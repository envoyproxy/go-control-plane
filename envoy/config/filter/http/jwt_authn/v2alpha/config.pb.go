...
type RemoteJwks struct {
	...
	CacheDuration *google_protobuf4.Duration `protobuf:"bytes,2,opt,name=cache_duration,json=cacheDuration" json:"cache_duration,omitempty"`
}
...
func (m *RemoteJwks) GetCacheDuration() *google_protobuf4.Duration {
	if m != nil {
...
type JwtRequirement_AllowMissingOrFailed struct {
	AllowMissingOrFailed *google_protobuf6.Empty `protobuf:"bytes,5,opt,name=allow_missing_or_failed,json=allowMissingOrFailed,oneof"`
}
...
func (m *JwtRequirement) GetAllowMissingOrFailed() *google_protobuf6.Empty {
...
type FilterStateRule struct {
	...
	Requires map[string]*JwtRequirement `protobuf:"bytes,3,rep,name=requires" json:"requires,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*FilterStateRule) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{8} }
...
type JwtAuthentication struct {
	...
	// check this one.
	FilterStateRules *FilterStateRule `protobuf:"bytes,3,opt,name=filter_state_rules,json=filterStateRules" json:"filter_state_rules,omitempty"`
}
...
func (*JwtAuthentication) Descriptor() ([]byte, []int) { return fileDescriptorConfig, []int{9} }
...
func (m *FilterStateRule) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Requires) > 0 {
		...
		sortkeys.Strings(keysForRequires)
...
func (m *JwtAuthentication) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Providers) > 0 {
		...
		sortkeys.Strings(keysForProviders)
...
func (m *RemoteJwks) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.CacheDuration == nil {
				m.CacheDuration = &google_protobuf4.Duration{}
			}
