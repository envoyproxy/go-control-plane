...
const file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc = "" +
	"\n" +
	"7envoy/config/filter/http/jwt_authn/v2alpha/config.proto\x12*envoy.config.filter.http.jwt_authn.v2alpha\x1a\x1cenvoy/api/v2/core/base.proto\x1a envoy/api/v2/core/http_uri.proto\x1a)envoy/api/v2/route/route_components.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x80\x04\n" +
	"\vJwtProvider\x12\x1f\n" +
	"\x06issuer\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x06issuer\x12\x1c\n" +
	"\taudiences\x18\x02 \x03(\tR\taudiences\x12Y\n" +
	"\vremote_jwks\x18\x03 \x01(\v26.envoy.config.filter.http.jwt_authn.v2alpha.RemoteJwksH\x00R\n" +
	"remoteJwks\x12>\n" +
	"\n" +
	"local_jwks\x18\x04 \x01(\v2\x1d.envoy.api.v2.core.DataSourceH\x00R\tlocalJwks\x12\x18\n" +
	"\aforward\x18\x05 \x01(\bR\aforward\x12X\n" +
	"\ffrom_headers\x18\x06 \x03(\v25.envoy.config.filter.http.jwt_authn.v2alpha.JwtHeaderR\vfromHeaders\x12\x1f\n" +
	"\vfrom_params\x18\a \x03(\tR\n" +
	"fromParams\x124\n" +
	"\x16forward_payload_header\x18\b \x01(\tR\x14forwardPayloadHeader\x12.\n" +
	"\x13payload_in_metadata\x18\t \x01(\tR\x11payloadInMetadataB\x1c\n" +
	"\x15jwks_source_specifier\x12\x03\xf8B\x01\"\x85\x01\n" +
	"\n" +
	"RemoteJwks\x125\n" +
	"\bhttp_uri\x18\x01 \x01(\v2\x1a.envoy.api.v2.core.HttpUriR\ahttpUri\x12@\n" +
	"\x0ecache_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\rcacheDuration\"K\n" +
	"\tJwtHeader\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12!\n" +
	"\fvalue_prefix\x18\x02 \x01(\tR\vvaluePrefix\"Z\n" +
	"\x15ProviderWithAudiences\x12#\n" +
	"\rprovider_name\x18\x01 \x01(\tR\fproviderName\x12\x1c\n" +
	"\taudiences\x18\x02 \x03(\tR\taudiences\"\xa2\x04\n" +
	"\x0eJwtRequirement\x12%\n" +
	"\rprovider_name\x18\x01 \x01(\tH\x00R\fproviderName\x12y\n" +
	"\x16provider_and_audiences\x18\x02 \x01(\v2A.envoy.config.filter.http.jwt_authn.v2alpha.ProviderWithAudiencesH\x00R\x14providerAndAudiences\x12e\n" +
	"\frequires_any\x18\x03 \x01(\v2@.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementOrListH\x00R\vrequiresAny\x12f\n" +
	"\frequires_all\x18\x04 \x01(\v2A.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementAndListH\x00R\vrequiresAll\x12O\n" +
	"\x17allow_missing_or_failed\x18\x05 \x01(\v2\x16.google.protobuf.EmptyH\x00R\x14allowMissingOrFailed\x12=\n" +
	"\rallow_missing\x18\x06 \x01(\v2\x16.google.protobuf.EmptyH\x00R\fallowMissingB\x0f\n" +
	"\rrequires_type\"\x80\x01\n" +
	"\x14JwtRequirementOrList\x12h\n" +
	"\frequirements\x18\x01 \x03(\v2:.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementB\b\xfaB\x05\x92\x01\x02\b\x02R\frequirements\"\x81\x01\n" +
	"\x15JwtRequirementAndList\x12h\n" +
	"\frequirements\x18\x01 \x03(\v2:.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementB\b\xfaB\x05\x92\x01\x02\b\x02R\frequirements\"\xa9\x01\n" +
	"\x0fRequirementRule\x12>\n" +
	"\x05match\x18\x01 \x01(\v2\x1e.envoy.api.v2.route.RouteMatchB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x12V\n" +
	"\brequires\x18\x02 \x01(\v2:.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementR\brequires\"\x8e\x02\n" +
	"\x0fFilterStateRule\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12e\n" +
	"\brequires\x18\x03 \x03(\v2I.envoy.config.filter.http.jwt_authn.v2alpha.FilterStateRule.RequiresEntryR\brequires\x1aw\n" +
	"\rRequiresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12P\n" +
	"\x05value\x18\x02 \x01(\v2:.envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementR\x05value:\x028\x01\"\xe8\x03\n" +
	"\x11JwtAuthentication\x12j\n" +
	"\tproviders\x18\x01 \x03(\v2L.envoy.config.filter.http.jwt_authn.v2alpha.JwtAuthentication.ProvidersEntryR\tproviders\x12Q\n" +
	"\x05rules\x18\x02 \x03(\v2;.envoy.config.filter.http.jwt_authn.v2alpha.RequirementRuleR\x05rules\x12i\n" +
	"\x12filter_state_rules\x18\x03 \x01(\v2;.envoy.config.filter.http.jwt_authn.v2alpha.FilterStateRuleR\x10filterStateRules\x122\n" +
	"\x15bypass_cors_preflight\x18\x04 \x01(\bR\x13bypassCorsPreflight\x1au\n" +
	"\x0eProvidersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12M\n" +
	"\x05value\x18\x02 \x01(\v27.envoy.config.filter.http.jwt_authn.v2alpha.JwtProviderR\x05value:\x028\x01B\xd6\x01\xf2\x98\xfe\x8f\x05,\x12*envoy.extensions.filters.http.jwt_authn.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"8io.envoyproxy.envoy.config.filter.http.jwt_authn.v2alphaB\vConfigProtoP\x01ZQgithub.com/envoyproxy/go-control-plane/envoy/config/filter/http/jwt_authn/v2alphab\x06proto3"

var (
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescOnce sync.Once
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescData []byte
)
...
func file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescGZIP() []byte {
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescOnce.Do(func() {
		file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc), len(file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc)))
	})
...
var file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_goTypes = []any{
...
func file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_init() {
	...
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[0].OneofWrappers = []any{
		(*JwtProvider_RemoteJwks)(nil),
		(*JwtProvider_LocalJwks)(nil),
	}
	file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc), len(file_envoy_config_filter_http_jwt_authn_v2alpha_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
