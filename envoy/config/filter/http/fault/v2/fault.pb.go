...
type FaultAbort struct {
	...
	// provided.
	Percentage *envoy_type.FractionalPercent `protobuf:"bytes,3,opt,name=percentage" json:"percentage,omitempty"`
}
...
func (m *FaultAbort) GetPercentage() *envoy_type.FractionalPercent {
	if m != nil {
		return m.Percentage
	}
	return nil
...
type HTTPFault struct {
	...
	MaxActiveFaults *google_protobuf2.UInt32Value `protobuf:"bytes,6,opt,name=max_active_faults,json=maxActiveFaults" json:"max_active_faults,omitempty"`
	...
	ResponseRateLimit *envoy_config_filter_fault_v2.FaultRateLimit `protobuf:"bytes,7,opt,name=response_rate_limit,json=responseRateLimit" json:"response_rate_limit,omitempty"`
}
...
func (m *HTTPFault) GetMaxActiveFaults() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *HTTPFault) GetResponseRateLimit() *envoy_config_filter_fault_v2.FaultRateLimit {
	if m != nil {
...
func (m *HTTPFault) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.MaxActiveFaults == nil {
				m.MaxActiveFaults = &google_protobuf2.UInt32Value{}
			}
		...
		case 7:
			...
			if m.ResponseRateLimit == nil {
				m.ResponseRateLimit = &envoy_config_filter_fault_v2.FaultRateLimit{}
			}
