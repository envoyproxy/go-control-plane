...
import fmt "fmt"
import math "math"
import envoy_config_common_dynamic_forward_proxy_v2alpha "github.com/envoyproxy/go-control-plane/envoy/config/common/dynamic_forward_proxy/v2alpha"
...
type FilterConfig struct {
	...
	DnsCacheConfig *envoy_config_common_dynamic_forward_proxy_v2alpha.DnsCacheConfig `protobuf:"bytes,1,opt,name=dns_cache_config,json=dnsCacheConfig" json:"dns_cache_config,omitempty"`
}

func (m *FilterConfig) Reset()                    { *m = FilterConfig{} }
func (m *FilterConfig) String() string            { return proto.CompactTextString(m) }
func (*FilterConfig) ProtoMessage()               {}
func (*FilterConfig) Descriptor() ([]byte, []int) { return fileDescriptorDynamicForwardProxy, []int{0} }

func (m *FilterConfig) GetDnsCacheConfig() *envoy_config_common_dynamic_forward_proxy_v2alpha.DnsCacheConfig {
	if m != nil {
...
func (m *FilterConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.DnsCacheConfig == nil {
				m.DnsCacheConfig = &envoy_config_common_dynamic_forward_proxy_v2alpha.DnsCacheConfig{}
			}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/dynamic_forward_proxy/v2alpha/dynamic_forward_proxy.proto", fileDescriptorDynamicForwardProxy)
}

var fileDescriptorDynamicForwardProxy = []byte{
