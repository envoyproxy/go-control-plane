...
func (*HealthCheck) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_2116fd4f7ef14bb6, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/http/health_check/v2/health_check.proto", fileDescriptor_health_check_2116fd4f7ef14bb6)
}

var fileDescriptor_health_check_2116fd4f7ef14bb6 = []byte{
