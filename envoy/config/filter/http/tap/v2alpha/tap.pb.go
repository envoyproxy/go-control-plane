...
/*
	Package envoy_config_filter_http_tap_v2alpha is a generated protocol buffer package.
...
import fmt "fmt"
import math "math"
import envoy_config_common_tap_v2alpha "github.com/envoyproxy/go-control-plane/envoy/config/common/tap/v2alpha"
...
type Tap struct {
	...
	CommonConfig *envoy_config_common_tap_v2alpha.CommonExtensionConfig `protobuf:"bytes,1,opt,name=common_config,json=commonConfig" json:"common_config,omitempty"`
}

func (m *Tap) Reset()                    { *m = Tap{} }
func (m *Tap) String() string            { return proto.CompactTextString(m) }
func (*Tap) ProtoMessage()               {}
func (*Tap) Descriptor() ([]byte, []int) { return fileDescriptorTap, []int{0} }

func (m *Tap) GetCommonConfig() *envoy_config_common_tap_v2alpha.CommonExtensionConfig {
	if m != nil {
...
func (m *Tap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.CommonConfig == nil {
				m.CommonConfig = &envoy_config_common_tap_v2alpha.CommonExtensionConfig{}
			}
...
func init() { proto.RegisterFile("envoy/config/filter/http/tap/v2alpha/tap.proto", fileDescriptorTap) }
