...
type CsrfPolicy struct {
	...
	FilterEnabled *envoy_api_v2_core.RuntimeFractionalPercent `protobuf:"bytes,1,opt,name=filter_enabled,json=filterEnabled" json:"filter_enabled,omitempty"`
	...
	//   This field defaults to 100/:ref:`HUNDRED
	//   <envoy_api_enum_type.FractionalPercent.DenominatorType>`.
	ShadowEnabled *envoy_api_v2_core.RuntimeFractionalPercent `protobuf:"bytes,2,opt,name=shadow_enabled,json=shadowEnabled" json:"shadow_enabled,omitempty"`
	// Specifies additional source origins that will be allowed in addition to
	// the destination origin.
	//
	// More information on how this can be configured via runtime can be found
	// :ref:`here <csrf-configuration>`.
	AdditionalOrigins []*envoy_type_matcher.StringMatcher `protobuf:"bytes,3,rep,name=additional_origins,json=additionalOrigins" json:"additional_origins,omitempty"`
}
...
func (*CsrfPolicy) Descriptor() ([]byte, []int) { return fileDescriptorCsrf, []int{0} }

func (m *CsrfPolicy) GetFilterEnabled() *envoy_api_v2_core.RuntimeFractionalPercent {
	if m != nil {
...
func (m *CsrfPolicy) GetShadowEnabled() *envoy_api_v2_core.RuntimeFractionalPercent {
	if m != nil {
...
func (m *CsrfPolicy) GetAdditionalOrigins() []*envoy_type_matcher.StringMatcher {
	if m != nil {
...
func (m *CsrfPolicy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.FilterEnabled == nil {
				m.FilterEnabled = &envoy_api_v2_core.RuntimeFractionalPercent{}
			}
		...
		case 3:
			...
			m.AdditionalOrigins = append(m.AdditionalOrigins, &envoy_type_matcher.StringMatcher{})
...
func init() { proto.RegisterFile("envoy/config/filter/http/csrf/v2/csrf.proto", fileDescriptorCsrf) }

var fileDescriptorCsrf = []byte{
