...
const file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc = "" +
	"\n" +
	"/envoy/config/filter/http/buffer/v2/buffer.proto\x12\"envoy.config.filter.http.buffer.v2\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"f\n" +
	"\x06Buffer\x12V\n" +
	"\x11max_request_bytes\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\f\xfaB\t\x8a\x01\x02\x10\x01*\x02 \x00R\x0fmaxRequestBytesJ\x04\b\x02\x10\x03\"\x98\x01\n" +
	"\x0eBufferPerRoute\x12%\n" +
	"\bdisabled\x18\x01 \x01(\bB\a\xfaB\x04j\x02\b\x01H\x00R\bdisabled\x12N\n" +
	"\x06buffer\x18\x02 \x01(\v2*.envoy.config.filter.http.buffer.v2.BufferB\b\xfaB\x05\x8a\x01\x02\x10\x01H\x00R\x06bufferB\x0f\n" +
	"\boverride\x12\x03\xf8B\x01B\xcc\x01\xf2\x98\xfe\x8f\x05)\x12'envoy.extensions.filters.http.buffer.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"0io.envoyproxy.envoy.config.filter.http.buffer.v2B\vBufferProtoP\x01ZRgithub.com/envoyproxy/go-control-plane/envoy/config/filter/http/buffer/v2;bufferv2b\x06proto3"

var (
	file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDescOnce sync.Once
	file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDescData []byte
)
...
func file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDescGZIP() []byte {
	file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDescOnce.Do(func() {
		file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc), len(file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc)))
	})
...
var file_envoy_config_filter_http_buffer_v2_buffer_proto_goTypes = []any{
...
func file_envoy_config_filter_http_buffer_v2_buffer_proto_init() {
	...
	file_envoy_config_filter_http_buffer_v2_buffer_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc), len(file_envoy_config_filter_http_buffer_v2_buffer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
