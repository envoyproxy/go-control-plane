...
const file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc = "" +
	"\n" +
	"+envoy/config/filter/http/gzip/v2/gzip.proto\x12 envoy.config.filter.http.gzip.v2\x1a7envoy/config/filter/http/compressor/v2/compressor.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xd4\x06\n" +
	"\x04Gzip\x12J\n" +
	"\fmemory_level\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\t\xfaB\x06*\x04\x18\t(\x01R\vmemoryLevel\x12G\n" +
	"\x0econtent_length\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueB\x02\x18\x01R\rcontentLength\x12s\n" +
	"\x11compression_level\x18\x03 \x01(\x0e2<.envoy.config.filter.http.gzip.v2.Gzip.CompressionLevel.EnumB\b\xfaB\x05\x82\x01\x02\x10\x01R\x10compressionLevel\x12w\n" +
	"\x14compression_strategy\x18\x04 \x01(\x0e2:.envoy.config.filter.http.gzip.v2.Gzip.CompressionStrategyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x13compressionStrategy\x12%\n" +
	"\fcontent_type\x18\x06 \x03(\tB\x02\x18\x01R\vcontentType\x127\n" +
	"\x16disable_on_etag_header\x18\a \x01(\bB\x02\x18\x01R\x13disableOnEtagHeader\x12E\n" +
	"\x1dremove_accept_encoding_header\x18\b \x01(\bB\x02\x18\x01R\x1aremoveAcceptEncodingHeader\x12H\n" +
	"\vwindow_bits\x18\t \x01(\v2\x1c.google.protobuf.UInt32ValueB\t\xfaB\x06*\x04\x18\x0f(\tR\n" +
	"windowBits\x12R\n" +
	"\n" +
	"compressor\x18\n" +
	" \x01(\v22.envoy.config.filter.http.compressor.v2.CompressorR\n" +
	"compressor\x1a<\n" +
	"\x10CompressionLevel\"(\n" +
	"\x04Enum\x12\v\n" +
	...
	"\x03RLE\x10\x03B\xc2\x01\xf2\x98\xfe\x8f\x05'\x12%envoy.extensions.filters.http.gzip.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	".io.envoyproxy.envoy.config.filter.http.gzip.v2B\tGzipProtoP\x01ZNgithub.com/envoyproxy/go-control-plane/envoy/config/filter/http/gzip/v2;gzipv2b\x06proto3"

var (
	file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDescOnce sync.Once
	file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDescData []byte
)
...
func file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDescGZIP() []byte {
	file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDescOnce.Do(func() {
		file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc), len(file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc)))
	})
...
var file_envoy_config_filter_http_gzip_v2_gzip_proto_goTypes = []any{
...
func file_envoy_config_filter_http_gzip_v2_gzip_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc), len(file_envoy_config_filter_http_gzip_v2_gzip_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
