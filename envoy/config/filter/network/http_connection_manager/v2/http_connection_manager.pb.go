...
func (HttpConnectionManager_CodecType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{0, 0}
}
...
func (HttpConnectionManager_ForwardClientCertDetails) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{0, 1}
}
...
func (HttpConnectionManager_Tracing_OperationName) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{0, 0, 0}
}
...
func (*HttpConnectionManager) Descriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{0}
}
...
func (*HttpConnectionManager_UpgradeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{0, 2}
}
...
func (*Rds) Descriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{1}
}
...
func (*HttpFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{2}
}
...
func (*HttpFilter_DeprecatedV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca, []int{2, 0}
}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/http_connection_manager/v2/http_connection_manager.proto", fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca)
}

var fileDescriptor_http_connection_manager_7e0c73a52f4bf6ca = []byte{
