...
func (*MySQLProxy) Descriptor() ([]byte, []int) { return fileDescriptorMysqlProxy, []int{0} }
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/mysql_proxy/v1alpha1/mysql_proxy.proto", fileDescriptorMysqlProxy)
}

var fileDescriptorMysqlProxy = []byte{
