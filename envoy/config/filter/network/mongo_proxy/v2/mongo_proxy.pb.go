...
const file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc = "" +
	"\n" +
	"<envoy/config/filter/network/mongo_proxy/v2/mongo_proxy.proto\x12*envoy.config.filter.network.mongo_proxy.v2\x1a(envoy/config/filter/fault/v2/fault.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc9\x01\n" +
	"\n" +
	"MongoProxy\x12(\n" +
	...
	"\x05delay\x18\x03 \x01(\v2(.envoy.config.filter.fault.v2.FaultDelayR\x05delay\x122\n" +
	"\x15emit_dynamic_metadata\x18\x04 \x01(\bR\x13emitDynamicMetadataB\xed\x01\xf2\x98\xfe\x8f\x051\x12/envoy.extensions.filters.network.mongo_proxy.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"8io.envoyproxy.envoy.config.filter.network.mongo_proxy.v2B\x0fMongoProxyProtoP\x01Z_github.com/envoyproxy/go-control-plane/envoy/config/filter/network/mongo_proxy/v2;mongo_proxyv2b\x06proto3"

var (
	file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDescOnce sync.Once
	file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDescData []byte
)
...
func file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDescGZIP() []byte {
	file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDescOnce.Do(func() {
		file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc), len(file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc)))
	})
...
var file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_goTypes = []any{
...
func file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc), len(file_envoy_config_filter_network_mongo_proxy_v2_mongo_proxy_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
