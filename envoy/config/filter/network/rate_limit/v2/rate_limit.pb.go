...
type RateLimit struct {
	...
	// success.
	RateLimitService *envoy_config_ratelimit_v2.RateLimitServiceConfig `protobuf:"bytes,6,opt,name=rate_limit_service,json=rateLimitService" json:"rate_limit_service,omitempty"`
}
...
func (m *RateLimit) GetRateLimitService() *envoy_config_ratelimit_v2.RateLimitServiceConfig {
	if m != nil {
