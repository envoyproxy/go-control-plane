...
type RouteAction struct {
	...
	RateLimits []*envoy_api_v2_route.RateLimit `protobuf:"bytes,4,rep,name=rate_limits,json=rateLimits" json:"rate_limits,omitempty"`
}
...
func (m *RouteAction) GetRateLimits() []*envoy_api_v2_route.RateLimit {
	if m != nil {
		return m.RateLimits
	}
	return nil
...
func (*WeightedCluster) Descriptor() ([]byte, []int) { return fileDescriptorRoute, []int{4} }
...
func (m *RouteAction) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.RateLimits = append(m.RateLimits, &envoy_api_v2_route.RateLimit{})
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/thrift_proxy/v2alpha1/route.proto", fileDescriptorRoute)
}
