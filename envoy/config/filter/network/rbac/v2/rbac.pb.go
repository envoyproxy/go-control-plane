...
import fmt "fmt"
import math "math"
import envoy_config_rbac_v2 "github.com/envoyproxy/go-control-plane/envoy/config/rbac/v2"
...
func (RBAC_EnforcementType) EnumDescriptor() ([]byte, []int) { return fileDescriptorRbac, []int{0, 0} }
...
type RBAC struct {
	...
	Rules *envoy_config_rbac_v2.RBAC `protobuf:"bytes,1,opt,name=rules" json:"rules,omitempty"`
	// Shadow rules are not enforced by the filter but will emit stats and logs
	// and can be used for rule testing.
	// If absent, no shadow RBAC policy will be applied.
	ShadowRules *envoy_config_rbac_v2.RBAC `protobuf:"bytes,2,opt,name=shadow_rules,json=shadowRules" json:"shadow_rules,omitempty"`
...
func (m *RBAC) GetRules() *envoy_config_rbac_v2.RBAC {
	if m != nil {
		return m.Rules
	}
	return nil
...
func (m *RBAC) GetShadowRules() *envoy_config_rbac_v2.RBAC {
	if m != nil {
...
func (m *RBAC) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Rules == nil {
				m.Rules = &envoy_config_rbac_v2.RBAC{}
			}
		...
		case 2:
			...
			if m.ShadowRules == nil {
				m.ShadowRules = &envoy_config_rbac_v2.RBAC{}
			}
...
func init() { proto.RegisterFile("envoy/config/filter/network/rbac/v2/rbac.proto", fileDescriptorRbac) }
