...
type ZooKeeperProxy struct {
	...
	MaxPacketBytes *google_protobuf3.UInt32Value `protobuf:"bytes,3,opt,name=max_packet_bytes,json=maxPacketBytes" json:"max_packet_bytes,omitempty"`
}
...
func (*ZooKeeperProxy) Descriptor() ([]byte, []int) { return fileDescriptorZookeeperProxy, []int{0} }
...
func (m *ZooKeeperProxy) GetMaxPacketBytes() *google_protobuf3.UInt32Value {
	if m != nil {
...
func (m *ZooKeeperProxy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.MaxPacketBytes == nil {
				m.MaxPacketBytes = &google_protobuf3.UInt32Value{}
			}
...
func init() {
	proto.RegisterFile("envoy/config/filter/network/zookeeper_proxy/v1alpha1/zookeeper_proxy.proto", fileDescriptorZookeeperProxy)
}

var fileDescriptorZookeeperProxy = []byte{
