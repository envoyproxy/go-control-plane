...
func (ProtocolType) EnumDescriptor() ([]byte, []int) { return fileDescriptorDubboProxy, []int{0} }
...
func (SerializationType) EnumDescriptor() ([]byte, []int) { return fileDescriptorDubboProxy, []int{1} }
...
type DubboProxy struct {
	...
	RouteConfig []*RouteConfiguration `protobuf:"bytes,4,rep,name=route_config,json=routeConfig" json:"route_config,omitempty"`
	// A list of individual Dubbo filters that make up the filter chain for requests made to the
	// Dubbo proxy. Order matters as the filters are processed sequentially. For backwards
	// compatibility, if no dubbo_filters are specified, a default Dubbo router filter
	// (`envoy.filters.dubbo.router`) is used.
	DubboFilters []*DubboFilter `protobuf:"bytes,5,rep,name=dubbo_filters,json=dubboFilters" json:"dubbo_filters,omitempty"`
}
...
func (*DubboFilter) Descriptor() ([]byte, []int) { return fileDescriptorDubboProxy, []int{1} }
...
func (m *DubboFilter) GetConfig() *google_protobuf.Any {
	if m != nil {
		return m.Config
	}
	return nil
