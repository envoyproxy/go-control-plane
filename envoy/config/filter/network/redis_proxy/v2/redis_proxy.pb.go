...
type RedisProxy struct {
	...
	PrefixRoutes RedisProxy_PrefixRoutes `protobuf:"bytes,5,opt,name=prefix_routes,json=prefixRoutes" json:"prefix_routes"`
	...
	DownstreamAuthPassword *envoy_api_v2_core.DataSource `protobuf:"bytes,6,opt,name=downstream_auth_password,json=downstreamAuthPassword" json:"downstream_auth_password,omitempty"`
}
...
func (m *RedisProxy) GetDownstreamAuthPassword() *envoy_api_v2_core.DataSource {
	if m != nil {
...
type RedisProxy_ConnPoolSettings struct {
	...
	// defaults to 3ms.
	BufferFlushTimeout *time.Duration `protobuf:"bytes,5,opt,name=buffer_flush_timeout,json=bufferFlushTimeout,stdduration" json:"buffer_flush_timeout,omitempty"`
}
...
type RedisProxy_PrefixRoutes struct {
	...
	Routes []RedisProxy_PrefixRoutes_Route `protobuf:"bytes,1,rep,name=routes" json:"routes"`
	...
	// Optional catch-all route to forward commands that doesn't match any of the routes. The
	// catch-all route becomes required when no routes are specified.
	CatchAllRoute *RedisProxy_PrefixRoutes_Route `protobuf:"bytes,4,opt,name=catch_all_route,json=catchAllRoute" json:"catch_all_route,omitempty"`
}
...
func (*RedisProxy_PrefixRoutes) Descriptor() ([]byte, []int) {
	return fileDescriptorRedisProxy, []int{0, 1}
}
...
type RedisProxy_PrefixRoutes_Route struct {
	...
	RequestMirrorPolicy []*RedisProxy_PrefixRoutes_Route_RequestMirrorPolicy `protobuf:"bytes,4,rep,name=request_mirror_policy,json=requestMirrorPolicy" json:"request_mirror_policy,omitempty"`
}
...
func (*RedisProxy_PrefixRoutes_Route) Descriptor() ([]byte, []int) {
	return fileDescriptorRedisProxy, []int{0, 1, 0}
}
...
type RedisProxy_PrefixRoutes_Route_RequestMirrorPolicy struct {
	...
	// HUNDRED.
	RuntimeFraction *envoy_api_v2_core.RuntimeFractionalPercent `protobuf:"bytes,2,opt,name=runtime_fraction,json=runtimeFraction" json:"runtime_fraction,omitempty"`
...
func (*RedisProxy_PrefixRoutes_Route_RequestMirrorPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptorRedisProxy, []int{0, 1, 0, 0}
}
...
func (m *RedisProxy_PrefixRoutes_Route_RequestMirrorPolicy) GetRuntimeFraction() *envoy_api_v2_core.RuntimeFractionalPercent {
	if m != nil {
...
type RedisProtocolOptions struct {
	...
	AuthPassword *envoy_api_v2_core.DataSource `protobuf:"bytes,1,opt,name=auth_password,json=authPassword" json:"auth_password,omitempty"`
}
...
func (*RedisProtocolOptions) Descriptor() ([]byte, []int) { return fileDescriptorRedisProxy, []int{1} }

func (m *RedisProtocolOptions) GetAuthPassword() *envoy_api_v2_core.DataSource {
	if m != nil {
...
func (m *RedisProxy_ConnPoolSettings) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OpTimeout != nil {
		...
		n4, err := types.StdDurationMarshalTo(*m.OpTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.BufferFlushTimeout != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRedisProxy(dAtA, i, uint64(types.SizeOfStdDuration(*m.BufferFlushTimeout)))
		n5, err := types.StdDurationMarshalTo(*m.BufferFlushTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *RedisProxy_ConnPoolSettings) Size() (n int) {
	...
	if m.BufferFlushTimeout != nil {
		l = types.SizeOfStdDuration(*m.BufferFlushTimeout)
		n += 1 + l + sovRedisProxy(uint64(l))
	}
	return n
}
...
func (m *RedisProxy) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.DownstreamAuthPassword == nil {
				m.DownstreamAuthPassword = &envoy_api_v2_core.DataSource{}
			}
...
func (m *RedisProxy_ConnPoolSettings) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if err := types.StdDurationUnmarshal(m.BufferFlushTimeout, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RedisProtocolOptions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.AuthPassword == nil {
				m.AuthPassword = &envoy_api_v2_core.DataSource{}
			}
