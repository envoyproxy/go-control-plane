...
const file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc = "" +
	"\n" +
	"6envoy/config/filter/dubbo/router/v2alpha1/router.proto\x12)envoy.config.filter.dubbo.router.v2alpha1\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\"\b\n" +
	"\x06RouterB\xe0\x01\xf2\x98\xfe\x8f\x058\x126envoy.extensions.filters.network.dubbo_proxy.router.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"7io.envoyproxy.envoy.config.filter.dubbo.router.v2alpha1B\vRouterProtoP\x01ZPgithub.com/envoyproxy/go-control-plane/envoy/config/filter/dubbo/router/v2alpha1b\x06proto3"

var (
	file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDescOnce sync.Once
	file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDescData []byte
)
...
func file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDescGZIP() []byte {
	file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDescOnce.Do(func() {
		file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc), len(file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc)))
	})
...
var file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_goTypes = []any{
...
func file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc), len(file_envoy_config_filter_dubbo_router_v2alpha1_router_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
