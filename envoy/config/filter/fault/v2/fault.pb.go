...
type FaultDelay_HeaderDelay_ struct {
	HeaderDelay *FaultDelay_HeaderDelay `protobuf:"bytes,5,opt,name=header_delay,json=headerDelay,oneof"`
}
...
func (*FaultDelay_HeaderDelay) Descriptor() ([]byte, []int) { return fileDescriptorFault, []int{0, 0} }
...
type FaultRateLimit struct {
	...
	Percentage *envoy_type.FractionalPercent `protobuf:"bytes,2,opt,name=percentage" json:"percentage,omitempty"`
}
...
func (*FaultRateLimit) Descriptor() ([]byte, []int) { return fileDescriptorFault, []int{1} }
...
type FaultRateLimit_FixedLimit_ struct {
	FixedLimit *FaultRateLimit_FixedLimit `protobuf:"bytes,1,opt,name=fixed_limit,json=fixedLimit,oneof"`
}
type FaultRateLimit_HeaderLimit_ struct {
	HeaderLimit *FaultRateLimit_HeaderLimit `protobuf:"bytes,3,opt,name=header_limit,json=headerLimit,oneof"`
}
...
func (m *FaultRateLimit) GetPercentage() *envoy_type.FractionalPercent {
	if m != nil {
		return m.Percentage
	}
	return nil
...
func (*FaultRateLimit_FixedLimit) Descriptor() ([]byte, []int) {
	return fileDescriptorFault, []int{1, 0}
}
...
func (*FaultRateLimit_HeaderLimit) Descriptor() ([]byte, []int) {
	return fileDescriptorFault, []int{1, 1}
}
...
var fileDescriptorFault = []byte{
	...
	,
}
