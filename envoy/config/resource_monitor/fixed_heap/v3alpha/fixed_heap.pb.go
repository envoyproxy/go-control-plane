...
package envoy_config_resource_monitor_fixed_heap_v3alpha
...
func (*FixedHeapConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_57748e5de5032989, []int{0}
}
...
func init() {
	proto.RegisterType((*FixedHeapConfig)(nil), "envoy.config.resource_monitor.fixed_heap.v3alpha.FixedHeapConfig")
}

func init() {
	proto.RegisterFile("envoy/config/resource_monitor/fixed_heap/v3alpha/fixed_heap.proto", fileDescriptor_57748e5de5032989)
}

var fileDescriptor_57748e5de5032989 = []byte{
	...
	0xcf, 0x48, 0x4d, 0x2c, 0xd0, 0x2f, 0x33, 0x4e, 0xcc, 0x29, 0xc8, 0x48, 0x44, 0x12, 0xd2, 0x2b,
	...
	0xec, 0x4a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xcf, 0xd4, 0xd0, 0x53, 0x35, 0x01, 0x00,
	0x00,
}
