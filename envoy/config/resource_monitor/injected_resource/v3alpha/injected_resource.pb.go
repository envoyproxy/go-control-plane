...
package envoy_config_resource_monitor_injected_resource_v3alpha
...
func (*InjectedResourceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_ddbaba630446dd16, []int{0}
}
...
func init() {
	proto.RegisterType((*InjectedResourceConfig)(nil), "envoy.config.resource_monitor.injected_resource.v3alpha.InjectedResourceConfig")
}

func init() {
	proto.RegisterFile("envoy/config/resource_monitor/injected_resource/v3alpha/injected_resource.proto", fileDescriptor_ddbaba630446dd16)
}

var fileDescriptor_ddbaba630446dd16 = []byte{
	...
	0x49, 0x4d, 0x89, 0x87, 0xc9, 0xe8, 0x97, 0x19, 0x27, 0xe6, 0x14, 0x64, 0x24, 0x62, 0xca, 0xe8,
	...
	0x20, 0x00, 0x00, 0xff, 0xff, 0x3e, 0xec, 0x0d, 0x8f, 0x4c, 0x01, 0x00, 0x00,
}
