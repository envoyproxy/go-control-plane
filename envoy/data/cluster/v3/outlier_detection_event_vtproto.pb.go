...
func (m *OutlierDetectionEvent) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.NumEjections != 0 {
		i = encodeVarint(dAtA, i, uint64(m.NumEjections))
		i--
		dAtA[i] = 0x38
	}
	if m.Action != 0 {
	...
	if len(m.UpstreamUrl) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.UpstreamUrl)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *OutlierEjectSuccessRate) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.ClusterSuccessRateEjectionThreshold != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ClusterSuccessRateEjectionThreshold))
		i--
		dAtA[i] = 0x18
	}
	if m.ClusterAverageSuccessRate != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ClusterAverageSuccessRate))
		i--
		dAtA[i] = 0x10
	}
	if m.HostSuccessRate != 0 {
		i = encodeVarint(dAtA, i, uint64(m.HostSuccessRate))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *OutlierEjectSuccessRate) SizeVT() (n int) {
	...
	_ = l
	if m.HostSuccessRate != 0 {
		n += 1 + sov(uint64(m.HostSuccessRate))
	}
	if m.ClusterAverageSuccessRate != 0 {
		n += 1 + sov(uint64(m.ClusterAverageSuccessRate))
	}
	if m.ClusterSuccessRateEjectionThreshold != 0 {
		n += 1 + sov(uint64(m.ClusterSuccessRateEjectionThreshold))
	}
	n += len(m.unknownFields)
	return n
}
