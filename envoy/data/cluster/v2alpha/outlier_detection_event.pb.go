...
const file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc = "" +
	"\n" +
	"8envoy/data/cluster/v2alpha/outlier_detection_event.proto\x12\x1aenvoy.data.cluster.v2alpha\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xc2\x06\n" +
	"\x15OutlierDetectionEvent\x12M\n" +
	"\x04type\x18\x01 \x01(\x0e2/.envoy.data.cluster.v2alpha.OutlierEjectionTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04type\x128\n" +
	...
	"\fcluster_name\x18\x04 \x01(\tB\a\xfaB\x04r\x02 \x01R\vclusterName\x12*\n" +
	"\fupstream_url\x18\x05 \x01(\tB\a\xfaB\x04r\x02 \x01R\vupstreamUrl\x12D\n" +
	"\x06action\x18\x06 \x01(\x0e2\".envoy.data.cluster.v2alpha.ActionB\b\xfaB\x05\x82\x01\x02\x10\x01R\x06action\x12#\n" +
	"\rnum_ejections\x18\a \x01(\rR\fnumEjections\x12\x1a\n" +
	"\benforced\x18\b \x01(\bR\benforced\x12n\n" +
	"\x18eject_success_rate_event\x18\t \x01(\v23.envoy.data.cluster.v2alpha.OutlierEjectSuccessRateH\x00R\x15ejectSuccessRateEvent\x12m\n" +
	"\x17eject_consecutive_event\x18\n" +
	" \x01(\v23.envoy.data.cluster.v2alpha.OutlierEjectConsecutiveH\x00R\x15ejectConsecutiveEvent\x12\x80\x01\n" +
	"\x1eeject_failure_percentage_event\x18\v \x01(\v29.envoy.data.cluster.v2alpha.OutlierEjectFailurePercentageH\x00R\x1bejectFailurePercentageEventB\f\n" +
	"\x05event\x12\x03\xf8B\x01\"\xf7\x01\n" +
	...
	"'cluster_success_rate_ejection_threshold\x18\x03 \x01(\rB\a\xfaB\x04*\x02\x18dR#clusterSuccessRateEjectionThreshold\"\x19\n" +
	"\x17OutlierEjectConsecutive\"T\n" +
	"\x1dOutlierEjectFailurePercentage\x123\n" +
	"\x11host_success_rate\x18\x01 \x01(\rB\a\xfaB\x04*\x02\x18dR\x0fhostSuccessRate*\xdf\x01\n" +
	...
	"\aUNEJECT\x10\x01B\xb0\x01\xf2\x98\xfe\x8f\x05\x17\x12\x15envoy.data.cluster.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"(io.envoyproxy.envoy.data.cluster.v2alphaB\x1aOutlierDetectionEventProtoP\x01ZAgithub.com/envoyproxy/go-control-plane/envoy/data/cluster/v2alphab\x06proto3"

var (
	file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDescOnce sync.Once
	file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDescData []byte
)
...
func file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDescGZIP() []byte {
	file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDescOnce.Do(func() {
		file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc), len(file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc)))
	})
...
var file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_goTypes = []any{
...
func file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_init() {
	...
	file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc), len(file_envoy_data_cluster_v2alpha_outlier_detection_event_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
