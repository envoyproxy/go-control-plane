...
func (m *ConnectionProperties) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.SentBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.SentBytes))
		i--
		dAtA[i] = 0x10
	}
	if m.ReceivedBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ReceivedBytes))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *AccessLogCommon) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.AccessLogType != 0 {
		i = encodeVarint(dAtA, i, uint64(m.AccessLogType))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x88
	...
	if m.UpstreamWireBytesReceived != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpstreamWireBytesReceived))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x80
	...
	if m.UpstreamWireBytesSent != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpstreamWireBytesSent))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf8
	...
	if m.DownstreamWireBytesReceived != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DownstreamWireBytesReceived))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xf0
	...
	if m.DownstreamWireBytesSent != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DownstreamWireBytesSent))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe8
	...
	if len(m.DownstreamTransportFailureReason) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.DownstreamTransportFailureReason)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe2
	...
	if len(m.ConnectionTerminationDetails) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ConnectionTerminationDetails)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
	...
	if m.UpstreamRequestAttemptCount != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpstreamRequestAttemptCount))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc0
	...
	if len(m.RouteName) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.RouteName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	...
	if len(m.UpstreamTransportFailureReason) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.UpstreamTransportFailureReason)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.UpstreamCluster) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.UpstreamCluster)))
		i--
		dAtA[i] = 0x7a
	}
...
func (m *TLSProperties) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.Ja3Fingerprint) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Ja3Fingerprint)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.TlsSessionId) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.TlsSessionId)))
		i--
		dAtA[i] = 0x32
	}
	...
	if len(m.TlsSniHostname) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.TlsSniHostname)))
		i--
		dAtA[i] = 0x1a
	}
	...
	if m.TlsVersion != 0 {
		i = encodeVarint(dAtA, i, uint64(m.TlsVersion))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *HTTPRequestProperties) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.DownstreamHeaderBytesReceived != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DownstreamHeaderBytesReceived))
		i--
		dAtA[i] = 0x78
	}
	if m.UpstreamHeaderBytesSent != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpstreamHeaderBytesSent))
		i--
		dAtA[i] = 0x70
	}
	...
	if m.RequestBodyBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.RequestBodyBytes))
		i--
		dAtA[i] = 0x60
	}
	if m.RequestHeadersBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.RequestHeadersBytes))
		i--
		dAtA[i] = 0x58
	}
	if len(m.OriginalPath) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.OriginalPath)))
		i--
		dAtA[i] = 0x52
	}
	...
	if m.RequestMethod != 0 {
		i = encodeVarint(dAtA, i, uint64(m.RequestMethod))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *HTTPResponseProperties) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.DownstreamHeaderBytesSent != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DownstreamHeaderBytesSent))
		i--
		dAtA[i] = 0x40
	}
	if m.UpstreamHeaderBytesReceived != 0 {
		i = encodeVarint(dAtA, i, uint64(m.UpstreamHeaderBytesReceived))
		i--
		dAtA[i] = 0x38
	}
	if len(m.ResponseCodeDetails) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ResponseCodeDetails)))
		i--
		dAtA[i] = 0x32
	}
	...
	if m.ResponseBodyBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ResponseBodyBytes))
		i--
		dAtA[i] = 0x18
	}
	if m.ResponseHeadersBytes != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ResponseHeadersBytes))
		i--
		dAtA[i] = 0x10
	}
...
func (m *ConnectionProperties) SizeVT() (n int) {
	...
	_ = l
	if m.ReceivedBytes != 0 {
		n += 1 + sov(uint64(m.ReceivedBytes))
	}
	if m.SentBytes != 0 {
		n += 1 + sov(uint64(m.SentBytes))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *AccessLogCommon) SizeVT() (n int) {
	...
	if m.UpstreamRequestAttemptCount != 0 {
		n += 2 + sov(uint64(m.UpstreamRequestAttemptCount))
	}
	...
	if m.DownstreamWireBytesSent != 0 {
		n += 2 + sov(uint64(m.DownstreamWireBytesSent))
	}
	if m.DownstreamWireBytesReceived != 0 {
		n += 2 + sov(uint64(m.DownstreamWireBytesReceived))
	}
	if m.UpstreamWireBytesSent != 0 {
		n += 2 + sov(uint64(m.UpstreamWireBytesSent))
	}
	if m.UpstreamWireBytesReceived != 0 {
		n += 2 + sov(uint64(m.UpstreamWireBytesReceived))
	}
	if m.AccessLogType != 0 {
		n += 2 + sov(uint64(m.AccessLogType))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *HTTPRequestProperties) SizeVT() (n int) {
	...
	if m.RequestHeadersBytes != 0 {
		n += 1 + sov(uint64(m.RequestHeadersBytes))
	}
	if m.RequestBodyBytes != 0 {
		n += 1 + sov(uint64(m.RequestBodyBytes))
	}
	if len(m.RequestHeaders) > 0 {
	...
	if m.UpstreamHeaderBytesSent != 0 {
		n += 1 + sov(uint64(m.UpstreamHeaderBytesSent))
	}
	if m.DownstreamHeaderBytesReceived != 0 {
		n += 1 + sov(uint64(m.DownstreamHeaderBytesReceived))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *HTTPResponseProperties) SizeVT() (n int) {
	...
	if m.ResponseHeadersBytes != 0 {
		n += 1 + sov(uint64(m.ResponseHeadersBytes))
	}
	if m.ResponseBodyBytes != 0 {
		n += 1 + sov(uint64(m.ResponseBodyBytes))
	}
	if len(m.ResponseHeaders) > 0 {
	...
	if m.UpstreamHeaderBytesReceived != 0 {
		n += 1 + sov(uint64(m.UpstreamHeaderBytesReceived))
	}
	if m.DownstreamHeaderBytesSent != 0 {
		n += 1 + sov(uint64(m.DownstreamHeaderBytesSent))
	}
	n += len(m.unknownFields)
	return n
}
