...
type TLSProperties struct {
	...
	LocalCertificateProperties *TLSProperties_CertificateProperties `protobuf:"bytes,4,opt,name=local_certificate_properties,json=localCertificateProperties" json:"local_certificate_properties,omitempty"`
	// Properties of the peer certificate used to negotiate TLS.
	PeerCertificateProperties *TLSProperties_CertificateProperties `protobuf:"bytes,5,opt,name=peer_certificate_properties,json=peerCertificateProperties" json:"peer_certificate_properties,omitempty"`
	// The TLS session ID.
...
type TLSProperties_CertificateProperties struct {
	...
	SubjectAltName []*TLSProperties_CertificateProperties_SubjectAltName `protobuf:"bytes,1,rep,name=subject_alt_name,json=subjectAltName" json:"subject_alt_name,omitempty"`
...
func (*TLSProperties_CertificateProperties_SubjectAltName) Descriptor() ([]byte, []int) {
	return fileDescriptorAccesslog, []int{4, 0, 0}
}
...
func (m *HTTPRequestProperties) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RequestHeaders) > 0 {
		...
		sortkeys.Strings(keysForRequestHeaders)
...
func (m *HTTPResponseProperties) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ResponseHeaders) > 0 {
		...
		sortkeys.Strings(keysForResponseHeaders)
	...
	if len(m.ResponseTrailers) > 0 {
		...
		sortkeys.Strings(keysForResponseTrailers)
