...
const (
	...
	HealthCheckerType_UDP            HealthCheckerType = 6
)
...
const file_envoy_data_core_v3_health_check_event_proto_rawDesc = "" +
	...
	"\x0eDYNAMIC_MODULE\x10\x05\x12\a\n" +
	"\x03UDP\x10\x06B\x85\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
