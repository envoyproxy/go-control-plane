...
func (HealthCheckFailureType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{0}
}
...
func (HealthCheckerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{1}
}
...
func (*HealthCheckAddHealthy) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{2}
}
...
func (*HealthCheckFailure) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{3}
}
...
func (*DegradedHealthyHost) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{4}
}
...
func (*NoLongerDegradedHost) Descriptor() ([]byte, []int) {
	return fileDescriptor_health_check_event_b5a8bc5fc8458d3f, []int{5}
}
...
func init() {
	proto.RegisterFile("envoy/data/core/v2alpha/health_check_event.proto", fileDescriptor_health_check_event_b5a8bc5fc8458d3f)
}

var fileDescriptor_health_check_event_b5a8bc5fc8458d3f = []byte{
	...
	,
}
