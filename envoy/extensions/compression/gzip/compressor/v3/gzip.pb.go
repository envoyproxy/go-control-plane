...
const file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc = "" +
	"\n" +
	":envoy/extensions/compression/gzip/compressor/v3/gzip.proto\x12/envoy.extensions.compression.gzip.compressor.v3\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x89\a\n" +
	"\x04Gzip\x12J\n" +
	"\fmemory_level\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\t\xfaB\x06*\x04\x18\t(\x01R\vmemoryLevel\x12}\n" +
	"\x11compression_level\x18\x02 \x01(\x0e2F.envoy.extensions.compression.gzip.compressor.v3.Gzip.CompressionLevelB\b\xfaB\x05\x82\x01\x02\x10\x01R\x10compressionLevel\x12\x86\x01\n" +
	"\x14compression_strategy\x18\x03 \x01(\x0e2I.envoy.extensions.compression.gzip.compressor.v3.Gzip.CompressionStrategyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x13compressionStrategy\x12H\n" +
	"\vwindow_bits\x18\x04 \x01(\v2\x1c.google.protobuf.UInt32ValueB\t\xfaB\x06*\x04\x18\x0f(\tR\n" +
	"windowBits\x12I\n" +
	"\n" +
	"chunk_size\x18\x05 \x01(\v2\x1c.google.protobuf.UInt32ValueB\f\xfaB\t*\a\x18\x80\x80\x04(\x80 R\tchunkSize\"_\n" +
	"\x13CompressionStrategy\x12\x14\n" +
	"\x10DEFAULT_STRATEGY\x10\x00\x12\f\n" +
	"\bFILTERED\x10\x01\x12\x10\n" +
	"\fHUFFMAN_ONLY\x10\x02\x12\a\n" +
	"\x03RLE\x10\x03\x12\t\n" +
	"\x05FIXED\x10\x04\"\xb6\x02\n" +
	"\x10CompressionLevel\x12\x17\n" +
	"\x13DEFAULT_COMPRESSION\x10\x00\x12\x0e\n" +
	"\n" +
	"BEST_SPEED\x10\x01\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_1\x10\x01\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_2\x10\x02\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_3\x10\x03\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_4\x10\x04\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_5\x10\x05\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_6\x10\x06\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_7\x10\a\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_8\x10\b\x12\x17\n" +
	"\x13COMPRESSION_LEVEL_9\x10\t\x12\x14\n" +
	"\x10BEST_COMPRESSION\x10\t\x1a\x02\x10\x01B\xb9\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"=io.envoyproxy.envoy.extensions.compression.gzip.compressor.v3B\tGzipProtoP\x01Zcgithub.com/envoyproxy/go-control-plane/envoy/extensions/compression/gzip/compressor/v3;compressorv3b\x06proto3"

var (
	file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDescOnce sync.Once
	file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDescData []byte
)
...
func file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDescGZIP() []byte {
	file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc), len(file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc)))
	})
...
var file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_goTypes = []any{
...
func file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc), len(file_envoy_extensions_compression_gzip_compressor_v3_gzip_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
