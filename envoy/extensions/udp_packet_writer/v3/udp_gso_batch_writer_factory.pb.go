...
const file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDesc = "" +
	"\n" +
	...
	"\x18UdpGsoBatchWriterFactoryB\xc0\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"3io.envoyproxy.envoy.extensions.udp_packet_writer.v3B\x1dUdpGsoBatchWriterFactoryProtoP\x01Z`github.com/envoyproxy/go-control-plane/envoy/extensions/udp_packet_writer/v3;udp_packet_writerv3b\x06proto3"

var (
	file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDescOnce sync.Once
	file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDescData []byte
)
...
func file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDescGZIP() []byte {
	file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDesc), len(file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDesc)))
	})
...
var file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_goTypes = []any{
...
func file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDesc), len(file_envoy_extensions_udp_packet_writer_v3_udp_gso_batch_writer_factory_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
