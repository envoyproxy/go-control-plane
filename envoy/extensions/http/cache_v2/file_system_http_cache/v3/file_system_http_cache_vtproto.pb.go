...
func (m *FileSystemHttpCacheV2Config) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FileSystemHttpCacheV2Config) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *FileSystemHttpCacheV2Config) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *FileSystemHttpCacheV2Config) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
