...
const file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDesc = "" +
	"\n" +
	"2envoy/extensions/regex_engines/v3/google_re2.proto\x12!envoy.extensions.regex_engines.v3\x1a\x1dudpa/annotations/status.proto\"\v\n" +
	"\tGoogleRE2B\xa5\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"/io.envoyproxy.envoy.extensions.regex_engines.v3B\x0eGoogleRe2ProtoP\x01ZXgithub.com/envoyproxy/go-control-plane/envoy/extensions/regex_engines/v3;regex_enginesv3b\x06proto3"

var (
	file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDescOnce sync.Once
	file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDescData []byte
)
...
func file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDescGZIP() []byte {
	file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDesc), len(file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDesc)))
	})
...
var file_envoy_extensions_regex_engines_v3_google_re2_proto_goTypes = []any{
...
func file_envoy_extensions_regex_engines_v3_google_re2_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDesc), len(file_envoy_extensions_regex_engines_v3_google_re2_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
