...
func (*ThriftProxy) Descriptor() ([]byte, []int) {
	return fileDescriptor_thrift_proxy_18c039d9e1a061ba, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/extensions/filters/network/thrift_proxy/v2alpha1/thrift_proxy.proto", fileDescriptor_thrift_proxy_18c039d9e1a061ba)
}

var fileDescriptor_thrift_proxy_18c039d9e1a061ba = []byte{
