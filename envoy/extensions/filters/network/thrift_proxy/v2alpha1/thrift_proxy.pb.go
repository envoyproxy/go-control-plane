...
func (*ThriftProxy) Descriptor() ([]byte, []int) {
	return fileDescriptor_thrift_proxy_53fdc36881eb5b5c, []int{0}
}
...
func init() {
	proto.RegisterFile("envoy/extensions/filters/network/thrift_proxy/v2alpha1/thrift_proxy.proto", fileDescriptor_thrift_proxy_53fdc36881eb5b5c)
}

var fileDescriptor_thrift_proxy_53fdc36881eb5b5c = []byte{
