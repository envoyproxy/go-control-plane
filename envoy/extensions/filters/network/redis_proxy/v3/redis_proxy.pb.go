...
const file_envoy_extensions_filters_network_redis_proxy_v3_redis_proxy_proto_rawDesc = "" +
	...
	"5envoy.config.filter.network.redis_proxy.v2.RedisProxyJ\x04\b\x02\x10\x03R\acluster\"\xce\x02\n" +
	...
	"\aaws_iam\x18\x03 \x01(\v27.envoy.extensions.filters.network.redis_proxy.v3.AwsIamR\x06awsIam:F\x9aň\x1eA\n" +
