...
func (m *HttpConnectionManager_ProxyStatusConfig_LiteralProxyName) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	i = encodeVarint(dAtA, i, uint64(len(m.LiteralProxyName)))
	i--
	dAtA[i] = 0x32
	return len(dAtA) - i, nil
}
...
func (m *HttpConnectionManager) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if m.PathWithEscapedSlashesAction != 0 {
		i = encodeVarint(dAtA, i, uint64(m.PathWithEscapedSlashesAction))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0xe8
	...
	if m.ServerHeaderTransformation != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ServerHeaderTransformation))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x90
	...
	if len(m.Via) > 0 {
		i -= len(m.Via)
		copy(dAtA[i:], m.Via)
		i = encodeVarint(dAtA, i, uint64(len(m.Via)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	...
	if m.XffNumTrustedHops != 0 {
		i = encodeVarint(dAtA, i, uint64(m.XffNumTrustedHops))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x98
	...
	if m.ForwardClientCertDetails != 0 {
		i = encodeVarint(dAtA, i, uint64(m.ForwardClientCertDetails))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if m.CodecType != 0 {
		i = encodeVarint(dAtA, i, uint64(m.CodecType))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *ScopedRoutes_ScopeKeyBuilder_FragmentBuilder_HeaderValueExtractor_KvElement) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.Separator) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.Separator)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *ScopedRoutes_ScopeKeyBuilder_FragmentBuilder_HeaderValueExtractor) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.ElementSeparator) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.ElementSeparator)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
...
func (m *ScopedRds) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if len(m.SrdsResourcesLocator) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.SrdsResourcesLocator)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *HttpConnectionManager) SizeVT() (n int) {
	...
	if m.ForwardClientCertDetails != 0 {
		n += 2 + sov(uint64(m.ForwardClientCertDetails))
	}
	if m.SetCurrentClientCertDetails != nil {
	...
	if m.XffNumTrustedHops != 0 {
		n += 2 + sov(uint64(m.XffNumTrustedHops))
	}
	if m.RepresentIpv4RemoteAddressAsIpv4MappedIpv6 {
		n += 3
	}
	...
	if m.ServerHeaderTransformation != 0 {
		n += 2 + sov(uint64(m.ServerHeaderTransformation))
	}
	if m.CommonHttpProtocolOptions != nil {
	...
	if m.PathWithEscapedSlashesAction != 0 {
		n += 2 + sov(uint64(m.PathWithEscapedSlashesAction))
	}
	if len(m.OriginalIpDetectionExtensions) > 0 {
