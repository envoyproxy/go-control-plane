...
const file_envoy_extensions_filters_http_oauth2_v3_oauth_proto_rawDesc = "" +
	...
	"\x1bcode_verifier_cookie_config\x18\a \x01(\v25.envoy.extensions.filters.http.oauth2.v3.CookieConfigR\x18codeVerifierCookieConfig\"\x8b\x06\n" +
	...
	"hmacSecret\x12i\n" +
	"\fcookie_names\x18\x04 \x01(\v2F.envoy.extensions.filters.http.oauth2.v3.OAuth2Credentials.CookieNamesR\vcookieNames\x12#\n" +
	"\rcookie_domain\x18\x05 \x01(\tR\fcookieDomain\x1a\xd5\x02\n" +
	"\vCookieNames\x12.\n" +
