...
func (x *Lua) GetFilterContext() *structpb.Struct {
	if x != nil {
...
var file_envoy_extensions_filters_http_lua_v3_lua_proto_depIdxs = []int32{
	...
	5, // 3: envoy.extensions.filters.http.lua.v3.Lua.filter_context:type_name -> google.protobuf.Struct
	3, // 4: envoy.extensions.filters.http.lua.v3.LuaPerRoute.source_code:type_name -> envoy.config.core.v3.DataSource
	5, // 5: envoy.extensions.filters.http.lua.v3.LuaPerRoute.filter_context:type_name -> google.protobuf.Struct
	3, // 6: envoy.extensions.filters.http.lua.v3.Lua.SourceCodesEntry.value:type_name -> envoy.config.core.v3.DataSource
