...
func (x *ExtractOnlyWithoutValidation) GetVerificationStatusHeader() string {
	if x != nil {
		return x.VerificationStatusHeader
	}
	return ""
}
...
const file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDesc = "" +
	"\n" +
	"7envoy/extensions/filters/http/jwt_authn/v3/config.proto\x12*envoy.extensions.filters.http.jwt_authn.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a#envoy/config/core/v3/http_uri.proto\x1a,envoy/config/route/v3/route_components.proto\x1a\"envoy/type/matcher/v3/string.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xbe\v\n" +
	"\vJwtProvider\x12\x16\n" +
	"\x06issuer\x18\x01 \x01(\tR\x06issuer\x12\x1c\n" +
	"\taudiences\x18\x02 \x03(\tR\taudiences\x12@\n" +
	"\bsubjects\x18\x13 \x01(\v2$.envoy.type.matcher.v3.StringMatcherR\bsubjects\x12-\n" +
	"\x12require_expiration\x18\x14 \x01(\bR\x11requireExpiration\x12<\n" +
	"\fmax_lifetime\x18\x15 \x01(\v2\x19.google.protobuf.DurationR\vmaxLifetime\x12Y\n" +
	"\vremote_jwks\x18\x03 \x01(\v26.envoy.extensions.filters.http.jwt_authn.v3.RemoteJwksH\x00R\n" +
	"remoteJwks\x12A\n" +
	"\n" +
	"local_jwks\x18\x04 \x01(\v2 .envoy.config.core.v3.DataSourceH\x00R\tlocalJwks\x12\x18\n" +
	"\aforward\x18\x05 \x01(\bR\aforward\x12X\n" +
	"\ffrom_headers\x18\x06 \x03(\v25.envoy.extensions.filters.http.jwt_authn.v3.JwtHeaderR\vfromHeaders\x12\x1f\n" +
	"\vfrom_params\x18\a \x03(\tR\n" +
	"fromParams\x12!\n" +
	"\ffrom_cookies\x18\r \x03(\tR\vfromCookies\x12A\n" +
	"\x16forward_payload_header\x18\b \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x01R\x14forwardPayloadHeader\x12;\n" +
	"\x1apad_forward_payload_header\x18\v \x01(\bR\x17padForwardPayloadHeader\x12.\n" +
	"\x13payload_in_metadata\x18\t \x01(\tR\x11payloadInMetadata\x12\x8b\x01\n" +
	"\x1dnormalize_payload_in_metadata\x18\x12 \x01(\v2H.envoy.extensions.filters.http.jwt_authn.v3.JwtProvider.NormalizePayloadR\x1anormalizePayloadInMetadata\x12,\n" +
	"\x12header_in_metadata\x18\x0e \x01(\tR\x10headerInMetadata\x129\n" +
	"\x19failed_status_in_metadata\x18\x10 \x01(\tR\x16failedStatusInMetadata\x12,\n" +
	"\x12clock_skew_seconds\x18\n" +
	" \x01(\rR\x10clockSkewSeconds\x12d\n" +
	"\x10jwt_cache_config\x18\f \x01(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwtCacheConfigR\x0ejwtCacheConfig\x12f\n" +
	"\x10claim_to_headers\x18\x0f \x03(\v2<.envoy.extensions.filters.http.jwt_authn.v3.JwtClaimToHeaderR\x0eclaimToHeaders\x12*\n" +
	"\x11clear_route_cache\x18\x11 \x01(\bR\x0fclearRouteCache\x1aH\n" +
	"\x10NormalizePayload\x124\n" +
	"\x16space_delimited_claims\x18\x01 \x03(\tR\x14spaceDelimitedClaims:=\x9aň\x1e8\n" +
	"6envoy.config.filter.http.jwt_authn.v2alpha.JwtProviderB\x1c\n" +
	"\x15jwks_source_specifier\x12\x03\xf8B\x01\"c\n" +
	"\x0eJwtCacheConfig\x12$\n" +
	"\x0ejwt_cache_size\x18\x01 \x01(\rR\fjwtCacheSize\x12+\n" +
	"\x12jwt_max_token_size\x18\x02 \x01(\rR\x0fjwtMaxTokenSize\"\x89\x03\n" +
	"\n" +
	"RemoteJwks\x12B\n" +
	"\bhttp_uri\x18\x01 \x01(\v2\x1d.envoy.config.core.v3.HttpUriB\b\xfaB\x05\x8a\x01\x02\x10\x01R\ahttpUri\x12V\n" +
	"\x0ecache_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\x14\xfaB\x11\xaa\x01\x0e\x1a\x06\b\x80\xb4\xc4\xc3!2\x04\x10\xc0\x84=R\rcacheDuration\x12[\n" +
	"\vasync_fetch\x18\x03 \x01(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwksAsyncFetchR\n" +
	"asyncFetch\x12D\n" +
	"\fretry_policy\x18\x04 \x01(\v2!.envoy.config.core.v3.RetryPolicyR\vretryPolicy:<\x9aň\x1e7\n" +
	...
	"\x17failed_refetch_duration\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x15failedRefetchDuration\"\x9b\x01\n" +
	"\tJwtHeader\x12!\n" +
	"\x04name\x18\x01 \x01(\tB\r\xfaB\n" +
	"r\b\x10\x01\xc8\x01\x00\xc0\x01\x01R\x04name\x12.\n" +
	"\fvalue_prefix\x18\x02 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02R\vvaluePrefix:;\x9aň\x1e6\n" +
	"4envoy.config.filter.http.jwt_authn.v2alpha.JwtHeader\"\xa3\x01\n" +
	...
	"\rrequires_type\"\\\n" +
	"\x1cExtractOnlyWithoutValidation\x12<\n" +
	"\x1averification_status_header\x18\x01 \x01(\tR\x18verificationStatusHeader\"\xc8\x01\n" +
	...
	"\frequirements\x18\x01 \x03(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementB\b\xfaB\x05\x92\x01\x02\b\x02R\frequirements:G\x9aň\x1eB\n" +
	"@envoy.config.filter.http.jwt_authn.v2alpha.JwtRequirementAndList\"\xbb\x02\n" +
	"\x0fRequirementRule\x12A\n" +
	"\x05match\x18\x01 \x01(\v2!.envoy.config.route.v3.RouteMatchB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x05match\x12X\n" +
	"\brequires\x18\x02 \x01(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementH\x00R\brequires\x124\n" +
	"\x10requirement_name\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x10\x01H\x00R\x0frequirementName:A\x9aň\x1e<\n" +
	":envoy.config.filter.http.jwt_authn.v2alpha.RequirementRuleB\x12\n" +
	"\x10requirement_type\"\xd1\x02\n" +
	"\x0fFilterStateRule\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04name\x12e\n" +
	"\brequires\x18\x03 \x03(\v2I.envoy.extensions.filters.http.jwt_authn.v3.FilterStateRule.RequiresEntryR\brequires\x1aw\n" +
	"\rRequiresEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12P\n" +
	"\x05value\x18\x02 \x01(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementR\x05value:\x028\x01:A\x9aň\x1e<\n" +
	":envoy.config.filter.http.jwt_authn.v2alpha.FilterStateRule\"\xff\x06\n" +
	"\x11JwtAuthentication\x12j\n" +
	"\tproviders\x18\x01 \x03(\v2L.envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication.ProvidersEntryR\tproviders\x12Q\n" +
	"\x05rules\x18\x02 \x03(\v2;.envoy.extensions.filters.http.jwt_authn.v3.RequirementRuleR\x05rules\x12i\n" +
	"\x12filter_state_rules\x18\x03 \x01(\v2;.envoy.extensions.filters.http.jwt_authn.v3.FilterStateRuleR\x10filterStateRules\x122\n" +
	"\x15bypass_cors_preflight\x18\x04 \x01(\bR\x13bypassCorsPreflight\x12z\n" +
	"\x0frequirement_map\x18\x05 \x03(\v2Q.envoy.extensions.filters.http.jwt_authn.v3.JwtAuthentication.RequirementMapEntryR\x0erequirementMap\x124\n" +
	"\x16strip_failure_response\x18\x06 \x01(\bR\x14stripFailureResponse\x12\x1f\n" +
	"\vstat_prefix\x18\a \x01(\tR\n" +
	"statPrefix\x1au\n" +
	"\x0eProvidersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12M\n" +
	"\x05value\x18\x02 \x01(\v27.envoy.extensions.filters.http.jwt_authn.v3.JwtProviderR\x05value:\x028\x01\x1a}\n" +
	"\x13RequirementMapEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12P\n" +
	"\x05value\x18\x02 \x01(\v2:.envoy.extensions.filters.http.jwt_authn.v3.JwtRequirementR\x05value:\x028\x01:C\x9aň\x1e>\n" +
...
var (
	...
	file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDescData []byte
)
...
func file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDescGZIP() []byte {
	file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDesc), len(file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_rawDesc)))
	})
...
func file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_init() {
	...
	file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_msgTypes[0].OneofWrappers = []any{
		(*JwtProvider_RemoteJwks)(nil),
		(*JwtProvider_LocalJwks)(nil),
	}
	file_envoy_extensions_filters_http_jwt_authn_v3_config_proto_msgTypes[6].OneofWrappers = []any{
