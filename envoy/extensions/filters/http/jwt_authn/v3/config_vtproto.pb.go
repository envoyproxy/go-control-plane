...
func (m *JwtRequirement) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.RequiresType.(*JwtRequirement_ExtractOnlyWithoutValidation); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *JwtRequirement_ExtractOnlyWithoutValidation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *JwtRequirement_ExtractOnlyWithoutValidation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ExtractOnlyWithoutValidation != nil {
		size, err := m.ExtractOnlyWithoutValidation.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ExtractOnlyWithoutValidation) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *ExtractOnlyWithoutValidation) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *ExtractOnlyWithoutValidation) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *JwtRequirement_ExtractOnlyWithoutValidation) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.ExtractOnlyWithoutValidation != nil {
		l = m.ExtractOnlyWithoutValidation.SizeVT()
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	} else {
		n += 2
	}
...
func (m *ExtractOnlyWithoutValidation) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
