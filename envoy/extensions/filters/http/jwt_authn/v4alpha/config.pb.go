...
var file_envoy_extensions_filters_http_jwt_authn_v4alpha_config_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x63, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x22, 0xad, 0x02,
	...
	0x74, 0x63, 0x68, 0x52, 0x0a, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x46, 0x65, 0x74, 0x63, 0x68, 0x3a,
...
var file_envoy_extensions_filters_http_jwt_authn_v4alpha_config_proto_goTypes = []interface{}{
	...
	(*v4alpha1.RouteMatch)(nil),   // 19: envoy.config.route.v4alpha.RouteMatch
}
var file_envoy_extensions_filters_http_jwt_authn_v4alpha_config_proto_depIdxs = []int32{
	...
	4,  // 6: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement.provider_and_audiences:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.ProviderWithAudiences
	6,  // 7: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement.requires_any:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementOrList
	7,  // 8: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement.requires_all:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementAndList
	18, // 9: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement.allow_missing_or_failed:type_name -> google.protobuf.Empty
	18, // 10: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement.allow_missing:type_name -> google.protobuf.Empty
	5,  // 11: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementOrList.requirements:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement
	5,  // 12: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirementAndList.requirements:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement
	19, // 13: envoy.extensions.filters.http.jwt_authn.v4alpha.RequirementRule.match:type_name -> envoy.config.route.v4alpha.RouteMatch
	5,  // 14: envoy.extensions.filters.http.jwt_authn.v4alpha.RequirementRule.requires:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement
	12, // 15: envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule.requires:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule.RequiresEntry
	13, // 16: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.providers:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.ProvidersEntry
	8,  // 17: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.rules:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.RequirementRule
	9,  // 18: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.filter_state_rules:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule
	14, // 19: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.requirement_map:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.RequirementMapEntry
	5,  // 20: envoy.extensions.filters.http.jwt_authn.v4alpha.FilterStateRule.RequiresEntry.value:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement
	0,  // 21: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.ProvidersEntry.value:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtProvider
	5,  // 22: envoy.extensions.filters.http.jwt_authn.v4alpha.JwtAuthentication.RequirementMapEntry.value:type_name -> envoy.extensions.filters.http.jwt_authn.v4alpha.JwtRequirement
