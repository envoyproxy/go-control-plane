...
// source: envoy/extensions/filters/http/jwt_authn/v3alpha/config.proto

package envoy_extensions_filters_http_jwt_authn_v3alpha
...
func (*JwtProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{0}
}
...
type JwtProvider_LocalJwks struct {
	LocalJwks *v3alpha.DataSource `protobuf:"bytes,4,opt,name=local_jwks,json=localJwks,proto3,oneof"`
}
...
func (m *JwtProvider) GetLocalJwks() *v3alpha.DataSource {
...
type RemoteJwks struct {
	HttpUri              *v3alpha.HttpUri   `protobuf:"bytes,1,opt,name=http_uri,json=httpUri,proto3" json:"http_uri,omitempty"`
...
func (*RemoteJwks) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{1}
}
...
func (m *RemoteJwks) GetHttpUri() *v3alpha.HttpUri {
	if m != nil {
		return m.HttpUri
	}
	return nil
...
func (*JwtHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{2}
}
...
func (*ProviderWithAudiences) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{3}
}
...
func (*JwtRequirement) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{4}
}
...
func (*JwtRequirementOrList) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{5}
}
...
func (*JwtRequirementAndList) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{6}
}
...
type RequirementRule struct {
	Match                *v3alpha1.RouteMatch `protobuf:"bytes,1,opt,name=match,proto3" json:"match,omitempty"`
...
func (*RequirementRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{7}
}
...
func (m *RequirementRule) GetMatch() *v3alpha1.RouteMatch {
	if m != nil {
		return m.Match
	}
	return nil
...
func (*FilterStateRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{8}
}
...
func (*JwtAuthentication) Descriptor() ([]byte, []int) {
	return fileDescriptor_03d7ae505cdaab3f, []int{9}
}
...
func init() {
	proto.RegisterType((*JwtProvider)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtProvider")
	proto.RegisterType((*RemoteJwks)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.RemoteJwks")
	proto.RegisterType((*JwtHeader)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtHeader")
	proto.RegisterType((*ProviderWithAudiences)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.ProviderWithAudiences")
	proto.RegisterType((*JwtRequirement)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtRequirement")
	proto.RegisterType((*JwtRequirementOrList)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtRequirementOrList")
	proto.RegisterType((*JwtRequirementAndList)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtRequirementAndList")
	proto.RegisterType((*RequirementRule)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.RequirementRule")
	proto.RegisterType((*FilterStateRule)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.FilterStateRule")
	proto.RegisterMapType((map[string]*JwtRequirement)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.FilterStateRule.RequiresEntry")
	proto.RegisterType((*JwtAuthentication)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtAuthentication")
	proto.RegisterMapType((map[string]*JwtProvider)(nil), "envoy.extensions.filters.http.jwt_authn.v3alpha.JwtAuthentication.ProvidersEntry")
}

func init() {
	proto.RegisterFile("envoy/extensions/filters/http/jwt_authn/v3alpha/config.proto", fileDescriptor_03d7ae505cdaab3f)
}

var fileDescriptor_03d7ae505cdaab3f = []byte{
	...
	,
}
