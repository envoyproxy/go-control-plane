...
func (m *CacheV2Config_KeyCreatorParams) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CacheV2Config_KeyCreatorParams) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *CacheV2Config_KeyCreatorParams) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *CacheV2Config) MarshalVTStrict() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CacheV2Config) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *CacheV2Config) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if len(m.OverrideUpstreamCluster) > 0 {
		i -= len(m.OverrideUpstreamCluster)
		copy(dAtA[i:], m.OverrideUpstreamCluster)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OverrideUpstreamCluster)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *CacheV2Config_KeyCreatorParams) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CacheV2Config) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.OverrideUpstreamCluster)
	if l > 0 {
		n += 1 + l + protohelpers.SizeOfVarint(uint64(l))
	}
	n += len(m.unknownFields)
