...
const file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDesc = "" +
	"\n" +
	"Aenvoy/extensions/filters/http/connect_grpc_bridge/v3/config.proto\x124envoy.extensions.filters.http.connect_grpc_bridge.v3\x1a\x1fxds/annotations/v3/status.proto\x1a\x1dudpa/annotations/status.proto\"\x0e\n" +
	"\fFilterConfigB\xd6\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\xd2Ƥ\xe1\x06\x02\b\x01\n" +
	"Bio.envoyproxy.envoy.extensions.filters.http.connect_grpc_bridge.v3B\vConfigProtoP\x01Zqgithub.com/envoyproxy/go-control-plane/envoy/extensions/filters/http/connect_grpc_bridge/v3;connect_grpc_bridgev3b\x06proto3"

var (
	file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDescOnce sync.Once
	file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDescData []byte
)
...
func file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDescGZIP() []byte {
	file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDesc), len(file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDesc)))
	})
...
var file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_goTypes = []any{
...
func file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDesc), len(file_envoy_extensions_filters_http_connect_grpc_bridge_v3_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
