...
var file_envoy_extensions_wasm_v3_wasm_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x67, 0x22, 0x9c, 0x02, 0x0a, 0x08, 0x56, 0x6d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	,
	...
	0x28, 0x08, 0x52, 0x08, 0x66, 0x61, 0x69, 0x6c, 0x4f, 0x70, 0x65, 0x6e, 0x12, 0x79, 0x0a, 0x1d,
	...
	0x09, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x74, 0x6f, 0x6e, 0x42, 0x3d, 0x0a, 0x26, 0x69, 0x6f,
...
var file_envoy_extensions_wasm_v3_wasm_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_envoy_extensions_wasm_v3_wasm_proto_goTypes = []interface{}{
	...
	(*PluginConfig)(nil),                // 3: envoy.extensions.wasm.v3.PluginConfig
	(*WasmService)(nil),                 // 4: envoy.extensions.wasm.v3.WasmService
	nil,                                 // 5: envoy.extensions.wasm.v3.CapabilityRestrictionConfig.AllowedCapabilitiesEntry
	(*v3.AsyncDataSource)(nil),          // 6: envoy.config.core.v3.AsyncDataSource
	(*any.Any)(nil),                     // 7: google.protobuf.Any
}
var file_envoy_extensions_wasm_v3_wasm_proto_depIdxs = []int32{
	5, // 0: envoy.extensions.wasm.v3.CapabilityRestrictionConfig.allowed_capabilities:type_name -> envoy.extensions.wasm.v3.CapabilityRestrictionConfig.AllowedCapabilitiesEntry
	6, // 1: envoy.extensions.wasm.v3.VmConfig.code:type_name -> envoy.config.core.v3.AsyncDataSource
	7, // 2: envoy.extensions.wasm.v3.VmConfig.configuration:type_name -> google.protobuf.Any
	2, // 3: envoy.extensions.wasm.v3.PluginConfig.vm_config:type_name -> envoy.extensions.wasm.v3.VmConfig
	7, // 4: envoy.extensions.wasm.v3.PluginConfig.configuration:type_name -> google.protobuf.Any
	0, // 5: envoy.extensions.wasm.v3.PluginConfig.capability_restriction_config:type_name -> envoy.extensions.wasm.v3.CapabilityRestrictionConfig
	3, // 6: envoy.extensions.wasm.v3.WasmService.config:type_name -> envoy.extensions.wasm.v3.PluginConfig
	1, // 7: envoy.extensions.wasm.v3.CapabilityRestrictionConfig.AllowedCapabilitiesEntry.value:type_name -> envoy.extensions.wasm.v3.SanitizationConfig
...
func file_envoy_extensions_wasm_v3_wasm_proto_init() {
	...
	file_envoy_extensions_wasm_v3_wasm_proto_msgTypes[3].OneofWrappers = []interface{}{
