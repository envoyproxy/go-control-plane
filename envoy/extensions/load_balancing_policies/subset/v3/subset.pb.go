...
const file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc = "" +
	"\n" +
	"?envoy/extensions/load_balancing_policies/subset/v3/subset.proto\x122envoy.extensions.load_balancing_policies.subset.v3\x1a%envoy/config/cluster/v3/cluster.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\"\xa3\v\n" +
	"\x06Subset\x12\x84\x01\n" +
	"\x0ffallback_policy\x18\x01 \x01(\x0e2Q.envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetFallbackPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0efallbackPolicy\x12>\n" +
	"\x0edefault_subset\x18\x02 \x01(\v2\x17.google.protobuf.StructR\rdefaultSubset\x12v\n" +
	"\x10subset_selectors\x18\x03 \x03(\v2K.envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetSelectorR\x0fsubsetSelectors\x120\n" +
	"\x14allow_redundant_keys\x18\n" +
	" \x01(\bR\x12allowRedundantKeys\x122\n" +
	...
	"\vlist_as_any\x18\a \x01(\bR\tlistAsAny\x12\x9d\x01\n" +
	"\x18metadata_fallback_policy\x18\b \x01(\x0e2Y.envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetMetadataFallbackPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x16metadataFallbackPolicy\x12`\n" +
	"\x10subset_lb_policy\x18\t \x01(\v2,.envoy.config.cluster.v3.LoadBalancingPolicyB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x0esubsetLbPolicy\x1a\xa8\x03\n" +
	"\x10LbSubsetSelector\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\tR\x04keys\x123\n" +
	"\x16single_host_per_subset\x18\x04 \x01(\bR\x13singleHostPerSubset\x12\x9d\x01\n" +
	"\x0ffallback_policy\x18\x02 \x01(\x0e2j.envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetSelector.LbSubsetSelectorFallbackPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0efallbackPolicy\x120\n" +
	...
	"&envoy.config.cluster.v3.LbSubsetConfigB\xbd\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
	"@io.envoyproxy.envoy.extensions.load_balancing_policies.subset.v3B\vSubsetProtoP\x01Zbgithub.com/envoyproxy/go-control-plane/envoy/extensions/load_balancing_policies/subset/v3;subsetv3b\x06proto3"

var (
	file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDescOnce sync.Once
	file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDescData []byte
)
...
func file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDescGZIP() []byte {
	file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDescOnce.Do(func() {
		file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc), len(file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc)))
	})
...
var file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_goTypes = []any{
...
func file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc), len(file_envoy_extensions_load_balancing_policies_subset_v3_subset_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
