...
type OrcaOobReportingConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *OrcaOobReportingConfig) Reset() {
	*x = OrcaOobReportingConfig{}
	mi := &file_envoy_extensions_load_balancing_policies_common_v3_common_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *OrcaOobReportingConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OrcaOobReportingConfig) ProtoMessage() {}

func (x *OrcaOobReportingConfig) ProtoReflect() protoreflect.Message {
	mi := &file_envoy_extensions_load_balancing_policies_common_v3_common_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OrcaOobReportingConfig.ProtoReflect.Descriptor instead.
func (*OrcaOobReportingConfig) Descriptor() ([]byte, []int) {
	return file_envoy_extensions_load_balancing_policies_common_v3_common_proto_rawDescGZIP(), []int{3}
}

func (x *OrcaOobReportingConfig) GetPortValue() uint32 {
	if x != nil {
		return x.PortValue
	}
	return 0
...
func (x *OrcaOobReportingConfig) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
func (x *OrcaOobReportingConfig) GetTransportSocketMatchCriteria() *structpb.Struct {
	if x != nil {
...
func (x *LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone) Reset() {
	*x = LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone{}
	mi := &file_envoy_extensions_load_balancing_policies_common_v3_common_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_envoy_extensions_load_balancing_policies_common_v3_common_proto_rawDesc = "" +
	"\n" +
	"?envoy/extensions/load_balancing_policies/common/v3/common.proto\x122envoy.extensions.load_balancing_policies.common.v3\x1a\x1fenvoy/config/core/v3/base.proto\x1a,envoy/config/route/v3/route_components.proto\x1a\x1benvoy/type/v3/percent.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xcc\b\n" +
	...
	"hashPolicy\"\xcd\x01\n" +
	"\x16OrcaOobReportingConfig\x12(\n" +
	"\n" +
	"port_value\x18\x01 \x01(\rB\t\xfaB\x06*\x04\x18\xff\xff\x03R\tportValue\x12)\n" +
	"\tauthority\x18\x02 \x01(\tB\v\xfaB\br\x06\xc8\x01\x00\xc0\x01\x02R\tauthority\x12^\n" +
	"\x1ftransport_socket_match_criteria\x18\x03 \x01(\v2\x17.google.protobuf.StructR\x1ctransportSocketMatchCriteriaB\xbd\x01\xba\x80\xc8\xd1\x06\x02\x10\x02\n" +
...
var file_envoy_extensions_load_balancing_policies_common_v3_common_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_envoy_extensions_load_balancing_policies_common_v3_common_proto_goTypes = []any{
	...
	(*OrcaOobReportingConfig)(nil),                            // 4: envoy.extensions.load_balancing_policies.common.v3.OrcaOobReportingConfig
	(*LocalityLbConfig_ZoneAwareLbConfig)(nil),                // 5: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig
	(*LocalityLbConfig_LocalityWeightedLbConfig)(nil),         // 6: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.LocalityWeightedLbConfig
	(*LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone)(nil), // 7: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.ForceLocalZone
	(*durationpb.Duration)(nil),                               // 8: google.protobuf.Duration
	(*v3.RuntimeDouble)(nil),                                  // 9: envoy.config.core.v3.RuntimeDouble
	(*v31.Percent)(nil),                                       // 10: envoy.type.v3.Percent
	(*wrapperspb.UInt32Value)(nil),                            // 11: google.protobuf.UInt32Value
	(*v32.RouteAction_HashPolicy)(nil),                        // 12: envoy.config.route.v3.RouteAction.HashPolicy
...
var file_envoy_extensions_load_balancing_policies_common_v3_common_proto_depIdxs = []int32{
	5,  // 0: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.zone_aware_lb_config:type_name -> envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig
	6,  // 1: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.locality_weighted_lb_config:type_name -> envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.LocalityWeightedLbConfig
	8,  // 2: envoy.extensions.load_balancing_policies.common.v3.SlowStartConfig.slow_start_window:type_name -> google.protobuf.Duration
	9,  // 3: envoy.extensions.load_balancing_policies.common.v3.SlowStartConfig.aggression:type_name -> envoy.config.core.v3.RuntimeDouble
	10, // 4: envoy.extensions.load_balancing_policies.common.v3.SlowStartConfig.min_weight_percent:type_name -> envoy.type.v3.Percent
	11, // 5: envoy.extensions.load_balancing_policies.common.v3.ConsistentHashingLbConfig.hash_balance_factor:type_name -> google.protobuf.UInt32Value
	12, // 6: envoy.extensions.load_balancing_policies.common.v3.ConsistentHashingLbConfig.hash_policy:type_name -> envoy.config.route.v3.RouteAction.HashPolicy
	13, // 7: envoy.extensions.load_balancing_policies.common.v3.OrcaOobReportingConfig.transport_socket_match_criteria:type_name -> google.protobuf.Struct
	10, // 8: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.routing_enabled:type_name -> envoy.type.v3.Percent
	14, // 9: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.min_cluster_size:type_name -> google.protobuf.UInt64Value
	7,  // 10: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.force_local_zone:type_name -> envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.ForceLocalZone
	0,  // 11: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.locality_basis:type_name -> envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.LocalityBasis
	11, // 12: envoy.extensions.load_balancing_policies.common.v3.LocalityLbConfig.ZoneAwareLbConfig.ForceLocalZone.min_size:type_name -> google.protobuf.UInt32Value
