...
const file_envoy_api_v2_core_address_proto_rawDesc = "" +
	"\n" +
	"\x1fenvoy/api/v2/core/address.proto\x12\x11envoy.api.v2.core\x1a%envoy/api/v2/core/socket_option.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"A\n" +
	"\x04Pipe\x12\x1b\n" +
	"\x04path\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04path\x12\x1c\n" +
	"\x04mode\x18\x02 \x01(\rB\b\xfaB\x05*\x03\x18\xff\x03R\x04mode\"\xcb\x02\n" +
	"\rSocketAddress\x12O\n" +
	"\bprotocol\x18\x01 \x01(\x0e2).envoy.api.v2.core.SocketAddress.ProtocolB\b\xfaB\x05\x82\x01\x02\x10\x01R\bprotocol\x12!\n" +
	...
	"\x03UDP\x10\x01B\x15\n" +
	"\x0eport_specifier\x12\x03\xf8B\x01\"\xe9\x01\n" +
	"\fTcpKeepalive\x12G\n" +
	...
	"\x12keepalive_interval\x18\x03 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x11keepaliveInterval\"\xdf\x01\n" +
	"\n" +
	"BindConfig\x12Q\n" +
	"\x0esource_address\x18\x01 \x01(\v2 .envoy.api.v2.core.SocketAddressB\b\xfaB\x05\x8a\x01\x02\x10\x01R\rsourceAddress\x126\n" +
	"\bfreebind\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\bfreebind\x12F\n" +
	"\x0esocket_options\x18\x03 \x03(\v2\x1f.envoy.api.v2.core.SocketOptionR\rsocketOptions\"\x93\x01\n" +
	"\aAddress\x12I\n" +
	"\x0esocket_address\x18\x01 \x01(\v2 .envoy.api.v2.core.SocketAddressH\x00R\rsocketAddress\x12-\n" +
	"\x04pipe\x18\x02 \x01(\v2\x17.envoy.api.v2.core.PipeH\x00R\x04pipeB\x0e\n" +
	"\aaddress\x12\x03\xf8B\x01\"\x82\x01\n" +
	"\tCidrRange\x12.\n" +
	"\x0eaddress_prefix\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\raddressPrefix\x12E\n" +
	"\n" +
	"prefix_len\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueB\b\xfaB\x05*\x03\x18\x80\x01R\tprefixLenB\x8f\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\fAddressProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreb\x06proto3"

var (
	file_envoy_api_v2_core_address_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_address_proto_rawDescData []byte
)

func file_envoy_api_v2_core_address_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_address_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_address_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_address_proto_rawDesc), len(file_envoy_api_v2_core_address_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_address_proto_goTypes = []any{
...
func file_envoy_api_v2_core_address_proto_init() {
	...
	file_envoy_api_v2_core_address_proto_msgTypes[1].OneofWrappers = []any{
		(*SocketAddress_PortValue)(nil),
		(*SocketAddress_NamedPort)(nil),
	}
	file_envoy_api_v2_core_address_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_address_proto_rawDesc), len(file_envoy_api_v2_core_address_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
