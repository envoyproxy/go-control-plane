...
type TcpKeepalive struct {
	...
	KeepaliveProbes *google_protobuf2.UInt32Value `protobuf:"bytes,1,opt,name=keepalive_probes,json=keepaliveProbes" json:"keepalive_probes,omitempty"`
	// The number of seconds a connection needs to be idle before keep-alive probes
	// start being sent. Default is to use the OS level configuration (unless
	// overridden, Linux defaults to 7200s (ie 2 hours.)
	KeepaliveTime *google_protobuf2.UInt32Value `protobuf:"bytes,2,opt,name=keepalive_time,json=keepaliveTime" json:"keepalive_time,omitempty"`
	// The number of seconds between keep-alive probes. Default is to use the OS
	// level configuration (unless overridden, Linux defaults to 75s.)
	KeepaliveInterval *google_protobuf2.UInt32Value `protobuf:"bytes,3,opt,name=keepalive_interval,json=keepaliveInterval" json:"keepalive_interval,omitempty"`
}
...
func (m *TcpKeepalive) GetKeepaliveProbes() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *TcpKeepalive) GetKeepaliveTime() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *TcpKeepalive) GetKeepaliveInterval() *google_protobuf2.UInt32Value {
	if m != nil {
...
type BindConfig struct {
	...
	Freebind *google_protobuf2.BoolValue `protobuf:"bytes,2,opt,name=freebind" json:"freebind,omitempty"`
...
func (m *BindConfig) GetFreebind() *google_protobuf2.BoolValue {
	if m != nil {
		return m.Freebind
	}
	return nil
...
func (m *CidrRange) GetPrefixLen() *google_protobuf2.UInt32Value {
	if m != nil {
		return m.PrefixLen
	}
	return nil
...
func (m *TcpKeepalive) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.KeepaliveProbes == nil {
				m.KeepaliveProbes = &google_protobuf2.UInt32Value{}
			}
		...
		case 2:
			...
			if m.KeepaliveTime == nil {
				m.KeepaliveTime = &google_protobuf2.UInt32Value{}
			}
		...
		case 3:
			...
			if m.KeepaliveInterval == nil {
				m.KeepaliveInterval = &google_protobuf2.UInt32Value{}
			}
...
func (m *CidrRange) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.PrefixLen == nil {
				m.PrefixLen = &google_protobuf2.UInt32Value{}
			}
