...
func (x *TransportSocket) GetConfig() *structpb.Struct {
	if x != nil {
		if x, ok := x.ConfigType.(*TransportSocket_Config); ok {
			return x.Config
		}
	}
	return nil
...
const file_envoy_api_v2_core_base_proto_rawDesc = "" +
	"\n" +
	"\x1cenvoy/api/v2/core/base.proto\x12\x11envoy.api.v2.core\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1fenvoy/api/v2/core/backoff.proto\x1a envoy/api/v2/core/http_uri.proto\x1a\x18envoy/type/percent.proto\x1a!envoy/type/semantic_version.proto\x1a\x19google/protobuf/any.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\x1a%envoy/api/v2/core/socket_option.proto\"Q\n" +
	"\bLocality\x12\x16\n" +
	"\x06region\x18\x01 \x01(\tR\x06region\x12\x12\n" +
	"\x04zone\x18\x02 \x01(\tR\x04zone\x12\x19\n" +
	"\bsub_zone\x18\x03 \x01(\tR\asubZone\"z\n" +
	"\fBuildVersion\x125\n" +
	"\aversion\x18\x01 \x01(\v2\x1b.envoy.type.SemanticVersionR\aversion\x123\n" +
	"\bmetadata\x18\x02 \x01(\v2\x17.google.protobuf.StructR\bmetadata\"\xbb\x01\n" +
	"\tExtension\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bcategory\x18\x02 \x01(\tR\bcategory\x12'\n" +
	"\x0ftype_descriptor\x18\x03 \x01(\tR\x0etypeDescriptor\x129\n" +
	"\aversion\x18\x04 \x01(\v2\x1f.envoy.api.v2.core.BuildVersionR\aversion\x12\x1a\n" +
	"\bdisabled\x18\x05 \x01(\bR\bdisabled\"\xca\x04\n" +
	"\x04Node\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\acluster\x18\x02 \x01(\tR\acluster\x123\n" +
	"\bmetadata\x18\x03 \x01(\v2\x17.google.protobuf.StructR\bmetadata\x127\n" +
	"\blocality\x18\x04 \x01(\v2\x1b.envoy.api.v2.core.LocalityR\blocality\x12'\n" +
	"\rbuild_version\x18\x05 \x01(\tB\x02\x18\x01R\fbuildVersion\x12&\n" +
	"\x0fuser_agent_name\x18\x06 \x01(\tR\ruserAgentName\x12.\n" +
	"\x12user_agent_version\x18\a \x01(\tH\x00R\x10userAgentVersion\x12Z\n" +
	"\x18user_agent_build_version\x18\b \x01(\v2\x1f.envoy.api.v2.core.BuildVersionH\x00R\x15userAgentBuildVersion\x12<\n" +
	"\n" +
	"extensions\x18\t \x03(\v2\x1c.envoy.api.v2.core.ExtensionR\n" +
	"extensions\x12'\n" +
	"\x0fclient_features\x18\n" +
	" \x03(\tR\x0eclientFeatures\x12K\n" +
	"\x13listening_addresses\x18\v \x03(\v2\x1a.envoy.api.v2.core.AddressR\x12listeningAddressesB\x19\n" +
	"\x17user_agent_version_type\"\xc0\x01\n" +
	"\bMetadata\x12X\n" +
	"\x0ffilter_metadata\x18\x01 \x03(\v2/.envoy.api.v2.core.Metadata.FilterMetadataEntryR\x0efilterMetadata\x1aZ\n" +
	...
	"(\x80\x80\x01\xc8\x01\x00\xc0\x01\x02R\x05value\"\x89\x01\n" +
	"\x11HeaderValueOption\x12@\n" +
	"\x06header\x18\x01 \x01(\v2\x1e.envoy.api.v2.core.HeaderValueB\b\xfaB\x05\x8a\x01\x02\x10\x01R\x06header\x122\n" +
	"\x06append\x18\x02 \x01(\v2\x1a.google.protobuf.BoolValueR\x06append\"E\n" +
	"\tHeaderMap\x128\n" +
	"\aheaders\x18\x01 \x03(\v2\x1e.envoy.api.v2.core.HeaderValueR\aheaders\"\xa3\x01\n" +
	"\n" +
	"DataSource\x12%\n" +
	...
	"\rinline_string\x18\x03 \x01(\tB\a\xfaB\x04r\x02 \x01H\x00R\finlineStringB\x10\n" +
	"\tspecifier\x12\x03\xf8B\x01\"\x96\x01\n" +
	"\vRetryPolicy\x12H\n" +
	"\x0eretry_back_off\x18\x01 \x01(\v2\".envoy.api.v2.core.BackoffStrategyR\fretryBackOff\x12=\n" +
	"\vnum_retries\x18\x02 \x01(\v2\x1c.google.protobuf.UInt32ValueR\n" +
	"numRetries\"\xb7\x01\n" +
	"\x10RemoteDataSource\x12?\n" +
	"\bhttp_uri\x18\x01 \x01(\v2\x1a.envoy.api.v2.core.HttpUriB\b\xfaB\x05\x8a\x01\x02\x10\x01R\ahttpUri\x12\x1f\n" +
	"\x06sha256\x18\x02 \x01(\tB\a\xfaB\x04r\x02 \x01R\x06sha256\x12A\n" +
	"\fretry_policy\x18\x03 \x01(\v2\x1e.envoy.api.v2.core.RetryPolicyR\vretryPolicy\"\x99\x01\n" +
	"\x0fAsyncDataSource\x125\n" +
	"\x05local\x18\x01 \x01(\v2\x1d.envoy.api.v2.core.DataSourceH\x00R\x05local\x12=\n" +
	"\x06remote\x18\x02 \x01(\v2#.envoy.api.v2.core.RemoteDataSourceH\x00R\x06remoteB\x10\n" +
	"\tspecifier\x12\x03\xf8B\x01\"\xaf\x01\n" +
	...
	"\vconfig_type\"\x89\x01\n" +
	"\x18RuntimeFractionalPercent\x12L\n" +
	"\rdefault_value\x18\x01 \x01(\v2\x1d.envoy.type.FractionalPercentB\b\xfaB\x05\x8a\x01\x02\x10\x01R\fdefaultValue\x12\x1f\n" +
	...
	"\bOUTBOUND\x10\x02B\x8c\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\tBaseProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreP\vb\x06proto3"

var (
	file_envoy_api_v2_core_base_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_base_proto_rawDescData []byte
)

func file_envoy_api_v2_core_base_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_base_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_base_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_base_proto_rawDesc), len(file_envoy_api_v2_core_base_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_base_proto_goTypes = []any{
...
func file_envoy_api_v2_core_base_proto_init() {
	...
	file_envoy_api_v2_core_base_proto_msgTypes[3].OneofWrappers = []any{
		(*Node_UserAgentVersion)(nil),
		(*Node_UserAgentBuildVersion)(nil),
	}
	file_envoy_api_v2_core_base_proto_msgTypes[11].OneofWrappers = []any{
		(*DataSource_Filename)(nil),
		(*DataSource_InlineBytes)(nil),
		(*DataSource_InlineString)(nil),
	}
	file_envoy_api_v2_core_base_proto_msgTypes[14].OneofWrappers = []any{
		(*AsyncDataSource_Local)(nil),
		(*AsyncDataSource_Remote)(nil),
	}
	file_envoy_api_v2_core_base_proto_msgTypes[15].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_base_proto_rawDesc), len(file_envoy_api_v2_core_base_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   19,
			NumExtensions: 0,
			NumServices:   0,
