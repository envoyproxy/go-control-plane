...
const file_envoy_api_v2_core_http_uri_proto_rawDesc = "" +
	"\n" +
	" envoy/api/v2/core/http_uri.proto\x12\x11envoy.api.v2.core\x1a\x1egoogle/protobuf/duration.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xa5\x01\n" +
	"\aHttpUri\x12\x19\n" +
	...
	"\xfaB\a\xaa\x01\x04\b\x012\x00R\atimeoutB\x19\n" +
	"\x12http_upstream_type\x12\x03\xf8B\x01B\x8f\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\fHttpUriProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreb\x06proto3"

var (
	file_envoy_api_v2_core_http_uri_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_http_uri_proto_rawDescData []byte
)

func file_envoy_api_v2_core_http_uri_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_http_uri_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_http_uri_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_http_uri_proto_rawDesc), len(file_envoy_api_v2_core_http_uri_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_http_uri_proto_goTypes = []any{
...
func file_envoy_api_v2_core_http_uri_proto_init() {
	...
	file_envoy_api_v2_core_http_uri_proto_msgTypes[0].OneofWrappers = []any{
		(*HttpUri_Cluster)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_http_uri_proto_rawDesc), len(file_envoy_api_v2_core_http_uri_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
