...
const file_envoy_api_v2_core_grpc_method_list_proto_rawDesc = "" +
	"\n" +
	"(envoy/api/v2/core/grpc_method_list.proto\x12\x11envoy.api.v2.core\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xac\x01\n" +
	"\x0eGrpcMethodList\x12E\n" +
	"\bservices\x18\x01 \x03(\v2).envoy.api.v2.core.GrpcMethodList.ServiceR\bservices\x1aS\n" +
	"\aService\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12+\n" +
	"\fmethod_names\x18\x02 \x03(\tB\b\xfaB\x05\x92\x01\x02\b\x01R\vmethodNamesB\x96\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\x13GrpcMethodListProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreb\x06proto3"

var (
	file_envoy_api_v2_core_grpc_method_list_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_grpc_method_list_proto_rawDescData []byte
)
...
func file_envoy_api_v2_core_grpc_method_list_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_grpc_method_list_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_grpc_method_list_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_grpc_method_list_proto_rawDesc), len(file_envoy_api_v2_core_grpc_method_list_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_grpc_method_list_proto_goTypes = []any{
...
func file_envoy_api_v2_core_grpc_method_list_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_grpc_method_list_proto_rawDesc), len(file_envoy_api_v2_core_grpc_method_list_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
