...
const file_envoy_api_v2_core_socket_option_proto_rawDesc = "" +
	"\n" +
	"%envoy/api/v2/core/socket_option.proto\x12\x11envoy.api.v2.core\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xbb\x02\n" +
	"\fSocketOption\x12 \n" +
	...
	"\tbuf_value\x18\x05 \x01(\fH\x00R\bbufValue\x12K\n" +
	"\x05state\x18\x06 \x01(\x0e2+.envoy.api.v2.core.SocketOption.SocketStateB\b\xfaB\x05\x82\x01\x02\x10\x01R\x05state\"F\n" +
	"\vSocketState\x12\x11\n" +
	"\rSTATE_PREBIND\x10\x00\x12\x0f\n" +
	"\vSTATE_BOUND\x10\x01\x12\x13\n" +
	"\x0fSTATE_LISTENING\x10\x02B\f\n" +
	"\x05value\x12\x03\xf8B\x01B\x94\x01\xf2\x98\xfe\x8f\x05\x16\x12\x14envoy.config.core.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1fio.envoyproxy.envoy.api.v2.coreB\x11SocketOptionProtoP\x01Z8github.com/envoyproxy/go-control-plane/envoy/api/v2/coreb\x06proto3"

var (
	file_envoy_api_v2_core_socket_option_proto_rawDescOnce sync.Once
	file_envoy_api_v2_core_socket_option_proto_rawDescData []byte
)
...
func file_envoy_api_v2_core_socket_option_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_core_socket_option_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_core_socket_option_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_socket_option_proto_rawDesc), len(file_envoy_api_v2_core_socket_option_proto_rawDesc)))
	})
...
var file_envoy_api_v2_core_socket_option_proto_goTypes = []any{
...
func file_envoy_api_v2_core_socket_option_proto_init() {
	...
	file_envoy_api_v2_core_socket_option_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_core_socket_option_proto_rawDesc), len(file_envoy_api_v2_core_socket_option_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
