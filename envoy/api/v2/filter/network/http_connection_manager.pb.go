...
type HttpConnectionManager struct {
	...
	HttpProtocolOptions *envoy_api_v2_core4.Http1ProtocolOptions `protobuf:"bytes,8,opt,name=http_protocol_options,json=httpProtocolOptions" json:"http_protocol_options,omitempty"`
	// Additional HTTP/2 settings that are passed directly to the HTTP/2 codec.
	Http2ProtocolOptions *envoy_api_v2_core4.Http2ProtocolOptions `protobuf:"bytes,9,opt,name=http2_protocol_options,json=http2ProtocolOptions" json:"http2_protocol_options,omitempty"`
...
func (m *HttpConnectionManager) GetHttpProtocolOptions() *envoy_api_v2_core4.Http1ProtocolOptions {
	if m != nil {
...
func (m *HttpConnectionManager) GetHttp2ProtocolOptions() *envoy_api_v2_core4.Http2ProtocolOptions {
	if m != nil {
...
type HttpConnectionManager_Tracing struct {
	...
	// Default: 100%
	ClientSampling *envoy_api_v2_core1.Percent `protobuf:"bytes,3,opt,name=client_sampling,json=clientSampling" json:"client_sampling,omitempty"`
	// Target percentage of requests managed by this HTTP connection manager that will be randomly
	// selected for trace generation, if not requested by the client or not forced. This field is
	// a direct analog for the runtime variable 'tracing.random_sampling' in the
	// :ref:`HTTP Connection Manager <config_http_conn_man_runtime>`.
	// Default: 100%
	RandomSampling *envoy_api_v2_core1.Percent `protobuf:"bytes,4,opt,name=random_sampling,json=randomSampling" json:"random_sampling,omitempty"`
	...
	// :ref:`HTTP Connection Manager <config_http_conn_man_runtime>`.
	// Default: 100%
	OverallSampling *envoy_api_v2_core1.Percent `protobuf:"bytes,5,opt,name=overall_sampling,json=overallSampling" json:"overall_sampling,omitempty"`
}
...
func (m *HttpConnectionManager_Tracing) GetClientSampling() *envoy_api_v2_core1.Percent {
	if m != nil {
...
func (m *HttpConnectionManager_Tracing) GetRandomSampling() *envoy_api_v2_core1.Percent {
	if m != nil {
...
func (m *HttpConnectionManager_Tracing) GetOverallSampling() *envoy_api_v2_core1.Percent {
	if m != nil {
...
func (m *Rds) GetConfigSource() envoy_api_v2_core3.ConfigSource {
	if m != nil {
...
func (m *HttpConnectionManager) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.HttpProtocolOptions == nil {
				m.HttpProtocolOptions = &envoy_api_v2_core4.Http1ProtocolOptions{}
			}
		...
		case 9:
			...
			if m.Http2ProtocolOptions == nil {
				m.Http2ProtocolOptions = &envoy_api_v2_core4.Http2ProtocolOptions{}
			}
...
func (m *HttpConnectionManager_Tracing) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.ClientSampling == nil {
				m.ClientSampling = &envoy_api_v2_core1.Percent{}
			}
		...
		case 4:
			...
			if m.RandomSampling == nil {
				m.RandomSampling = &envoy_api_v2_core1.Percent{}
			}
		...
		case 5:
			...
			if m.OverallSampling == nil {
				m.OverallSampling = &envoy_api_v2_core1.Percent{}
			}
...
var fileDescriptorHttpConnectionManager = []byte{
	...
	,
}
