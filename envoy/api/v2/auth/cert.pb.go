...
type UpstreamTlsContext struct {
	...
	MaxSessionKeys *google_protobuf2.UInt32Value `protobuf:"bytes,4,opt,name=max_session_keys,json=maxSessionKeys" json:"max_session_keys,omitempty"`
}
...
func (m *UpstreamTlsContext) GetMaxSessionKeys() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *CertificateValidationContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.RequireOcspStaple == nil {
				m.RequireOcspStaple = &google_protobuf2.BoolValue{}
			}
		...
		case 6:
			...
			if m.RequireSignedCertificateTimestamp == nil {
				m.RequireSignedCertificateTimestamp = &google_protobuf2.BoolValue{}
			}
...
func (m *UpstreamTlsContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.MaxSessionKeys == nil {
				m.MaxSessionKeys = &google_protobuf2.UInt32Value{}
			}
...
func (m *DownstreamTlsContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.RequireClientCertificate == nil {
				m.RequireClientCertificate = &google_protobuf2.BoolValue{}
			}
		...
		case 3:
			...
			if m.RequireSni == nil {
				m.RequireSni = &google_protobuf2.BoolValue{}
			}
...
var fileDescriptorCert = []byte{
	...
	,
}
