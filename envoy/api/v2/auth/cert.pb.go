...
type TlsCertificate struct {
	...
	CertificateChain *envoy_api_v21.DataSource `protobuf:"bytes,1,opt,name=certificate_chain,json=certificateChain" json:"certificate_chain,omitempty"`
	// The TLS private key.
	PrivateKey *envoy_api_v21.DataSource `protobuf:"bytes,2,opt,name=private_key,json=privateKey" json:"private_key,omitempty"`
	// [#not-implemented-hide:]
	Password *envoy_api_v21.DataSource `protobuf:"bytes,3,opt,name=password" json:"password,omitempty"`
	// [#not-implemented-hide:]
	OcspStaple *envoy_api_v21.DataSource `protobuf:"bytes,4,opt,name=ocsp_staple,json=ocspStaple" json:"ocsp_staple,omitempty"`
	// [#not-implemented-hide:]
	SignedCertificateTimestamp []*envoy_api_v21.DataSource `protobuf:"bytes,5,rep,name=signed_certificate_timestamp,json=signedCertificateTimestamp" json:"signed_certificate_timestamp,omitempty"`
}
...
func (m *TlsCertificate) GetCertificateChain() *envoy_api_v21.DataSource {
	if m != nil {
...
func (m *TlsCertificate) GetPrivateKey() *envoy_api_v21.DataSource {
	if m != nil {
		return m.PrivateKey
	}
	return nil
...
func (m *TlsCertificate) GetPassword() *envoy_api_v21.DataSource {
	if m != nil {
		return m.Password
	}
	return nil
...
func (m *TlsCertificate) GetOcspStaple() *envoy_api_v21.DataSource {
	if m != nil {
		return m.OcspStaple
	}
	return nil
...
func (m *TlsCertificate) GetSignedCertificateTimestamp() []*envoy_api_v21.DataSource {
	if m != nil {
...
type TlsSessionTicketKeys struct {
	...
	Keys []*envoy_api_v21.DataSource `protobuf:"bytes,1,rep,name=keys" json:"keys,omitempty"`
}
...
func (m *TlsSessionTicketKeys) GetKeys() []*envoy_api_v21.DataSource {
	if m != nil {
		return m.Keys
	}
	return nil
...
type CertificateValidationContext struct {
	...
	// system CA locations.
	TrustedCa *envoy_api_v21.DataSource `protobuf:"bytes,1,opt,name=trusted_ca,json=trustedCa" json:"trusted_ca,omitempty"`
	...
	Crl *envoy_api_v21.DataSource `protobuf:"bytes,7,opt,name=crl" json:"crl,omitempty"`
}
...
func (m *CertificateValidationContext) GetTrustedCa() *envoy_api_v21.DataSource {
	if m != nil {
		return m.TrustedCa
	}
	return nil
...
func (m *CertificateValidationContext) GetCrl() *envoy_api_v21.DataSource {
	if m != nil {
		return m.Crl
	}
	return nil
...
type SdsSecretConfig struct {
	...
	SdsConfig *envoy_api_v23.ConfigSource `protobuf:"bytes,2,opt,name=sds_config,json=sdsConfig" json:"sds_config,omitempty"`
}
...
func (m *SdsSecretConfig) GetSdsConfig() *envoy_api_v23.ConfigSource {
	if m != nil {
		return m.SdsConfig
	}
	return nil
...
func (m *TlsCertificate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.CertificateChain == nil {
				m.CertificateChain = &envoy_api_v21.DataSource{}
			}
		...
		case 2:
			...
			if m.PrivateKey == nil {
				m.PrivateKey = &envoy_api_v21.DataSource{}
			}
		...
		case 3:
			...
			if m.Password == nil {
				m.Password = &envoy_api_v21.DataSource{}
			}
		...
		case 4:
			...
			if m.OcspStaple == nil {
				m.OcspStaple = &envoy_api_v21.DataSource{}
			}
		...
		case 5:
			...
			m.SignedCertificateTimestamp = append(m.SignedCertificateTimestamp, &envoy_api_v21.DataSource{})
...
func (m *TlsSessionTicketKeys) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Keys = append(m.Keys, &envoy_api_v21.DataSource{})
...
func (m *CertificateValidationContext) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.TrustedCa == nil {
				m.TrustedCa = &envoy_api_v21.DataSource{}
			}
		...
		case 7:
			...
			if m.Crl == nil {
				m.Crl = &envoy_api_v21.DataSource{}
			}
...
func (m *SdsSecretConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.SdsConfig == nil {
				m.SdsConfig = &envoy_api_v23.ConfigSource{}
			}
...
var fileDescriptorCert = []byte{
	...
	,
}
