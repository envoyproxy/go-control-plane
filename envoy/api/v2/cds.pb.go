...
func (Cluster_LbSubsetConfig_LbSubsetFallbackPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 4, 0}
}
...
func (Cluster_LbSubsetConfig_LbSubsetSelector_LbSubsetSelectorFallbackPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 4, 0, 0}
}
...
func (Cluster_RingHashLbConfig_HashFunction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 6, 0}
}
...
type Cluster struct {
	...
	// specific options.
	ExtensionProtocolOptions map[string]*google_protobuf1.Struct `protobuf:"bytes,35,rep,name=extension_protocol_options,json=extensionProtocolOptions" json:"extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
	// The extension_protocol_options field is used to provide extension-specific protocol options
	// for upstream connections. The key should match the extension filter name, such as
	// "envoy.filters.network.thrift_proxy". See the extension's documentation for details on
	// specific options.
	TypedExtensionProtocolOptions map[string]*google_protobuf.Any `protobuf:"bytes,36,rep,name=typed_extension_protocol_options,json=typedExtensionProtocolOptions" json:"typed_extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
type Cluster_ClusterType struct {
	ClusterType *Cluster_CustomClusterType `protobuf:"bytes,38,opt,name=cluster_type,json=clusterType,oneof"`
}
...
func (m *Cluster) GetExtensionProtocolOptions() map[string]*google_protobuf1.Struct {
	if m != nil {
...
func (m *Cluster) GetTypedExtensionProtocolOptions() map[string]*google_protobuf.Any {
	if m != nil {
...
type Cluster_CustomClusterType struct {
	...
	TypedConfig *google_protobuf.Any `protobuf:"bytes,2,opt,name=typed_config,json=typedConfig" json:"typed_config,omitempty"`
}
...
func (*Cluster_CustomClusterType) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 0} }
...
func (m *Cluster_CustomClusterType) GetTypedConfig() *google_protobuf.Any {
	if m != nil {
...
func (*Cluster_EdsClusterConfig) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 1} }
...
func (*Cluster_LbSubsetConfig) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 4} }
...
type Cluster_LeastRequestLbConfig struct {
	...
	ChoiceCount *google_protobuf2.UInt32Value `protobuf:"bytes,1,opt,name=choice_count,json=choiceCount" json:"choice_count,omitempty"`
}
...
func (*Cluster_LeastRequestLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 5}
}

func (m *Cluster_LeastRequestLbConfig) GetChoiceCount() *google_protobuf2.UInt32Value {
	if m != nil {
...
type Cluster_RingHashLbConfig struct {
	...
	MaximumRingSize *google_protobuf2.UInt64Value `protobuf:"bytes,4,opt,name=maximum_ring_size,json=maximumRingSize" json:"maximum_ring_size,omitempty"`
}
...
func (*Cluster_RingHashLbConfig) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 6} }
...
func (m *Cluster_RingHashLbConfig) GetMaximumRingSize() *google_protobuf2.UInt64Value {
	if m != nil {
...
func (*Cluster_OriginalDstLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 7}
}
...
type Cluster_CommonLbConfig struct {
	...
	UpdateMergeWindow *google_protobuf4.Duration `protobuf:"bytes,4,opt,name=update_merge_window,json=updateMergeWindow" json:"update_merge_window,omitempty"`
...
func (*Cluster_CommonLbConfig) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 8} }
...
func (m *Cluster_CommonLbConfig) GetUpdateMergeWindow() *google_protobuf4.Duration {
	if m != nil {
...
type Cluster_CommonLbConfig_ZoneAwareLbConfig struct {
	...
	// * :ref:`runtime values <config_cluster_manager_cluster_runtime_zone_routing>`.
	// * :ref:`Zone aware routing support <arch_overview_load_balancing_zone_aware_routing>`.
	MinClusterSize *google_protobuf2.UInt64Value `protobuf:"bytes,2,opt,name=min_cluster_size,json=minClusterSize" json:"min_cluster_size,omitempty"`
}
...
func (*Cluster_CommonLbConfig_ZoneAwareLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 8, 0}
}
...
func (m *Cluster_CommonLbConfig_ZoneAwareLbConfig) GetMinClusterSize() *google_protobuf2.UInt64Value {
	if m != nil {
...
func (*Cluster_CommonLbConfig_LocalityWeightedLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 8, 1}
}
...
func (c *clusterDiscoveryServiceClient) DeltaClusters(ctx context.Context, opts ...grpc.CallOption) (ClusterDiscoveryService_DeltaClustersClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClusterDiscoveryService_serviceDesc.Streams[1], c.cc, "/envoy.api.v2.ClusterDiscoveryService/DeltaClusters", opts...)
	if err != nil {
		return nil, err
	}
...
func (m *Cluster) MarshalTo(dAtA []byte) (int, error) {
	...
	n3, err := types.StdDurationMarshalTo(m.ConnectTimeout, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n3
	...
	if m.DnsRefreshRate != nil {
		...
		n10, err := types.StdDurationMarshalTo(*m.DnsRefreshRate, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.CleanupInterval != nil {
		...
		n12, err := types.StdDurationMarshalTo(*m.CleanupInterval, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
	...
	if len(m.ExtensionProtocolOptions) > 0 {
		...
		sortkeys.Strings(keysForExtensionProtocolOptions)
	...
	if len(m.TypedExtensionProtocolOptions) > 0 {
		...
		sortkeys.Strings(keysForTypedExtensionProtocolOptions)
...
func (m *Cluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.MaxRequestsPerConnection == nil {
				m.MaxRequestsPerConnection = &google_protobuf2.UInt32Value{}
			}
		...
		case 35:
			...
			if m.ExtensionProtocolOptions == nil {
				m.ExtensionProtocolOptions = make(map[string]*google_protobuf1.Struct)
			}
			var mapkey string
		...
		case 36:
			...
			if m.TypedExtensionProtocolOptions == nil {
				m.TypedExtensionProtocolOptions = make(map[string]*google_protobuf.Any)
			}
			var mapkey string
...
func (m *Cluster_CustomClusterType) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TypedConfig == nil {
				m.TypedConfig = &google_protobuf.Any{}
			}
...
func (m *Cluster_LbSubsetConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.DefaultSubset == nil {
				m.DefaultSubset = &google_protobuf1.Struct{}
			}
...
func (m *Cluster_LeastRequestLbConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ChoiceCount == nil {
				m.ChoiceCount = &google_protobuf2.UInt32Value{}
			}
...
func (m *Cluster_RingHashLbConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.MinimumRingSize == nil {
				m.MinimumRingSize = &google_protobuf2.UInt64Value{}
			}
		...
		case 4:
			...
			if m.MaximumRingSize == nil {
				m.MaximumRingSize = &google_protobuf2.UInt64Value{}
			}
...
func (m *Cluster_CommonLbConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.UpdateMergeWindow == nil {
				m.UpdateMergeWindow = &google_protobuf4.Duration{}
			}
...
func (m *Cluster_CommonLbConfig_ZoneAwareLbConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.MinClusterSize == nil {
				m.MinClusterSize = &google_protobuf2.UInt64Value{}
			}
...
var fileDescriptorCds = []byte{
	...
	,
}
