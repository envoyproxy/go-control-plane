...
type Cluster struct {
	...
	// specific options.
	ExtensionProtocolOptions map[string]*google_protobuf.Struct `protobuf:"bytes,35,rep,name=extension_protocol_options,json=extensionProtocolOptions" json:"extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *Cluster) GetExtensionProtocolOptions() map[string]*google_protobuf.Struct {
	if m != nil {
...
func (*Cluster_OriginalDstLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 4}
}
...
type Cluster_CommonLbConfig struct {
	...
	UpdateMergeWindow *google_protobuf3.Duration `protobuf:"bytes,4,opt,name=update_merge_window,json=updateMergeWindow" json:"update_merge_window,omitempty"`
}
...
func (*Cluster_CommonLbConfig) Descriptor() ([]byte, []int) { return fileDescriptorCds, []int{0, 5} }
...
func (m *Cluster_CommonLbConfig) GetUpdateMergeWindow() *google_protobuf3.Duration {
	if m != nil {
...
func (*Cluster_CommonLbConfig_ZoneAwareLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 5, 0}
}
...
func (*Cluster_CommonLbConfig_LocalityWeightedLbConfig) Descriptor() ([]byte, []int) {
	return fileDescriptorCds, []int{0, 5, 1}
}
	...
	for iNdEx < l {
		...
		case 35:
			...
			if m.ExtensionProtocolOptions == nil {
				m.ExtensionProtocolOptions = make(map[string]*google_protobuf.Struct)
			}
			var mapkey string
...
func (m *Cluster_CommonLbConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.UpdateMergeWindow == nil {
				m.UpdateMergeWindow = &google_protobuf3.Duration{}
			}
