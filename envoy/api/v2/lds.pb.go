...
type Listener struct {
	...
	Freebind bool `protobuf:"varint,11,opt,name=freebind,proto3" json:"freebind,omitempty"`
}
...
func (m *Listener) GetTransparent() bool {
	if m != nil {
...
func (m *Listener) GetFreebind() bool {
	if m != nil {
		return m.Freebind
	}
	return false
...
func (this *Listener) Equal(that interface{}) bool {
	...
	if this.Transparent != that1.Transparent {
		return false
	}
	if this.Freebind != that1.Freebind {
		return false
	}
	return true
}
...
var fileDescriptorLds = []byte{
	...
	,
}
