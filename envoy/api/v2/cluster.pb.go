...
type Cluster struct {
	...
	//
	// Deprecated: Marked as deprecated in envoy/api/v2/cluster.proto.
	ExtensionProtocolOptions map[string]*structpb.Struct `protobuf:"bytes,35,rep,name=extension_protocol_options,json=extensionProtocolOptions,proto3" json:"extension_protocol_options,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// The extension_protocol_options field is used to provide extension-specific protocol options
	// for upstream connections. The key should match the extension filter name, such as
	// "envoy.filters.network.thrift_proxy". See the extension's documentation for details on
	// specific options.
...
const file_envoy_api_v2_cluster_proto_rawDesc = "" +
	"\n" +
	"\x1aenvoy/api/v2/cluster.proto\x12\fenvoy.api.v2\x1a\x1benvoy/api/v2/auth/tls.proto\x1a*envoy/api/v2/cluster/circuit_breaker.proto\x1a!envoy/api/v2/cluster/filter.proto\x1a,envoy/api/v2/cluster/outlier_detection.proto\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1cenvoy/api/v2/core/base.proto\x1a%envoy/api/v2/core/config_source.proto\x1a$envoy/api/v2/core/health_check.proto\x1a envoy/api/v2/core/protocol.proto\x1a\x1benvoy/api/v2/endpoint.proto\x1a\x18envoy/type/percent.proto\x1a\x19google/protobuf/any.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xd89\n" +
	"\aCluster\x12d\n" +
	"\x18transport_socket_matches\x18+ \x03(\v2*.envoy.api.v2.Cluster.TransportSocketMatchR\x16transportSocketMatches\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x12\"\n" +
	"\ralt_stat_name\x18\x1c \x01(\tR\valtStatName\x12C\n" +
	"\x04type\x18\x02 \x01(\x0e2#.envoy.api.v2.Cluster.DiscoveryTypeB\b\xfaB\x05\x82\x01\x02\x10\x01H\x00R\x04type\x12L\n" +
	"\fcluster_type\x18& \x01(\v2'.envoy.api.v2.Cluster.CustomClusterTypeH\x00R\vclusterType\x12T\n" +
	"\x12eds_cluster_config\x18\x03 \x01(\v2&.envoy.api.v2.Cluster.EdsClusterConfigR\x10edsClusterConfig\x12L\n" +
	"\x0fconnect_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\x0econnectTimeout\x12f\n" +
	"!per_connection_buffer_limit_bytes\x18\x05 \x01(\v2\x1c.google.protobuf.UInt32ValueR\x1dperConnectionBufferLimitBytes\x12E\n" +
	"\tlb_policy\x18\x06 \x01(\x0e2\x1e.envoy.api.v2.Cluster.LbPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\blbPolicy\x124\n" +
	"\x05hosts\x18\a \x03(\v2\x1a.envoy.api.v2.core.AddressB\x02\x18\x01R\x05hosts\x12L\n" +
	"\x0fload_assignment\x18! \x01(\v2#.envoy.api.v2.ClusterLoadAssignmentR\x0eloadAssignment\x12C\n" +
	"\rhealth_checks\x18\b \x03(\v2\x1e.envoy.api.v2.core.HealthCheckR\fhealthChecks\x12[\n" +
	"\x1bmax_requests_per_connection\x18\t \x01(\v2\x1c.google.protobuf.UInt32ValueR\x18maxRequestsPerConnection\x12P\n" +
	"\x10circuit_breakers\x18\n" +
	" \x01(\v2%.envoy.api.v2.cluster.CircuitBreakersR\x0fcircuitBreakers\x12P\n" +
	"\vtls_context\x18\v \x01(\v2%.envoy.api.v2.auth.UpstreamTlsContextB\b\xb8\xee\xf2\xd2\x05\x01\x18\x01R\n" +
	"tlsContext\x12s\n" +
	"\x1eupstream_http_protocol_options\x18. \x01(\v2..envoy.api.v2.core.UpstreamHttpProtocolOptionsR\x1bupstreamHttpProtocolOptions\x12g\n" +
	"\x1ccommon_http_protocol_options\x18\x1d \x01(\v2&.envoy.api.v2.core.HttpProtocolOptionsR\x19commonHttpProtocolOptions\x12[\n" +
	"\x15http_protocol_options\x18\r \x01(\v2'.envoy.api.v2.core.Http1ProtocolOptionsR\x13httpProtocolOptions\x12]\n" +
	"\x16http2_protocol_options\x18\x0e \x01(\v2'.envoy.api.v2.core.Http2ProtocolOptionsR\x14http2ProtocolOptions\x12{\n" +
	"\x1aextension_protocol_options\x18# \x03(\v23.envoy.api.v2.Cluster.ExtensionProtocolOptionsEntryB\b\xb8\xee\xf2\xd2\x05\x01\x18\x01R\x18extensionProtocolOptions\x12\x81\x01\n" +
	" typed_extension_protocol_options\x18$ \x03(\v28.envoy.api.v2.Cluster.TypedExtensionProtocolOptionsEntryR\x1dtypedExtensionProtocolOptions\x12Q\n" +
	"\x10dns_refresh_rate\x18\x10 \x01(\v2\x19.google.protobuf.DurationB\f\xfaB\t\xaa\x01\x06*\x04\x10\xc0\x84=R\x0ednsRefreshRate\x12Z\n" +
	"\x18dns_failure_refresh_rate\x18, \x01(\v2!.envoy.api.v2.Cluster.RefreshRateR\x15dnsFailureRefreshRate\x12&\n" +
	"\x0frespect_dns_ttl\x18' \x01(\bR\rrespectDnsTtl\x12[\n" +
	"\x11dns_lookup_family\x18\x11 \x01(\x0e2%.envoy.api.v2.Cluster.DnsLookupFamilyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0fdnsLookupFamily\x12?\n" +
	"\rdns_resolvers\x18\x12 \x03(\v2\x1a.envoy.api.v2.core.AddressR\fdnsResolvers\x124\n" +
	"\x17use_tcp_for_dns_lookups\x18- \x01(\bR\x13useTcpForDnsLookups\x12S\n" +
	"\x11outlier_detection\x18\x13 \x01(\v2&.envoy.api.v2.cluster.OutlierDetectionR\x10outlierDetection\x12N\n" +
	"\x10cleanup_interval\x18\x14 \x01(\v2\x19.google.protobuf.DurationB\b\xfaB\x05\xaa\x01\x02*\x00R\x0fcleanupInterval\x12O\n" +
	"\x14upstream_bind_config\x18\x15 \x01(\v2\x1d.envoy.api.v2.core.BindConfigR\x12upstreamBindConfig\x12N\n" +
	"\x10lb_subset_config\x18\x16 \x01(\v2$.envoy.api.v2.Cluster.LbSubsetConfigR\x0elbSubsetConfig\x12W\n" +
	"\x13ring_hash_lb_config\x18\x17 \x01(\v2&.envoy.api.v2.Cluster.RingHashLbConfigH\x01R\x10ringHashLbConfig\x12`\n" +
	"\x16original_dst_lb_config\x18\" \x01(\v2).envoy.api.v2.Cluster.OriginalDstLbConfigH\x01R\x13originalDstLbConfig\x12c\n" +
	"\x17least_request_lb_config\x18% \x01(\v2*.envoy.api.v2.Cluster.LeastRequestLbConfigH\x01R\x14leastRequestLbConfig\x12N\n" +
	"\x10common_lb_config\x18\x1b \x01(\v2$.envoy.api.v2.Cluster.CommonLbConfigR\x0ecommonLbConfig\x12M\n" +
	"\x10transport_socket\x18\x18 \x01(\v2\".envoy.api.v2.core.TransportSocketR\x0ftransportSocket\x127\n" +
	"\bmetadata\x18\x19 \x01(\v2\x1b.envoy.api.v2.core.MetadataR\bmetadata\x12]\n" +
	"\x12protocol_selection\x18\x1a \x01(\x0e2..envoy.api.v2.Cluster.ClusterProtocolSelectionR\x11protocolSelection\x12g\n" +
	"\x1bupstream_connection_options\x18\x1e \x01(\v2'.envoy.api.v2.UpstreamConnectionOptionsR\x19upstreamConnectionOptions\x12U\n" +
	"(close_connections_on_host_health_failure\x18\x1f \x01(\bR#closeConnectionsOnHostHealthFailure\x12o\n" +
	"!drain_connections_on_host_removal\x18  \x01(\bB%\xf2\x98\xfe\x8f\x05\x1f\n" +
	"\x1dignore_health_on_host_removalR\x1ddrainConnectionsOnHostRemoval\x126\n" +
	"\afilters\x18( \x03(\v2\x1c.envoy.api.v2.cluster.FilterR\afilters\x12U\n" +
	"\x15load_balancing_policy\x18) \x01(\v2!.envoy.api.v2.LoadBalancingPolicyR\x13loadBalancingPolicy\x12>\n" +
	"\n" +
	"lrs_server\x18* \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceR\tlrsServer\x122\n" +
	"\x15track_timeout_budgets\x18/ \x01(\bR\x13trackTimeoutBudgets\x1a\xb1\x01\n" +
	"\x14TransportSocketMatch\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02\x10\x01R\x04name\x12-\n" +
	"\x05match\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05match\x12M\n" +
	"\x10transport_socket\x18\x03 \x01(\v2\".envoy.api.v2.core.TransportSocketR\x0ftransportSocket\x1ai\n" +
	"\x11CustomClusterType\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x04name\x127\n" +
	"\ftyped_config\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\vtypedConfig\x1au\n" +
	"\x10EdsClusterConfig\x12>\n" +
	"\n" +
	"eds_config\x18\x01 \x01(\v2\x1f.envoy.api.v2.core.ConfigSourceR\tedsConfig\x12!\n" +
	"\fservice_name\x18\x02 \x01(\tR\vserviceName\x1a\x81\a\n" +
	"\x0eLbSubsetConfig\x12n\n" +
	"\x0ffallback_policy\x18\x01 \x01(\x0e2;.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetFallbackPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0efallbackPolicy\x12>\n" +
	"\x0edefault_subset\x18\x02 \x01(\v2\x17.google.protobuf.StructR\rdefaultSubset\x12`\n" +
	"\x10subset_selectors\x18\x03 \x03(\v25.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelectorR\x0fsubsetSelectors\x122\n" +
	...
	"\vlist_as_any\x18\a \x01(\bR\tlistAsAny\x1a\xdd\x02\n" +
	"\x10LbSubsetSelector\x12\x12\n" +
	"\x04keys\x18\x01 \x03(\tR\x04keys\x12\x87\x01\n" +
	"\x0ffallback_policy\x18\x02 \x01(\x0e2T.envoy.api.v2.Cluster.LbSubsetConfig.LbSubsetSelector.LbSubsetSelectorFallbackPolicyB\b\xfaB\x05\x82\x01\x02\x10\x01R\x0efallbackPolicy\x120\n" +
	...
	"\fchoice_count\x18\x01 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x02R\vchoiceCount\x1a\xd8\x02\n" +
	"\x10RingHashLbConfig\x12T\n" +
	"\x11minimum_ring_size\x18\x01 \x01(\v2\x1c.google.protobuf.UInt64ValueB\n" +
	"\xfaB\a2\x05\x18\x80\x80\x80\x04R\x0fminimumRingSize\x12b\n" +
	"\rhash_function\x18\x03 \x01(\x0e23.envoy.api.v2.Cluster.RingHashLbConfig.HashFunctionB\b\xfaB\x05\x82\x01\x02\x10\x01R\fhashFunction\x12T\n" +
	...
	"\rMURMUR_HASH_2\x10\x01J\x04\b\x02\x10\x03\x1a=\n" +
	"\x13OriginalDstLbConfig\x12&\n" +
	"\x0fuse_http_header\x18\x01 \x01(\bR\ruseHttpHeader\x1a\x86\b\n" +
	"\x0eCommonLbConfig\x12K\n" +
	"\x17healthy_panic_threshold\x18\x01 \x01(\v2\x13.envoy.type.PercentR\x15healthyPanicThreshold\x12i\n" +
	"\x14zone_aware_lb_config\x18\x02 \x01(\v26.envoy.api.v2.Cluster.CommonLbConfig.ZoneAwareLbConfigH\x00R\x11zoneAwareLbConfig\x12~\n" +
	"\x1blocality_weighted_lb_config\x18\x03 \x01(\v2=.envoy.api.v2.Cluster.CommonLbConfig.LocalityWeightedLbConfigH\x00R\x18localityWeightedLbConfig\x12I\n" +
	...
	"$close_connections_on_host_set_change\x18\x06 \x01(\bR\x1fcloseConnectionsOnHostSetChange\x12\x7f\n" +
	"\x1cconsistent_hashing_lb_config\x18\a \x01(\v2>.envoy.api.v2.Cluster.CommonLbConfig.ConsistentHashingLbConfigR\x19consistentHashingLbConfig\x1a\xcc\x01\n" +
	"\x11ZoneAwareLbConfig\x12<\n" +
	"\x0frouting_enabled\x18\x01 \x01(\v2\x13.envoy.type.PercentR\x0eroutingEnabled\x12F\n" +
	"\x10min_cluster_size\x18\x02 \x01(\v2\x1c.google.protobuf.UInt64ValueR\x0eminClusterSize\x121\n" +
	"\x15fail_traffic_on_panic\x18\x03 \x01(\bR\x12failTrafficOnPanic\x1a\x1a\n" +
	"\x18LocalityWeightedLbConfig\x1aT\n" +
	"\x19ConsistentHashingLbConfig\x127\n" +
	"\x18use_hostname_for_hashing\x18\x01 \x01(\bR\x15useHostnameForHashingB\x1b\n" +
	"\x19locality_config_specifier\x1a\xa9\x01\n" +
	"\vRefreshRate\x12N\n" +
	...
	"\fmax_interval\x18\x02 \x01(\v2\x19.google.protobuf.DurationB\f\xfaB\t\xaa\x01\x06*\x04\x10\xc0\x84=R\vmaxInterval\x1ad\n" +
	"\x1dExtensionProtocolOptionsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12-\n" +
	"\x05value\x18\x02 \x01(\v2\x17.google.protobuf.StructR\x05value:\x028\x01\x1af\n" +
	...
	"\x0fORIGINAL_DST_LB\x10\x04\x1a\b\xa8\xf7\xb4\x8b\x02\x01\b\x01\x12\n" +
	"\n" +
	"\x06MAGLEV\x10\x05\x12\x14\n" +
	"\x10CLUSTER_PROVIDED\x10\x06\x12 \n" +
	"\x1cLOAD_BALANCING_POLICY_CONFIG\x10\a\"5\n" +
	...
	"\tlb_configJ\x04\b\f\x10\rJ\x04\b\x0f\x10\x10\"\xe8\x01\n" +
	"\x13LoadBalancingPolicy\x12D\n" +
	"\bpolicies\x18\x01 \x03(\v2(.envoy.api.v2.LoadBalancingPolicy.PolicyR\bpolicies\x1a\x8a\x01\n" +
	"\x06Policy\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x123\n" +
	"\x06config\x18\x02 \x01(\v2\x17.google.protobuf.StructB\x02\x18\x01R\x06config\x127\n" +
	"\ftyped_config\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\vtypedConfig\"W\n" +
	"\x12UpstreamBindConfig\x12A\n" +
	"\x0esource_address\x18\x01 \x01(\v2\x1a.envoy.api.v2.core.AddressR\rsourceAddress\"a\n" +
	"\x19UpstreamConnectionOptions\x12D\n" +
	"\rtcp_keepalive\x18\x01 \x01(\v2\x1f.envoy.api.v2.core.TcpKeepaliveR\ftcpKeepaliveB\x8e\x01\xf2\x98\xfe\x8f\x05\x19\x12\x17envoy.config.cluster.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x1aio.envoyproxy.envoy.api.v2B\fClusterProtoP\x01Z9github.com/envoyproxy/go-control-plane/envoy/api/v2;apiv2b\x06proto3"

var (
	file_envoy_api_v2_cluster_proto_rawDescOnce sync.Once
	file_envoy_api_v2_cluster_proto_rawDescData []byte
)

func file_envoy_api_v2_cluster_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_cluster_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_cluster_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_cluster_proto_rawDesc), len(file_envoy_api_v2_cluster_proto_rawDesc)))
	})
...
var file_envoy_api_v2_cluster_proto_goTypes = []any{
...
func file_envoy_api_v2_cluster_proto_init() {
	...
	file_envoy_api_v2_cluster_proto_msgTypes[0].OneofWrappers = []any{
		(*Cluster_Type)(nil),
	...
	file_envoy_api_v2_cluster_proto_msgTypes[11].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_cluster_proto_rawDesc), len(file_envoy_api_v2_cluster_proto_rawDesc)),
			NumEnums:      7,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   0,
