...
// source: envoy/api/v2/cluster/cluster.proto
...
import envoy_api_v25 "github.com/envoyproxy/go-control-plane/envoy/api/v2"
...
func (Cluster_DiscoveryType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCluster, []int{0, 0}
}
...
func (Cluster_LbPolicy) EnumDescriptor() ([]byte, []int) { return fileDescriptorCluster, []int{0, 1} }
...
func (Cluster_DnsLookupFamily) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCluster, []int{0, 2}
}
...
func (Cluster_ClusterProtocolSelection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCluster, []int{0, 3}
}
...
func (Cluster_LbSubsetConfig_LbSubsetFallbackPolicy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorCluster, []int{0, 1, 0}
}
...
type Cluster struct {
	...
	Type Cluster_DiscoveryType `protobuf:"varint,2,opt,name=type,proto3,enum=envoy.api.v2.cluster.Cluster_DiscoveryType" json:"type,omitempty"`
	...
	LbPolicy Cluster_LbPolicy `protobuf:"varint,6,opt,name=lb_policy,json=lbPolicy,proto3,enum=envoy.api.v2.cluster.Cluster_LbPolicy" json:"lb_policy,omitempty"`
	...
	Hosts []*envoy_api_v2.Address `protobuf:"bytes,7,rep,name=hosts" json:"hosts,omitempty"`
	...
	HttpProtocolOptions *envoy_api_v25.Http1ProtocolOptions `protobuf:"bytes,13,opt,name=http_protocol_options,json=httpProtocolOptions" json:"http_protocol_options,omitempty"`
	...
	Http2ProtocolOptions *envoy_api_v25.Http2ProtocolOptions `protobuf:"bytes,14,opt,name=http2_protocol_options,json=http2ProtocolOptions" json:"http2_protocol_options,omitempty"`
	...
	DnsLookupFamily Cluster_DnsLookupFamily `protobuf:"varint,17,opt,name=dns_lookup_family,json=dnsLookupFamily,proto3,enum=envoy.api.v2.cluster.Cluster_DnsLookupFamily" json:"dns_lookup_family,omitempty"`
	...
	// and :ref:`LOGICAL_DNS<envoy_api_enum_value_cluster.Cluster.DiscoveryType.LOGICAL_DNS>`
	// this setting is ignored.
	DnsResolvers []*envoy_api_v2.Address `protobuf:"bytes,18,rep,name=dns_resolvers,json=dnsResolvers" json:"dns_resolvers,omitempty"`
	// If specified, outlier detection will be enabled for this upstream cluster.
	// Each of the configuration values can be overridden via
	// :ref:`runtime values <config_cluster_manager_cluster_runtime_outlier_detection>`.
	OutlierDetection *OutlierDetection `protobuf:"bytes,19,opt,name=outlier_detection,json=outlierDetection" json:"outlier_detection,omitempty"`
	...
	UpstreamBindConfig *envoy_api_v2.BindConfig `protobuf:"bytes,21,opt,name=upstream_bind_config,json=upstreamBindConfig" json:"upstream_bind_config,omitempty"`
	...
	TransportSocket *envoy_api_v21.TransportSocket `protobuf:"bytes,24,opt,name=transport_socket,json=transportSocket" json:"transport_socket,omitempty"`
	...
	Metadata          *envoy_api_v21.Metadata          `protobuf:"bytes,25,opt,name=metadata" json:"metadata,omitempty"`
	ProtocolSelection Cluster_ClusterProtocolSelection `protobuf:"varint,26,opt,name=protocol_selection,json=protocolSelection,proto3,enum=envoy.api.v2.cluster.Cluster_ClusterProtocolSelection" json:"protocol_selection,omitempty"`
}

func (m *Cluster) Reset()                    { *m = Cluster{} }
func (m *Cluster) String() string            { return proto.CompactTextString(m) }
func (*Cluster) ProtoMessage()               {}
func (*Cluster) Descriptor() ([]byte, []int) { return fileDescriptorCluster, []int{0} }
...
func (m *Cluster) GetHosts() []*envoy_api_v2.Address {
	if m != nil {
		return m.Hosts
	}
	return nil
...
func (m *Cluster) GetDnsResolvers() []*envoy_api_v2.Address {
	if m != nil {
...
func (m *Cluster) GetUpstreamBindConfig() *envoy_api_v2.BindConfig {
	if m != nil {
...
func (m *Cluster) GetTransportSocket() *envoy_api_v21.TransportSocket {
	if m != nil {
...
func (m *Cluster) GetMetadata() *envoy_api_v21.Metadata {
	if m != nil {
		return m.Metadata
	}
	return nil
...
type Cluster_EdsClusterConfig struct {
	...
	EdsConfig *envoy_api_v23.ConfigSource `protobuf:"bytes,1,opt,name=eds_config,json=edsConfig" json:"eds_config,omitempty"`
...
func (m *Cluster_EdsClusterConfig) GetEdsConfig() *envoy_api_v23.ConfigSource {
	if m != nil {
		return m.EdsConfig
	}
	return nil
...
type Cluster_LbSubsetConfig struct {
	...
	FallbackPolicy Cluster_LbSubsetConfig_LbSubsetFallbackPolicy `protobuf:"varint,1,opt,name=fallback_policy,json=fallbackPolicy,proto3,enum=envoy.api.v2.cluster.Cluster_LbSubsetConfig_LbSubsetFallbackPolicy" json:"fallback_policy,omitempty"`
...
func (*Cluster_LbSubsetConfig) Descriptor() ([]byte, []int) { return fileDescriptorCluster, []int{0, 1} }
...
func (*Cluster_RingHashLbConfig_DeprecatedV1) Descriptor() ([]byte, []int) {
	return fileDescriptorCluster, []int{0, 2, 0}
}
...
type UpstreamBindConfig struct {
	...
	SourceAddress *envoy_api_v2.Address `protobuf:"bytes,1,opt,name=source_address,json=sourceAddress" json:"source_address,omitempty"`
}
...
func (*UpstreamBindConfig) Descriptor() ([]byte, []int) { return fileDescriptorCluster, []int{1} }

func (m *UpstreamBindConfig) GetSourceAddress() *envoy_api_v2.Address {
	if m != nil {
...
func init() {
	proto.RegisterType((*Cluster)(nil), "envoy.api.v2.cluster.Cluster")
	proto.RegisterType((*Cluster_EdsClusterConfig)(nil), "envoy.api.v2.cluster.Cluster.EdsClusterConfig")
	proto.RegisterType((*Cluster_LbSubsetConfig)(nil), "envoy.api.v2.cluster.Cluster.LbSubsetConfig")
	proto.RegisterType((*Cluster_LbSubsetConfig_LbSubsetSelector)(nil), "envoy.api.v2.cluster.Cluster.LbSubsetConfig.LbSubsetSelector")
	proto.RegisterType((*Cluster_RingHashLbConfig)(nil), "envoy.api.v2.cluster.Cluster.RingHashLbConfig")
	proto.RegisterType((*Cluster_RingHashLbConfig_DeprecatedV1)(nil), "envoy.api.v2.cluster.Cluster.RingHashLbConfig.DeprecatedV1")
	proto.RegisterType((*UpstreamBindConfig)(nil), "envoy.api.v2.cluster.UpstreamBindConfig")
	proto.RegisterEnum("envoy.api.v2.cluster.Cluster_DiscoveryType", Cluster_DiscoveryType_name, Cluster_DiscoveryType_value)
	proto.RegisterEnum("envoy.api.v2.cluster.Cluster_LbPolicy", Cluster_LbPolicy_name, Cluster_LbPolicy_value)
	proto.RegisterEnum("envoy.api.v2.cluster.Cluster_DnsLookupFamily", Cluster_DnsLookupFamily_name, Cluster_DnsLookupFamily_value)
	proto.RegisterEnum("envoy.api.v2.cluster.Cluster_ClusterProtocolSelection", Cluster_ClusterProtocolSelection_name, Cluster_ClusterProtocolSelection_value)
	proto.RegisterEnum("envoy.api.v2.cluster.Cluster_LbSubsetConfig_LbSubsetFallbackPolicy", Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_name, Cluster_LbSubsetConfig_LbSubsetFallbackPolicy_value)
}
...
func (m *Cluster) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EdsClusterConfig != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.EdsClusterConfig.Size()))
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintCluster(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(m.ConnectTimeout)))
	...
	if m.PerConnectionBufferLimitBytes != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.PerConnectionBufferLimitBytes.Size()))
	...
	if m.MaxRequestsPerConnection != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.MaxRequestsPerConnection.Size()))
	...
	if m.CircuitBreakers != nil {
		dAtA[i] = 0x52
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.CircuitBreakers.Size()))
	...
	if m.TlsContext != nil {
		dAtA[i] = 0x5a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.TlsContext.Size()))
	...
	if m.HttpProtocolOptions != nil {
		dAtA[i] = 0x6a
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.HttpProtocolOptions.Size()))
	...
	if m.Http2ProtocolOptions != nil {
		dAtA[i] = 0x72
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.Http2ProtocolOptions.Size()))
	...
	if m.DnsRefreshRate != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.DnsRefreshRate)))
	...
	if m.OutlierDetection != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.OutlierDetection.Size()))
	...
	if m.CleanupInterval != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(github_com_gogo_protobuf_types.SizeOfStdDuration(*m.CleanupInterval)))
	...
	if m.UpstreamBindConfig != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.UpstreamBindConfig.Size()))
	...
	if m.LbSubsetConfig != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.LbSubsetConfig.Size()))
	...
	if m.TransportSocket != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.TransportSocket.Size()))
	...
	if m.Metadata != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.Metadata.Size()))
...
func (m *Cluster_RingHashLbConfig_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RingHashLbConfig != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.RingHashLbConfig.Size()))
...
func (m *Cluster_EdsClusterConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.EdsConfig != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.EdsConfig.Size()))
...
func (m *Cluster_LbSubsetConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DefaultSubset != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.DefaultSubset.Size()))
		n19, err := m.DefaultSubset.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
...
func (m *Cluster_RingHashLbConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.MinimumRingSize != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.MinimumRingSize.Size()))
		n20, err := m.MinimumRingSize.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
	...
	if m.DeprecatedV1 != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.DeprecatedV1.Size()))
...
func (m *Cluster_RingHashLbConfig_DeprecatedV1) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.UseStdHash != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.UseStdHash.Size()))
		n22, err := m.UseStdHash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
...
func (m *UpstreamBindConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SourceAddress != nil {
		dAtA[i] = 0xa
		i++
		i = encodeVarintCluster(dAtA, i, uint64(m.SourceAddress.Size()))
		n23, err := m.SourceAddress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func (m *Cluster) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.Hosts = append(m.Hosts, &envoy_api_v2.Address{})
		...
		case 8:
			...
			m.HealthChecks = append(m.HealthChecks, &envoy_api_v24.HealthCheck{})
		...
		case 13:
			...
			if m.HttpProtocolOptions == nil {
				m.HttpProtocolOptions = &envoy_api_v25.Http1ProtocolOptions{}
			}
		...
		case 14:
			...
			if m.Http2ProtocolOptions == nil {
				m.Http2ProtocolOptions = &envoy_api_v25.Http2ProtocolOptions{}
			}
		...
		case 18:
			...
			m.DnsResolvers = append(m.DnsResolvers, &envoy_api_v2.Address{})
		...
		case 21:
			...
			if m.UpstreamBindConfig == nil {
				m.UpstreamBindConfig = &envoy_api_v2.BindConfig{}
			}
...
func (m *Cluster_EdsClusterConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.EdsConfig == nil {
				m.EdsConfig = &envoy_api_v23.ConfigSource{}
			}
...
func (m *UpstreamBindConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.SourceAddress == nil {
				m.SourceAddress = &envoy_api_v2.Address{}
			}
...
func init() { proto.RegisterFile("envoy/api/v2/cluster/cluster.proto", fileDescriptorCluster) }
...
var fileDescriptorCluster = []byte{
	...
	,
}
