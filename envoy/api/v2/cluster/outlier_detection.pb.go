...
type OutlierDetection struct {
	...
	// is set to true.
	ConsecutiveLocalOriginFailure *google_protobuf2.UInt32Value `protobuf:"bytes,13,opt,name=consecutive_local_origin_failure,json=consecutiveLocalOriginFailure" json:"consecutive_local_origin_failure,omitempty"`
	// The % chance that a host will be actually ejected when an outlier status
	...
	// :ref:`split_external_local_origin_errors<envoy_api_field_cluster.OutlierDetection.split_external_local_origin_errors>`
	// is set to true.
	EnforcingConsecutiveLocalOriginFailure *google_protobuf2.UInt32Value `protobuf:"bytes,14,opt,name=enforcing_consecutive_local_origin_failure,json=enforcingConsecutiveLocalOriginFailure" json:"enforcing_consecutive_local_origin_failure,omitempty"`
	// The % chance that a host will be actually ejected when an outlier status
	...
	// :ref:`split_external_local_origin_errors<envoy_api_field_cluster.OutlierDetection.split_external_local_origin_errors>`
	// is set to true.
	EnforcingLocalOriginSuccessRate *google_protobuf2.UInt32Value `protobuf:"bytes,15,opt,name=enforcing_local_origin_success_rate,json=enforcingLocalOriginSuccessRate" json:"enforcing_local_origin_success_rate,omitempty"`
}
...
func (m *OutlierDetection) GetConsecutiveLocalOriginFailure() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetEnforcingConsecutiveLocalOriginFailure() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) GetEnforcingLocalOriginSuccessRate() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *OutlierDetection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			if m.ConsecutiveLocalOriginFailure == nil {
				m.ConsecutiveLocalOriginFailure = &google_protobuf2.UInt32Value{}
			}
		...
		case 14:
			...
			if m.EnforcingConsecutiveLocalOriginFailure == nil {
				m.EnforcingConsecutiveLocalOriginFailure = &google_protobuf2.UInt32Value{}
			}
		...
		case 15:
			...
			if m.EnforcingLocalOriginSuccessRate == nil {
				m.EnforcingLocalOriginSuccessRate = &google_protobuf2.UInt32Value{}
			}
