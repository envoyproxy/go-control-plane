...
type CircuitBreakers_Thresholds struct {
	...
	// more details.
	MaxConnectionPools *google_protobuf2.UInt32Value `protobuf:"bytes,7,opt,name=max_connection_pools,json=maxConnectionPools" json:"max_connection_pools,omitempty"`
}
...
func (m *CircuitBreakers_Thresholds) GetMaxConnectionPools() *google_protobuf2.UInt32Value {
	if m != nil {
...
func (m *CircuitBreakers_Thresholds) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.MaxConnectionPools == nil {
				m.MaxConnectionPools = &google_protobuf2.UInt32Value{}
			}
