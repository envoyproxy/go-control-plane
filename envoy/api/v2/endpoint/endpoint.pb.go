...
type LbEndpoint_Endpoint struct {
	Endpoint *Endpoint `protobuf:"bytes,1,opt,name=endpoint,oneof"`
}
...
type LocalityLbEndpoints struct {
	...
	Proximity *google_protobuf2.UInt32Value `protobuf:"bytes,6,opt,name=proximity" json:"proximity,omitempty"`
}
...
func (m *LocalityLbEndpoints) GetProximity() *google_protobuf2.UInt32Value {
	if m != nil {
		return m.Proximity
	}
	return nil
...
func (m *LocalityLbEndpoints) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.Proximity == nil {
				m.Proximity = &google_protobuf2.UInt32Value{}
			}
...
var fileDescriptorEndpoint = []byte{
	...
	,
}
