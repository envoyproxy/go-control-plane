...
const file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc = "" +
	"\n" +
	"/envoy/api/v2/endpoint/endpoint_components.proto\x12\x15envoy.api.v2.endpoint\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy/api/v2/core/health_check.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x9a\x02\n" +
	"\bEndpoint\x124\n" +
	"\aaddress\x18\x01 \x01(\v2\x1a.envoy.api.v2.core.AddressR\aaddress\x12a\n" +
	"\x13health_check_config\x18\x02 \x01(\v21.envoy.api.v2.endpoint.Endpoint.HealthCheckConfigR\x11healthCheckConfig\x12\x1a\n" +
	"\bhostname\x18\x03 \x01(\tR\bhostname\x1aY\n" +
	"\x11HealthCheckConfig\x12(\n" +
	"\n" +
	"port_value\x18\x01 \x01(\rB\t\xfaB\x06*\x04\x18\xff\xff\x03R\tportValue\x12\x1a\n" +
	"\bhostname\x18\x02 \x01(\tR\bhostname\"\xdf\x02\n" +
	"\n" +
	"LbEndpoint\x12=\n" +
	"\bendpoint\x18\x01 \x01(\v2\x1f.envoy.api.v2.endpoint.EndpointH\x00R\bendpoint\x12%\n" +
	"\rendpoint_name\x18\x05 \x01(\tH\x00R\fendpointName\x12D\n" +
	"\rhealth_status\x18\x02 \x01(\x0e2\x1f.envoy.api.v2.core.HealthStatusR\fhealthStatus\x127\n" +
	"\bmetadata\x18\x03 \x01(\v2\x1b.envoy.api.v2.core.MetadataR\bmetadata\x12Y\n" +
	"\x15load_balancing_weight\x18\x04 \x01(\v2\x1c.google.protobuf.UInt32ValueB\a\xfaB\x04*\x02(\x01R\x13loadBalancingWeightB\x11\n" +
	"\x0fhost_identifier\"\xd1\x02\n" +
	"\x13LocalityLbEndpoints\x127\n" +
	"\blocality\x18\x01 \x01(\v2\x1b.envoy.api.v2.core.LocalityR\blocality\x12D\n" +
	"\flb_endpoints\x18\x02 \x03(\v2!.envoy.api.v2.endpoint.LbEndpointR\vlbEndpoints\x12Y\n" +
	...
	"\tproximity\x18\x06 \x01(\v2\x1c.google.protobuf.UInt32ValueR\tproximityB\xa6\x01\xf2\x98\xfe\x8f\x05\x1a\x12\x18envoy.config.endpoint.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"#io.envoyproxy.envoy.api.v2.endpointB\x17EndpointComponentsProtoP\x01Z<github.com/envoyproxy/go-control-plane/envoy/api/v2/endpointb\x06proto3"

var (
	file_envoy_api_v2_endpoint_endpoint_components_proto_rawDescOnce sync.Once
	file_envoy_api_v2_endpoint_endpoint_components_proto_rawDescData []byte
)
...
func file_envoy_api_v2_endpoint_endpoint_components_proto_rawDescGZIP() []byte {
	file_envoy_api_v2_endpoint_endpoint_components_proto_rawDescOnce.Do(func() {
		file_envoy_api_v2_endpoint_endpoint_components_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc), len(file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc)))
	})
...
var file_envoy_api_v2_endpoint_endpoint_components_proto_goTypes = []any{
...
func file_envoy_api_v2_endpoint_endpoint_components_proto_init() {
	...
	file_envoy_api_v2_endpoint_endpoint_components_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc), len(file_envoy_api_v2_endpoint_endpoint_components_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
