...
func (FilterChainMatch_ConnectionSourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_listener_c700d538faa6626d, []int{1, 0}
}
...
func (*Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_c700d538faa6626d, []int{0}
}
...
func (*FilterChainMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_c700d538faa6626d, []int{1}
}
...
func (*FilterChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_c700d538faa6626d, []int{2}
}
...
func (*ListenerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_c700d538faa6626d, []int{3}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/listener/listener.proto", fileDescriptor_listener_c700d538faa6626d)
}

var fileDescriptor_listener_c700d538faa6626d = []byte{
	...
	,
}
