...
func (*Filter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_defa937758e26f2e, []int{0}
}
...
func (*Filter_DeprecatedV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_defa937758e26f2e, []int{0, 0}
}
...
type FilterChainMatch struct {
	...
	//   instead.
	SniDomains           []string `protobuf:"bytes,1,rep,name=sni_domains,json=sniDomains" json:"sni_domains,omitempty"` // Deprecated: Do not use.
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*FilterChainMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_defa937758e26f2e, []int{1}
}
...
func (*FilterChain) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_defa937758e26f2e, []int{2}
}
...
func (*ListenerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_listener_defa937758e26f2e, []int{3}
}
...
func init() {
	proto.RegisterFile("envoy/api/v2/listener/listener.proto", fileDescriptor_listener_defa937758e26f2e)
}

var fileDescriptor_listener_defa937758e26f2e = []byte{
	// 789 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xb4, 0x54, 0x41, 0x4f, 0xdb, 0x48,
	0x18, 0x5d, 0x27, 0xd9, 0x90, 0x8c, 0x13, 0xc8, 0x8e, 0x40, 0x58, 0x59, 0x08, 0xd9, 0xec, 0xae,
	0x36, 0x42, 0x5a, 0x5b, 0x98, 0x95, 0xf6, 0xb0, 0x5a, 0x55, 0x04, 0x5a, 0xb5, 0x12, 0x20, 0xe4,
	0x40, 0x0e, 0xbd, 0xb8, 0x83, 0x3d, 0x09, 0xa3, 0x3a, 0x33, 0xd6, 0xcc, 0x38, 0x84, 0x7f, 0x54,
	0xf5, 0x1f, 0xb4, 0xa7, 0x1e, 0x39, 0x55, 0xed, 0x1f, 0xa8, 0xaa, 0xdc, 0xfa, 0x2b, 0xa8, 0x3c,
	0xb6, 0x43, 0x02, 0x11, 0xed, 0xa5, 0xb7, 0x6f, 0xbe, 0xef, 0xbd, 0x97, 0xe7, 0x6f, 0x5e, 0x06,
	0xfc, 0x81, 0xe9, 0x88, 0x5d, 0x59, 0x28, 0x24, 0xd6, 0xc8, 0xb6, 0x02, 0x22, 0x24, 0xa6, 0x98,
	...
	0x8a, 0x4f, 0x48, 0x20, 0x31, 0x87, 0x9b, 0xa0, 0x40, 0xd1, 0x10, 0x1b, 0x5a, 0x53, 0x6b, 0x97,
	0x3b, 0xe5, 0xb7, 0x5f, 0xde, 0xe5, 0x0b, 0x3c, 0xd7, 0xd4, 0x1c, 0xd5, 0x86, 0x16, 0x28, 0x7a,
	...
	,
}
