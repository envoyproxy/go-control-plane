...
const file_envoy_admin_v2alpha_server_info_proto_rawDesc = "" +
	"\n" +
	"%envoy/admin/v2alpha/server_info.proto\x12\x13envoy.admin.v2alpha\x1a\x1egoogle/protobuf/duration.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\"\xcb\x03\n" +
	"\n" +
	"ServerInfo\x12\x18\n" +
	"\aversion\x18\x01 \x01(\tR\aversion\x12;\n" +
	"\x05state\x18\x02 \x01(\x0e2%.envoy.admin.v2alpha.ServerInfo.StateR\x05state\x12K\n" +
	...
	"\x13hot_restart_version\x18\x05 \x01(\tR\x11hotRestartVersion\x12Y\n" +
	"\x14command_line_options\x18\x06 \x01(\v2'.envoy.admin.v2alpha.CommandLineOptionsR\x12commandLineOptions\"G\n" +
	"\x05State\x12\b\n" +
	"\x04LIVE\x10\x00\x12\f\n" +
	"\bDRAINING\x10\x01\x12\x14\n" +
	"\x10PRE_INITIALIZING\x10\x02\x12\x10\n" +
	"\fINITIALIZING\x10\x03\"\xf0\n" +
	"\n" +
	...
	"\x1dreject_unknown_dynamic_fields\x18\x1a \x01(\bR\x1arejectUnknownDynamicFields\x12,\n" +
	"\x12admin_address_path\x18\x06 \x01(\tR\x10adminAddressPath\x12j\n" +
	"\x18local_address_ip_version\x18\a \x01(\x0e21.envoy.admin.v2alpha.CommandLineOptions.IpVersionR\x15localAddressIpVersion\x12\x1b\n" +
	...
	"\n" +
	"drain_time\x18\x11 \x01(\v2\x19.google.protobuf.DurationR\tdrainTime\x12K\n" +
	"\x14parent_shutdown_time\x18\x12 \x01(\v2\x19.google.protobuf.DurationR\x12parentShutdownTime\x12@\n" +
	"\x04mode\x18\x13 \x01(\x0e2,.envoy.admin.v2alpha.CommandLineOptions.ModeR\x04mode\x12%\n" +
	"\tmax_stats\x18\x14 \x01(\x04B\b\xb8\xee\xf2\xd2\x05\x01\x18\x01R\bmaxStats\x121\n" +
	"\x10max_obj_name_len\x18\x15 \x01(\x04B\b\xb8\xee\xf2\xd2\x05\x01\x18\x01R\rmaxObjNameLen\x12.\n" +
	...
	"\x13disabled_extensions\x18\x1c \x03(\tR\x12disabledExtensions\"\x1b\n" +
	"\tIpVersion\x12\x06\n" +
	...
	"\bInitOnly\x10\x02J\x04\b\f\x10\rBz\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"!io.envoyproxy.envoy.admin.v2alphaB\x0fServerInfoProtoP\x01Z:github.com/envoyproxy/go-control-plane/envoy/admin/v2alphab\x06proto3"

var (
	file_envoy_admin_v2alpha_server_info_proto_rawDescOnce sync.Once
	file_envoy_admin_v2alpha_server_info_proto_rawDescData []byte
)
...
func file_envoy_admin_v2alpha_server_info_proto_rawDescGZIP() []byte {
	file_envoy_admin_v2alpha_server_info_proto_rawDescOnce.Do(func() {
		file_envoy_admin_v2alpha_server_info_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_server_info_proto_rawDesc), len(file_envoy_admin_v2alpha_server_info_proto_rawDesc)))
	})
...
var file_envoy_admin_v2alpha_server_info_proto_goTypes = []any{
...
func file_envoy_admin_v2alpha_server_info_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_server_info_proto_rawDesc), len(file_envoy_admin_v2alpha_server_info_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
