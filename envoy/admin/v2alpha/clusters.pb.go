...
func (*Clusters) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_a336b5a88375883c, []int{0}
}
...
func (*ClusterStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_a336b5a88375883c, []int{1}
}
...
func (*HostStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_a336b5a88375883c, []int{2}
}
...
func (*HostHealthStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_clusters_a336b5a88375883c, []int{3}
}
...
func init() {
	proto.RegisterFile("envoy/admin/v2alpha/clusters.proto", fileDescriptor_clusters_a336b5a88375883c)
}

var fileDescriptor_clusters_a336b5a88375883c = []byte{
	// 557 bytes of a gzipped FileDescriptorProto
	,
}
