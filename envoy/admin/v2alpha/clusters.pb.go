...
const file_envoy_admin_v2alpha_clusters_proto_rawDesc = "" +
	"\n" +
	"\"envoy/admin/v2alpha/clusters.proto\x12\x13envoy.admin.v2alpha\x1a!envoy/admin/v2alpha/metrics.proto\x1a\x1fenvoy/api/v2/core/address.proto\x1a\x1cenvoy/api/v2/core/base.proto\x1a$envoy/api/v2/core/health_check.proto\x1a\x18envoy/type/percent.proto\x1a\x1dudpa/annotations/status.proto\"Y\n" +
	"\bClusters\x12M\n" +
	"\x10cluster_statuses\x18\x01 \x03(\v2\".envoy.admin.v2alpha.ClusterStatusR\x0fclusterStatuses\"\xdd\x02\n" +
	"\rClusterStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\"\n" +
	"\radded_via_api\x18\x02 \x01(\bR\vaddedViaApi\x12Z\n" +
	"\x1fsuccess_rate_ejection_threshold\x18\x03 \x01(\v2\x13.envoy.type.PercentR\x1csuccessRateEjectionThreshold\x12D\n" +
	"\rhost_statuses\x18\x04 \x03(\v2\x1f.envoy.admin.v2alpha.HostStatusR\fhostStatuses\x12r\n" +
	",local_origin_success_rate_ejection_threshold\x18\x05 \x01(\v2\x13.envoy.type.PercentR'localOriginSuccessRateEjectionThreshold\"\xd8\x03\n" +
	"\n" +
	"HostStatus\x124\n" +
	"\aaddress\x18\x01 \x01(\v2\x1a.envoy.api.v2.core.AddressR\aaddress\x127\n" +
	"\x05stats\x18\x02 \x03(\v2!.envoy.admin.v2alpha.SimpleMetricR\x05stats\x12J\n" +
	"\rhealth_status\x18\x03 \x01(\v2%.envoy.admin.v2alpha.HostHealthStatusR\fhealthStatus\x126\n" +
	"\fsuccess_rate\x18\x04 \x01(\v2\x13.envoy.type.PercentR\vsuccessRate\x12\x16\n" +
	"\x06weight\x18\x05 \x01(\rR\x06weight\x12\x1a\n" +
	"\bhostname\x18\x06 \x01(\tR\bhostname\x12\x1a\n" +
	"\bpriority\x18\a \x01(\rR\bpriority\x12N\n" +
	"\x19local_origin_success_rate\x18\b \x01(\v2\x13.envoy.type.PercentR\x16localOriginSuccessRate\x127\n" +
	"\blocality\x18\t \x01(\v2\x1b.envoy.api.v2.core.LocalityR\blocality\"\xf3\x02\n" +
	...
	"\x11pending_active_hc\x18\x06 \x01(\bR\x0fpendingActiveHc\x12K\n" +
	"\x11eds_health_status\x18\x03 \x01(\x0e2\x1f.envoy.api.v2.core.HealthStatusR\x0fedsHealthStatusBx\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"!io.envoyproxy.envoy.admin.v2alphaB\rClustersProtoP\x01Z:github.com/envoyproxy/go-control-plane/envoy/admin/v2alphab\x06proto3"

var (
	file_envoy_admin_v2alpha_clusters_proto_rawDescOnce sync.Once
	file_envoy_admin_v2alpha_clusters_proto_rawDescData []byte
)

func file_envoy_admin_v2alpha_clusters_proto_rawDescGZIP() []byte {
	file_envoy_admin_v2alpha_clusters_proto_rawDescOnce.Do(func() {
		file_envoy_admin_v2alpha_clusters_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_clusters_proto_rawDesc), len(file_envoy_admin_v2alpha_clusters_proto_rawDesc)))
	})
...
var file_envoy_admin_v2alpha_clusters_proto_goTypes = []any{
...
func file_envoy_admin_v2alpha_clusters_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_clusters_proto_rawDesc), len(file_envoy_admin_v2alpha_clusters_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
