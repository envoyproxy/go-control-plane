...
type TapRequest struct {
	...
	TapConfig *envoy_service_tap_v2alpha.TapConfig `protobuf:"bytes,2,opt,name=tap_config,json=tapConfig" json:"tap_config,omitempty"`
}
...
func (*TapRequest) Descriptor() ([]byte, []int) { return fileDescriptorTap, []int{0} }
...
func (m *TapRequest) GetTapConfig() *envoy_service_tap_v2alpha.TapConfig {
	if m != nil {
		return m.TapConfig
	}
	return nil
...
func (m *TapRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.TapConfig == nil {
				m.TapConfig = &envoy_service_tap_v2alpha.TapConfig{}
			}
...
func init() { proto.RegisterFile("envoy/admin/v2alpha/tap.proto", fileDescriptorTap) }
