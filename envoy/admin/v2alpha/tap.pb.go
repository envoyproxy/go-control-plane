...
const file_envoy_admin_v2alpha_tap_proto_rawDesc = "" +
	"\n" +
	"\x1denvoy/admin/v2alpha/tap.proto\x12\x13envoy.admin.v2alpha\x1a&envoy/service/tap/v2alpha/common.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x81\x01\n" +
	"\n" +
	"TapRequest\x12$\n" +
	"\tconfig_id\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\bconfigId\x12M\n" +
	"\n" +
	"tap_config\x18\x02 \x01(\v2$.envoy.service.tap.v2alpha.TapConfigB\b\xfaB\x05\x8a\x01\x02\x10\x01R\ttapConfigBs\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"!io.envoyproxy.envoy.admin.v2alphaB\bTapProtoP\x01Z:github.com/envoyproxy/go-control-plane/envoy/admin/v2alphab\x06proto3"

var (
	file_envoy_admin_v2alpha_tap_proto_rawDescOnce sync.Once
	file_envoy_admin_v2alpha_tap_proto_rawDescData []byte
)

func file_envoy_admin_v2alpha_tap_proto_rawDescGZIP() []byte {
	file_envoy_admin_v2alpha_tap_proto_rawDescOnce.Do(func() {
		file_envoy_admin_v2alpha_tap_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_tap_proto_rawDesc), len(file_envoy_admin_v2alpha_tap_proto_rawDesc)))
	})
...
var file_envoy_admin_v2alpha_tap_proto_goTypes = []any{
...
func file_envoy_admin_v2alpha_tap_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_admin_v2alpha_tap_proto_rawDesc), len(file_envoy_admin_v2alpha_tap_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
