...
type Listeners struct {
	...
	ListenerStatuses []*ListenerStatus `protobuf:"bytes,1,rep,name=listener_statuses,json=listenerStatuses" json:"listener_statuses,omitempty"`
}
...
func (*Listeners) Descriptor() ([]byte, []int) { return fileDescriptorListeners, []int{0} }
...
func (*ListenerStatus) Descriptor() ([]byte, []int) { return fileDescriptorListeners, []int{1} }
...
func (m *ListenerStatus) GetLocalAddress() *envoy_api_v2_core1.Address {
	if m != nil {
...
func init() { proto.RegisterFile("envoy/admin/v2alpha/listeners.proto", fileDescriptorListeners) }

var fileDescriptorListeners = []byte{
