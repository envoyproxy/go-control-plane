...
func (*Certificates) Descriptor() ([]byte, []int) { return fileDescriptorCerts, []int{0} }
...
func (*Certificate) Descriptor() ([]byte, []int) { return fileDescriptorCerts, []int{1} }
...
type CertificateDetails struct {
	...
	ValidFrom *google_protobuf.Timestamp `protobuf:"bytes,5,opt,name=valid_from,json=validFrom" json:"valid_from,omitempty"`
	// Indicates the time at which the certificate expires.
	ExpirationTime *google_protobuf.Timestamp `protobuf:"bytes,6,opt,name=expiration_time,json=expirationTime" json:"expiration_time,omitempty"`
}
...
func (*CertificateDetails) Descriptor() ([]byte, []int) { return fileDescriptorCerts, []int{2} }
...
func (m *CertificateDetails) GetValidFrom() *google_protobuf.Timestamp {
	if m != nil {
		return m.ValidFrom
	}
	return nil
...
func (m *CertificateDetails) GetExpirationTime() *google_protobuf.Timestamp {
	if m != nil {
...
func (*SubjectAlternateName) Descriptor() ([]byte, []int) { return fileDescriptorCerts, []int{3} }
...
func (m *CertificateDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.ValidFrom == nil {
				m.ValidFrom = &google_protobuf.Timestamp{}
			}
		...
		case 6:
			...
			if m.ExpirationTime == nil {
				m.ExpirationTime = &google_protobuf.Timestamp{}
			}
...
func init() { proto.RegisterFile("envoy/admin/v2alpha/certs.proto", fileDescriptorCerts) }

var fileDescriptorCerts = []byte{
