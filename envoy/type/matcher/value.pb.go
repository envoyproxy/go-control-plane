...
const file_envoy_type_matcher_value_proto_rawDesc = "" +
	"\n" +
	"\x1eenvoy/type/matcher/value.proto\x12\x12envoy.type.matcher\x1a\x1fenvoy/type/matcher/number.proto\x1a\x1fenvoy/type/matcher/string.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\x98\x03\n" +
	"\fValueMatcher\x12K\n" +
	"\n" +
	"null_match\x18\x01 \x01(\v2*.envoy.type.matcher.ValueMatcher.NullMatchH\x00R\tnullMatch\x12F\n" +
	"\fdouble_match\x18\x02 \x01(\v2!.envoy.type.matcher.DoubleMatcherH\x00R\vdoubleMatch\x12F\n" +
	"\fstring_match\x18\x03 \x01(\v2!.envoy.type.matcher.StringMatcherH\x00R\vstringMatch\x12\x1f\n" +
	"\n" +
	"bool_match\x18\x04 \x01(\bH\x00R\tboolMatch\x12%\n" +
	"\rpresent_match\x18\x05 \x01(\bH\x00R\fpresentMatch\x12@\n" +
	"\n" +
	"list_match\x18\x06 \x01(\v2\x1f.envoy.type.matcher.ListMatcherH\x00R\tlistMatch\x1a\v\n" +
	"\tNullMatchB\x14\n" +
	"\rmatch_pattern\x12\x03\xf8B\x01\"^\n" +
	"\vListMatcher\x129\n" +
	"\x06one_of\x18\x01 \x01(\v2 .envoy.type.matcher.ValueMatcherH\x00R\x05oneOfB\x14\n" +
	"\rmatch_pattern\x12\x03\xf8B\x01Bs\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	" io.envoyproxy.envoy.type.matcherB\n" +
	"ValueProtoP\x01Z9github.com/envoyproxy/go-control-plane/envoy/type/matcherb\x06proto3"

var (
	file_envoy_type_matcher_value_proto_rawDescOnce sync.Once
	file_envoy_type_matcher_value_proto_rawDescData []byte
)

func file_envoy_type_matcher_value_proto_rawDescGZIP() []byte {
	file_envoy_type_matcher_value_proto_rawDescOnce.Do(func() {
		file_envoy_type_matcher_value_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_matcher_value_proto_rawDesc), len(file_envoy_type_matcher_value_proto_rawDesc)))
	})
...
var file_envoy_type_matcher_value_proto_goTypes = []any{
...
func file_envoy_type_matcher_value_proto_init() {
	...
	file_envoy_type_matcher_value_proto_msgTypes[0].OneofWrappers = []any{
	...
	file_envoy_type_matcher_value_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_matcher_value_proto_rawDesc), len(file_envoy_type_matcher_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
