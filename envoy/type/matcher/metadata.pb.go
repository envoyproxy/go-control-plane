...
func (m *MetadataMatcher_Value) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MetadataMatcher_Value.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MetadataMatcher_Value) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetadataMatcher_Value.Merge(dst, src)
}
func (m *MetadataMatcher_Value) XXX_Size() int {
	return m.Size()
}
func (m *MetadataMatcher_Value) XXX_DiscardUnknown() {
	xxx_messageInfo_MetadataMatcher_Value.DiscardUnknown(m)
}

var xxx_messageInfo_MetadataMatcher_Value proto.InternalMessageInfo
...
func (m *MetadataMatcher_Value_NullMatch) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MetadataMatcher_Value_NullMatch.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *MetadataMatcher_Value_NullMatch) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetadataMatcher_Value_NullMatch.Merge(dst, src)
}
func (m *MetadataMatcher_Value_NullMatch) XXX_Size() int {
	return m.Size()
}
func (m *MetadataMatcher_Value_NullMatch) XXX_DiscardUnknown() {
	xxx_messageInfo_MetadataMatcher_Value_NullMatch.DiscardUnknown(m)
}

var xxx_messageInfo_MetadataMatcher_Value_NullMatch proto.InternalMessageInfo
