...
const file_envoy_type_percent_proto_rawDesc = "" +
	"\n" +
	"\x18envoy/type/percent.proto\x12\n" +
	"envoy.type\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"8\n" +
	"\aPercent\x12-\n" +
	"\x05value\x18\x01 \x01(\x01B\x17\xfaB\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00Y@)\x00\x00\x00\x00\x00\x00\x00\x00R\x05value\"\xcb\x01\n" +
	"\x11FractionalPercent\x12\x1c\n" +
	"\tnumerator\x18\x01 \x01(\rR\tnumerator\x12Y\n" +
	"\vdenominator\x18\x02 \x01(\x0e2-.envoy.type.FractionalPercent.DenominatorTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\vdenominator\"=\n" +
	"\x0fDenominatorType\x12\v\n" +
	"\aHUNDRED\x10\x00\x12\x10\n" +
	"\fTEN_THOUSAND\x10\x01\x12\v\n" +
	"\aMILLION\x10\x02Be\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x18io.envoyproxy.envoy.typeB\fPercentProtoP\x01Z1github.com/envoyproxy/go-control-plane/envoy/typeb\x06proto3"

var (
	file_envoy_type_percent_proto_rawDescOnce sync.Once
	file_envoy_type_percent_proto_rawDescData []byte
)

func file_envoy_type_percent_proto_rawDescGZIP() []byte {
	file_envoy_type_percent_proto_rawDescOnce.Do(func() {
		file_envoy_type_percent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_percent_proto_rawDesc), len(file_envoy_type_percent_proto_rawDesc)))
	})
...
var file_envoy_type_percent_proto_goTypes = []any{
...
func file_envoy_type_percent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_percent_proto_rawDesc), len(file_envoy_type_percent_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
