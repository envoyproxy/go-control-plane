...
const file_envoy_type_metadata_v2_metadata_proto_rawDesc = "" +
	"\n" +
	"%envoy/type/metadata/v2/metadata.proto\x12\x16envoy.type.metadata.v2\x1a\x1eudpa/annotations/migrate.proto\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"\xb3\x01\n" +
	"\vMetadataKey\x12\x19\n" +
	"\x03key\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01R\x03key\x12M\n" +
	"\x04path\x18\x02 \x03(\v2/.envoy.type.metadata.v2.MetadataKey.PathSegmentB\b\xfaB\x05\x92\x01\x02\b\x01R\x04path\x1a:\n" +
	"\vPathSegment\x12\x1b\n" +
	"\x03key\x18\x01 \x01(\tB\a\xfaB\x04r\x02 \x01H\x00R\x03keyB\x0e\n" +
	"\asegment\x12\x03\xf8B\x01\"\xdb\x02\n" +
	"\fMetadataKind\x12H\n" +
	"\arequest\x18\x01 \x01(\v2,.envoy.type.metadata.v2.MetadataKind.RequestH\x00R\arequest\x12B\n" +
	"\x05route\x18\x02 \x01(\v2*.envoy.type.metadata.v2.MetadataKind.RouteH\x00R\x05route\x12H\n" +
	"\acluster\x18\x03 \x01(\v2,.envoy.type.metadata.v2.MetadataKind.ClusterH\x00R\acluster\x12?\n" +
	"\x04host\x18\x04 \x01(\v2).envoy.type.metadata.v2.MetadataKind.HostH\x00R\x04host\x1a\t\n" +
	"\aRequest\x1a\a\n" +
	"\x05Route\x1a\t\n" +
	"\aCluster\x1a\x06\n" +
	"\x04HostB\v\n" +
	"\x04kind\x12\x03\xf8B\x01B\xa7\x01\xf2\x98\xfe\x8f\x05\x18\x12\x16envoy.type.metadata.v3\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"$io.envoyproxy.envoy.type.metadata.v2B\rMetadataProtoP\x01ZHgithub.com/envoyproxy/go-control-plane/envoy/type/metadata/v2;metadatav2b\x06proto3"

var (
	file_envoy_type_metadata_v2_metadata_proto_rawDescOnce sync.Once
	file_envoy_type_metadata_v2_metadata_proto_rawDescData []byte
)
...
func file_envoy_type_metadata_v2_metadata_proto_rawDescGZIP() []byte {
	file_envoy_type_metadata_v2_metadata_proto_rawDescOnce.Do(func() {
		file_envoy_type_metadata_v2_metadata_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_metadata_v2_metadata_proto_rawDesc), len(file_envoy_type_metadata_v2_metadata_proto_rawDesc)))
	})
...
var file_envoy_type_metadata_v2_metadata_proto_goTypes = []any{
...
func file_envoy_type_metadata_v2_metadata_proto_init() {
	...
	file_envoy_type_metadata_v2_metadata_proto_msgTypes[1].OneofWrappers = []any{
		(*MetadataKind_Request_)(nil),
		(*MetadataKind_Route_)(nil),
		(*MetadataKind_Cluster_)(nil),
		(*MetadataKind_Host_)(nil),
	}
	file_envoy_type_metadata_v2_metadata_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_metadata_v2_metadata_proto_rawDesc), len(file_envoy_type_metadata_v2_metadata_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
