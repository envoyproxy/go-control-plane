...
const file_envoy_type_http_proto_rawDesc = "" +
	"\n" +
	...
	"\x05HTTP3\x10\x02Bb\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x18io.envoyproxy.envoy.typeB\tHttpProtoP\x01Z1github.com/envoyproxy/go-control-plane/envoy/typeb\x06proto3"

var (
	file_envoy_type_http_proto_rawDescOnce sync.Once
	file_envoy_type_http_proto_rawDescData []byte
)

func file_envoy_type_http_proto_rawDescGZIP() []byte {
	file_envoy_type_http_proto_rawDescOnce.Do(func() {
		file_envoy_type_http_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_http_proto_rawDesc), len(file_envoy_type_http_proto_rawDesc)))
	})
	return file_envoy_type_http_proto_rawDescData
}

var file_envoy_type_http_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_envoy_type_http_proto_goTypes = []any{
...
func file_envoy_type_http_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_http_proto_rawDesc), len(file_envoy_type_http_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
