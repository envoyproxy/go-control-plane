...
const file_envoy_type_http_status_proto_rawDesc = "" +
	"\n" +
	"\x1cenvoy/type/http_status.proto\x12\n" +
	"envoy.type\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\"D\n" +
	"\n" +
	"HttpStatus\x126\n" +
	"\x04code\x18\x01 \x01(\x0e2\x16.envoy.type.StatusCodeB\n" +
	"\xfaB\a\x82\x01\x04\x10\x01 \x00R\x04code*\xb5\t\n" +
	"\n" +
	"StatusCode\x12\t\n" +
	...
	"\x1dNetworkAuthenticationRequired\x10\xff\x03Bh\xba\x80\xc8\xd1\x06\x02\x10\x01\n" +
	"\x18io.envoyproxy.envoy.typeB\x0fHttpStatusProtoP\x01Z1github.com/envoyproxy/go-control-plane/envoy/typeb\x06proto3"

var (
	file_envoy_type_http_status_proto_rawDescOnce sync.Once
	file_envoy_type_http_status_proto_rawDescData []byte
)

func file_envoy_type_http_status_proto_rawDescGZIP() []byte {
	file_envoy_type_http_status_proto_rawDescOnce.Do(func() {
		file_envoy_type_http_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_envoy_type_http_status_proto_rawDesc), len(file_envoy_type_http_status_proto_rawDesc)))
	})
...
var file_envoy_type_http_status_proto_goTypes = []any{
...
func file_envoy_type_http_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_envoy_type_http_status_proto_rawDesc), len(file_envoy_type_http_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
