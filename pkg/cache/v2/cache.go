...
func (r *RawResponse) GetDiscoveryResponse() (*discovery.DiscoveryResponse, error) {
	...
	if marshaledResponse == nil {
		...
		for i, resource := range r.Resources {
			maybeTtldResource, resourceName, err := ttl.MaybeCreateTtlResourceIfSupported(resource, GetResourceName(resource.Resource), r.Request.TypeUrl, r.Heartbeat)
			if err != nil {
				return nil, err
			}
