...
func TestValidate(t *testing.T) {
	...
	invalidRoute := &routev3.RouteConfiguration{
		Name: "test",
...
func TestGetResourceReferences(t *testing.T) {
	cases := []struct {
		...
		{
			in: &clusterv3.Cluster{Name: clusterName, ClusterDiscoveryType: &clusterv3.Cluster_Type{Type: clusterv3.Cluster_EDS},
				EdsClusterConfig: &clusterv3.Cluster_EdsClusterConfig{ServiceName: "test"}},
