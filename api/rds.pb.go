...
import fmt "fmt"
import math "math"
import envoy_api_v2_auth "github.com/envoyproxy/go-control-plane/api/auth"
...
type VirtualHost struct {
	...
	Auth *envoy_api_v2_auth.AuthAction `protobuf:"bytes,9,opt,name=auth" json:"auth,omitempty"`
}
...
func (m *VirtualHost) GetAuth() *envoy_api_v2_auth.AuthAction {
	if m != nil {
		return m.Auth
	}
	return nil
...
type Route struct {
	...
	// [#not-implemented-hide:]
	// Return a 401/403 when auth checks fail.
	Auth *envoy_api_v2_auth.AuthAction `protobuf:"bytes,6,opt,name=auth" json:"auth,omitempty"`
}
...
func (m *Route) GetAuth() *envoy_api_v2_auth.AuthAction {
	if m != nil {
		return m.Auth
	}
	return nil
...
func (*Decorator) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{8} }
...
func (*VirtualCluster) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{9} }
...
func (*RateLimit) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{10} }
...
func (*RateLimit_Action) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{10, 0} }
...
func (*RateLimit_Action_SourceCluster) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 0}
}
...
func (*RateLimit_Action_DestinationCluster) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 1}
}
...
func (*RateLimit_Action_RequestHeaders) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 2}
}
...
func (*RateLimit_Action_RemoteAddress) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 3}
}
...
func (*RateLimit_Action_GenericKey) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 4}
}
...
func (*RateLimit_Action_HeaderValueMatch) Descriptor() ([]byte, []int) {
	return fileDescriptorRds, []int{10, 0, 5}
}
...
func (*HeaderMatcher) Descriptor() ([]byte, []int) { return fileDescriptorRds, []int{11} }
...
func (m *WeightedCluster_ClusterWeight) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Weight != nil {
		...
		n11, err := m.Weight.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.MetadataMatch != nil {
		...
		n12, err := m.MetadataMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *RouteMatch) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PathSpecifier != nil {
		nn13, err := m.PathSpecifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn13
	...
	if m.CaseSensitive != nil {
		...
		n14, err := m.CaseSensitive.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
	...
	if m.Runtime != nil {
		...
		n15, err := m.Runtime.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *CorsPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AllowCredentials != nil {
		...
		n16, err := m.AllowCredentials.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *RouteAction) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ClusterSpecifier != nil {
		nn18, err := m.ClusterSpecifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn18
	...
	if m.MetadataMatch != nil {
		...
		i++
		i = encodeVarintRds(dAtA, i, uint64(m.MetadataMatch.Size()))
		n19, err := m.MetadataMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.HostRewriteSpecifier != nil {
		nn20, err := m.HostRewriteSpecifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn20
	...
	if m.Timeout != nil {
		...
		n21, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.Timeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.RetryPolicy != nil {
		...
		n22, err := m.RetryPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	...
	if m.RequestMirrorPolicy != nil {
		...
		n23, err := m.RequestMirrorPolicy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
	...
	if m.IncludeVhRateLimits != nil {
		...
		n24, err := m.IncludeVhRateLimits.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n24
	...
	if m.UseWebsocket != nil {
		...
		n25, err := m.UseWebsocket.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n25
	...
	if m.Cors != nil {
		...
		i++
		i = encodeVarintRds(dAtA, i, uint64(m.Cors.Size()))
		n26, err := m.Cors.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *RouteAction_WeightedClusters) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.WeightedClusters != nil {
		...
		n27, err := m.WeightedClusters.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *RouteAction_AutoHostRewrite) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.AutoHostRewrite != nil {
		...
		n28, err := m.AutoHostRewrite.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *RouteAction_RetryPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.NumRetries != nil {
		...
		n29, err := m.NumRetries.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n29
	...
	if m.PerTryTimeout != nil {
		...
		n30, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.PerTryTimeout, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
...
func (m *RouteAction_HashPolicy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PolicySpecifier != nil {
		nn31, err := m.PolicySpecifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn31
...
func (m *RouteAction_HashPolicy_Cookie_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cookie != nil {
		...
		n33, err := m.Cookie.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *RouteAction_HashPolicy_ConnectionProperties_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConnectionProperties != nil {
		...
		n34, err := m.ConnectionProperties.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *RouteAction_HashPolicy_Cookie) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Ttl != nil {
		...
		n35, err := github_com_gogo_protobuf_types.StdDurationMarshalTo(*m.Ttl, dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n35
...
func (m *RateLimit) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Stage != nil {
		...
		n36, err := m.Stage.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *RateLimit_Action) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ActionSpecifier != nil {
		nn37, err := m.ActionSpecifier.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn37
...
func (m *RateLimit_Action_SourceCluster_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.SourceCluster != nil {
		...
		n38, err := m.SourceCluster.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *RateLimit_Action_DestinationCluster_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DestinationCluster != nil {
		...
		n39, err := m.DestinationCluster.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *RateLimit_Action_RequestHeaders_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RequestHeaders != nil {
		...
		n40, err := m.RequestHeaders.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *RateLimit_Action_RemoteAddress_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RemoteAddress != nil {
		...
		n41, err := m.RemoteAddress.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *RateLimit_Action_GenericKey_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.GenericKey != nil {
		...
		n42, err := m.GenericKey.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *RateLimit_Action_HeaderValueMatch_) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.HeaderValueMatch != nil {
		...
		n43, err := m.HeaderValueMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *RateLimit_Action_HeaderValueMatch) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExpectMatch != nil {
		...
		n44, err := m.ExpectMatch.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *HeaderMatcher) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Regex != nil {
		...
		n45, err := m.Regex.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *VirtualHost) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.Auth == nil {
				m.Auth = &envoy_api_v2_auth.AuthAction{}
			}
...
var fileDescriptorRds = []byte{
	...
	,
}
