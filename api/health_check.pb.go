...
func (m *HealthCheck_Payload) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Payload != nil {
		nn12, err := m.Payload.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn12
...
func (m *HealthCheck_HttpHealthCheck) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Send != nil {
		...
		n13, err := m.Send.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n13
	...
	if m.Receive != nil {
		...
		n14, err := m.Receive.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n14
...
var fileDescriptorHealthCheck = []byte{
	...
	,
}
