...
func (AuthAction_ActionType) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*AuthAction) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*AuthAction_AndRule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*AuthAction_OrRule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 1} }
...
func (*AuthAction_X509Rule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 2} }
...
func (*AuthAction_Rule) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 3} }
...
func init() { proto.RegisterFile("api/auth.proto", fileDescriptor1) }
