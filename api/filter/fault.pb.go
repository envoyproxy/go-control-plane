...
type FaultDelay_FixedDelay struct {
	FixedDelay *google_protobuf2.Duration `protobuf:"bytes,3,opt,name=fixed_delay,json=fixedDelay,oneof"`
}
...
func (m *FaultDelay) GetFixedDelay() *google_protobuf2.Duration {
