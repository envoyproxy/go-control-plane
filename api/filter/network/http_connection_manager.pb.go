...
func (m *Rds) GetConfigSource() envoy_api_v21.ConfigSource {
	...
	return envoy_api_v21.ConfigSource{}
}
...
func (m *HttpConnectionManager) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			if m.HttpProtocolOptions == nil {
				m.HttpProtocolOptions = &envoy_api_v22.Http1ProtocolOptions{}
			}
		...
		case 9:
			...
			if m.Http2ProtocolOptions == nil {
				m.Http2ProtocolOptions = &envoy_api_v22.Http2ProtocolOptions{}
			}
...
var fileDescriptorHttpConnectionManager = []byte{
	...
	,
}
